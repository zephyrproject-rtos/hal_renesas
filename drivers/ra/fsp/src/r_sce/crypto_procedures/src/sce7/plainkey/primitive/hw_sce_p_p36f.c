...
fsp_err_t HW_SCE_Aes256GcmDecryptFinalSub(const uint32_t *InData_Text, const uint32_t *InData_TextLen, const uint32_t *InData_DataALen, const uint32_t *InData_DataT, const uint32_t *InData_DataTLen, uint32_t *OutData_Text)
{
    ...
    SCE->REG_E0H = 0x00000080U;
    SCE->REG_1CH = 0x00260000U;
    HW_SCE_p_func100(0xa67896d2U, 0x227115f5U, 0xb2bb6979U, 0x90659808U);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        HW_SCE_p_func102(0x7b3aecc9U, 0xbd050b64U, 0x1bc78859U, 0xfeeeb21eU);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x7d050b3fU, 0xc1452782U, 0x22557e26U, 0x772f7578U);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            ...
            HW_SCE_p_func100(0xffc18d61U, 0x03e43802U, 0x748ed872U, 0x61ed1178U);
            ...
            HW_SCE_p_func101(0x66ca71a2U, 0x067a4835U, 0x31e7e853U, 0xe4bd76a9U);
        }
        ...
        HW_SCE_p_func100(0x6945e97fU, 0x22fb2101U, 0x58ff0c00U, 0xcfa74ef5U);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            HW_SCE_p_func102(0xfdffab20U, 0x9ed1eabeU, 0x691351caU, 0x997cca7dU);
            SCE->REG_1BCH = 0x00000040U;
            /* WAIT_LOOP */
            while (0U != SCE->REG_18H_b.B12)
            {
        ...
        {
            HW_SCE_p_func102(0x11d9c0d9U, 0xf094851aU, 0xd20b173bU, 0xff463944U);
            SCE->REG_1BCH = 0x00000040U;
            /* WAIT_LOOP */
            while (0U != SCE->REG_18H_b.B12)
            {
...
/***********************************************************************************************************************
End of function ./input_dir/HW_SCE/HW_SCEp/HW_SCEp_p36f.prc
***********************************************************************************************************************/
