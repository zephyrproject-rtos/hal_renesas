...
fsp_err_t HW_SCE_Aes256GcmEncryptFinalSub(const uint32_t *InData_Text, const uint32_t *InData_TextLen, const uint32_t *InData_DataALen, uint32_t *OutData_Text, uint32_t *OutData_DataT)
{
    ...
    HW_SCE_p_func100(0xc16f41f5U, 0xc41d0b5dU, 0xfd433984U, 0x9800fe74U);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        HW_SCE_p_func102(0x9153dfd4U, 0x40019173U, 0x23cc5041U, 0x873649b2U);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x8e84ae0cU, 0xfc5e27ccU, 0xdac90623U, 0x34f4b4a8U);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            ...
            HW_SCE_p_func100(0x05f20b91U, 0x2fb96093U, 0xc8dd11dbU, 0x72b25d33U);
            ...
            HW_SCE_p_func101(0xba39bfaeU, 0x18ac5128U, 0x28bc46aeU, 0x93f207cbU);
        }
        ...
        SCE->REG_1CH = 0x00001800U;
        HW_SCE_p_func100(0xc21d20bcU, 0x72f081eaU, 0xd710d420U, 0x72cad494U);
        SCE->REG_B0H = 0x40000020U;
        SCE->REG_A4H = 0x000087b5U;
        ...
        HW_SCE_p_func102(0xb9b671b1U, 0x14564ce4U, 0x78dc94f9U, 0x700895e9U);
        SCE->REG_1BCH = 0x00000040U;
        /* WAIT_LOOP */
        while (0U != SCE->REG_18H_b.B12)
        {
...
/***********************************************************************************************************************
End of function ./input_dir/HW_SCE/HW_SCEp/HW_SCEp_p34f.prc
***********************************************************************************************************************/
