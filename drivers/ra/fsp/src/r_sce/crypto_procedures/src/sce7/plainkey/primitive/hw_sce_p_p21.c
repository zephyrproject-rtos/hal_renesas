...
fsp_err_t HW_SCE_Ghash(uint32_t *InData_HV, uint32_t *InData_IV, uint32_t *InData_Text, uint32_t *OutData_DataT, uint32_t MAX_CNT)
{
    ...
    HW_SCE_p_func100(0x39762f3fU, 0x4c3ef054U, 0x822ff319U, 0x8c5596deU);
    ...
    HW_SCE_p_func102(0xc688a0d6U, 0x0862bb2fU, 0x656ddb57U, 0xe5dbc7f6U);
...
/***********************************************************************************************************************
End of function ./input_dir/HW_SCE/HW_SCEp/HW_SCEp_p21.prc
***********************************************************************************************************************/
