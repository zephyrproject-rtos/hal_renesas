...
fsp_err_t HW_SCE_Aes192GcmEncryptFinalSub(const uint32_t *InData_Text, const uint32_t *InData_TextLen, const uint32_t *InData_DataALen, uint32_t *OutData_Text, uint32_t *OutData_DataT)
{
    ...
    HW_SCE_p_func100(0xf71354fbU, 0xbeda6c82U, 0x3bd63339U, 0x3bac1d03U);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        HW_SCE_p_func102(0x001122a3U, 0x4fd6cb2fU, 0xb66eb3e7U, 0x35735d85U);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0xfd2cbbe2U, 0xa355f3a7U, 0x2889af9eU, 0xec4bf4d3U);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            ...
            HW_SCE_p_func100(0xe18be095U, 0x56a1b268U, 0xb5c27103U, 0xc5af57b6U);
            ...
            HW_SCE_p_func101(0x39174e5bU, 0x9807fc97U, 0x9d852260U, 0xf7734c3cU);
        }
        ...
        SCE->REG_1CH = 0x00001800U;
        HW_SCE_p_func100(0xe9d407bcU, 0x582d9bdfU, 0x909e4717U, 0xe71f9e29U);
        SCE->REG_B0H = 0x40000030U;
        SCE->REG_A4H = 0x000087b5U;
        ...
        HW_SCE_p_func102(0xcf551495U, 0x7009cda0U, 0x8f728475U, 0x0e02ff08U);
        SCE->REG_1BCH = 0x00000040U;
        /* WAIT_LOOP */
        while (0U != SCE->REG_18H_b.B12)
        {
...
/***********************************************************************************************************************
End of function ./input_dir/HW_SCE/HW_SCEp/HW_SCEp_p83f.prc
***********************************************************************************************************************/
