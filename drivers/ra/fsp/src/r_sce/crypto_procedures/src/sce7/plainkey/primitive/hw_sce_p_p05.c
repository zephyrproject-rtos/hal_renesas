...
fsp_err_t HW_SCE_UpdateAes128KeyIndexSub(const uint32_t * const InData_IV, const uint32_t * const InData_InstData, uint32_t * const OutData_KeyIndex)
{
    ...
    HW_SCE_p_func100(0x3755c96cU, 0x4601a0f0U, 0xc819846dU, 0x32b0e8b4U);
    ...
    HW_SCE_p_func100(0x9d21e547U, 0x0e91e30dU, 0x12933adcU, 0xbb65cf65U);
    ...
    HW_SCE_p_func100(0xa5c4afbeU, 0x9f4d2becU, 0x53ba65f1U, 0xd7f1fd61U);
    SCE->REG_104H = 0x00000361U;
    ...
    HW_SCE_p_func103();
    HW_SCE_p_func100(0x00b778adU, 0xbbea39fbU, 0x390afbeaU, 0x9c850c6eU);
    ...
    HW_SCE_p_func100(0x1c5ad1f2U, 0x8faba79aU, 0x19c76e94U, 0x6d55e244U);
    SCE->REG_104H = 0x00000052U;
    ...
    SCE->REG_1CH = 0x00001800U;
    HW_SCE_p_func100(0x69ea12d1U, 0x00ef1807U, 0x75475bceU, 0x594b8f97U);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        HW_SCE_p_func102(0x4207b4abU, 0xf5219b69U, 0xfe47713dU, 0x347b2265U);
    ...
    {
        HW_SCE_p_func100(0x3dd7b2cdU, 0x2bab9c94U, 0x297c90c3U, 0xb741ee28U);
        SCE->REG_E0H = 0x81040000U;
        ...
        HW_SCE_p_func102(0x293c5b92U, 0x0e21e676U, 0x2e68ac56U, 0x2a4f24b4U);
        SCE->REG_1B4H = 0x00000040U;
        /* WAIT_LOOP */
        while (0U != SCE->REG_18H_b.B12)
        {
...
/***********************************************************************************************************************
End of function ./input_dir/HW_SCE/HW_SCEp/HW_SCEp_p05.prc
***********************************************************************************************************************/
