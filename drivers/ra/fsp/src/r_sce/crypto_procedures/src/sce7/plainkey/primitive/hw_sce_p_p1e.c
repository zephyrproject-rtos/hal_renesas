...
fsp_err_t HW_SCE_UpdateEccPrivateKeyIndexSub(const uint32_t * const InData_CurveType, const uint32_t * const InData_Cmd, const uint32_t * const InData_IV, const uint32_t * const InData_InstData, uint32_t * const OutData_KeyIndex)
{
    uint32_t iLoop    = 0U;
    uint32_t iLoop1   = 0U;
    uint32_t iLoop2   = 0U;
    ...
    SCE->REG_84H = 0x00001e01U;
    SCE->REG_108H = 0x00000000U;
    HW_SCE_p_func100(0xa3697120U, 0x64f87cefU, 0x03afde22U, 0x58e538dbU);
    ...
    HW_SCE_p_func100(0x758020c1U, 0x82842ed6U, 0xe7e2282bU, 0xc3d2673eU);
    SCE->REG_104H = 0x00000361U;
    ...
    HW_SCE_p_func100(0x1152e695U, 0x61a61f01U, 0xd60c4734U, 0x077fdb22U);
    SCE->REG_104H = 0x00000361U;
    ...
    HW_SCE_p_func103();
    HW_SCE_p_func100(0xd0644753U, 0xd47e2a96U, 0x139d2dfeU, 0x5f7bd5b4U);
    ...
    HW_SCE_p_func100(0xcbe9b232U, 0xedff1b8bU, 0xcaa7327aU, 0xefd71c70U);
    SCE->REG_104H = 0x00000052U;
    ...
    SCE->REG_1CH = 0x00001800U;
    HW_SCE_p_func100(0xd2bcf2aeU, 0x9ac3959bU, 0x0453f6e8U, 0xab0dc70cU);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        HW_SCE_p_func102(0x1313074dU, 0x34834d4fU, 0xac5f7ed3U, 0xfe96d0fbU);
    ...
    {
        HW_SCE_p_func100(0x9876a31eU, 0xc00ccad1U, 0x117415f2U, 0xa6768b2bU);
        SCE->REG_E0H = 0x81040000U;
        ...
        HW_SCE_p_func102(0x07c9a531U, 0x4fa5484fU, 0xf6028da9U, 0x044543dfU);
        SCE->REG_1B4H = 0x00000040U;
        /* WAIT_LOOP */
        while (0U != SCE->REG_18H_b.B12)
        {
...
/***********************************************************************************************************************
End of function ./input_dir/HW_SCE/HW_SCEp/HW_SCEp_p1e_r1.prc
***********************************************************************************************************************/
