...
fsp_err_t HW_SCE_Aes256GcmEncryptInitSub(uint32_t *InData_KeyType, uint32_t *InData_KeyIndex, uint32_t *InData_IV)
{
    ...
    HW_SCE_p_func100(0x1099bcdeU, 0x9101e8bdU, 0xd8be7e70U, 0x7ca0ba4bU);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        HW_SCE_p_func102(0x317e5af8U, 0x6f8cb359U, 0xc86a9633U, 0x1357b9ffU);
    ...
    else
    {
        ...
        SCE->REG_E0H = 0x00000080U;
        SCE->REG_1CH = 0x00260000U;
        HW_SCE_p_func100(0x275ccdf4U, 0x67c62794U, 0xd956fae1U, 0x951c11abU);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            ...
            HW_SCE_p_func101(0x3f3bc3fcU, 0xfd147056U, 0xc6a7486bU, 0xe6a77186U);
        }
        else
        {
            ...
            HW_SCE_p_func101(0x313c8586U, 0x95a4f54eU, 0x64d8bd78U, 0x5667d0efU);
        }
        HW_SCE_p_func100(0x5fac3b5cU, 0x77f24111U, 0xa037167cU, 0xb08b7111U);
        ...
        HW_SCE_p_func100(0x62dd630dU, 0xde0a290fU, 0xfc404c2eU, 0x44af2effU);
        ...
        HW_SCE_p_func100(0x65e5b77aU, 0x8dde59a7U, 0xb61c081cU, 0x5c760a79U);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            HW_SCE_p_func102(0xfad27e84U, 0xdddcc0cbU, 0x733a97a9U, 0x8d01285aU);
            SCE->REG_1BCH = 0x00000040U;
            /* WAIT_LOOP */
            while (0U != SCE->REG_18H_b.B12)
            {
        ...
        else
        {
            ...
            HW_SCE_p_func101(0x574d8b32U, 0xb9a77a55U, 0xe8eac0aaU, 0xaa95a534U);
            return FSP_SUCCESS;
        }
    }
}
...
/***********************************************************************************************************************
End of function ./input_dir/HW_SCE/HW_SCEp/HW_SCEp_p34i_r1.prc
***********************************************************************************************************************/
