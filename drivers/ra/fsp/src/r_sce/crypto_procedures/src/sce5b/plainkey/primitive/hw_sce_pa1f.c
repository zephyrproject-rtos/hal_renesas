...
fsp_err_t HW_SCE_Aes256CcmEncryptFinalSub(const uint32_t *InData_Text, const uint32_t *InData_TextLen, uint32_t *OutData_Text, uint32_t *OutData_MAC)
{
    ...
    (void)OFS_ADR;
    (void)MAX_CNT2;
    HW_SCE_func100(0x1776c917U, 0x2373cbbfU, 0x3a4ada6dU, 0x2765ec52U);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        HW_SCE_func102(0x032dedd7U, 0x4dda3efeU, 0xf1ea54f6U, 0xbb1e4ea9U);
    ...
    else
    {
        ...
        HW_SCE_func100(0xe6bcbf6bU, 0xf1878dbfU, 0x7231bcf6U, 0x47c2a998U);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            HW_SCE_func100(0xb48dc3a0U, 0x7bae7829U, 0x55c6302aU, 0x0509171fU);
            ...
            HW_SCE_func101(0x908ec127U, 0xbc27a2bbU, 0xd707387fU, 0x2d38af9aU);
        }
        else
        {
            HW_SCE_func101(0x94ac0113U, 0x358629f9U, 0xd55c20e1U, 0xb348f031U);
        }
        HW_SCE_func100(0xb3cfb232U, 0x4fd2fcf2U, 0x052d1571U, 0x04176195U);
        ...
        HW_SCE_func102(0x71211525U, 0x09c6207fU, 0x21b4e191U, 0x3d4f9a55U);
        SCE->REG_1BCH = 0x00000040U;
        /* WAIT_LOOP */
        while (0U != SCE->REG_18H_b.B12)
        {
...
/***********************************************************************************************************************
End of function ./input_dir/RA6T_Boot/200821/HW_SCE/Cryptographic/HW_SCE_pa1f.prc
***********************************************************************************************************************/
