...
void HW_SCE_Aes128CmacUpdateSub(uint32_t *InData_Text, uint32_t MAX_CNT)
{
    ...
    HW_SCE_func101(0xcfe125fcU, 0x7d4dd56aU, 0x6bb309a1U, 0x5b687d65U);
}

/***********************************************************************************************************************
End of function ./input_dir/RA6T_Boot/200821/HW_SCE/Cryptographic/HW_SCE_p41u.prc
***********************************************************************************************************************/
