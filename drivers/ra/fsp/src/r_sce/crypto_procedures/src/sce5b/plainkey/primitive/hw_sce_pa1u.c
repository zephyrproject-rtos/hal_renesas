...
void HW_SCE_Aes256CcmEncryptUpdateSub(const uint32_t *InData_Text, uint32_t *OutData_Text, const uint32_t MAX_CNT)
{
    ...
    (void)OFS_ADR;
    (void)MAX_CNT2;
    HW_SCE_func100(0x11fb2126U, 0x7344ebeeU, 0x7c83a96fU, 0xef3c2306U);
    ...
    HW_SCE_func101(0xef77cf69U, 0xc2545174U, 0xd737c2dfU, 0x19f9bd73U);
}

/***********************************************************************************************************************
End of function ./input_dir/RA6T_Boot/200821/HW_SCE/Cryptographic/HW_SCE_pa1u.prc
***********************************************************************************************************************/
