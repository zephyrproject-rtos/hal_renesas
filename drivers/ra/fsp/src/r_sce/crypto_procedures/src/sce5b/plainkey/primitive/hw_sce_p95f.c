...
fsp_err_t HW_SCE_Aes128CcmEncryptFinalSub(const uint32_t *InData_TextLen, const uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t *OutData_MAC)
{
    ...
    (void)OFS_ADR;
    (void)MAX_CNT2;
    HW_SCE_func100(0x6a1105ddU, 0x9b02ebe7U, 0x16968fc3U, 0xd2579219U);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        HW_SCE_func102(0x927b2fe1U, 0xc11cd920U, 0x54039041U, 0x6bf0897eU);
    ...
    else
    {
        ...
        HW_SCE_func100(0xc764f7cfU, 0x7ff12cffU, 0x6a5e5747U, 0xceab5704U);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            HW_SCE_func100(0x6e330547U, 0x75f679feU, 0x79436a18U, 0xd3b95b18U);
            ...
            HW_SCE_func101(0xf6353e0bU, 0x2d675120U, 0x74b4d132U, 0xf4881448U);
        }
        else
        {
            HW_SCE_func101(0xd4e30301U, 0x61a23c31U, 0x44f604c0U, 0x8424d98bU);
        }
        HW_SCE_func100(0x76f34d3cU, 0x9c925501U, 0x16416534U, 0x673c812aU);
        ...
        HW_SCE_func102(0xee07aff3U, 0x8a262730U, 0x129fa908U, 0x6da0a3b0U);
        SCE->REG_1BCH = 0x00000040U;
        /* WAIT_LOOP */
        while (0U != SCE->REG_18H_b.B12)
        {
...
/***********************************************************************************************************************
End of function ./input_dir/RA6T_Boot/200821/HW_SCE/Cryptographic/HW_SCE_p95f.prc
***********************************************************************************************************************/
