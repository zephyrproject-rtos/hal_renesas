...
fsp_err_t HW_SCE_Aes256GcmEncryptInitSub(uint32_t *InData_KeyType, uint32_t *InData_KeyIndex, uint32_t *InData_IV)
{
    ...
    HW_SCE_func101(0x6508ade6U, 0xefa6be26U, 0x6ff0904bU, 0x3939f7c8U);
    HW_SCE_func043();
    HW_SCE_func100(0x91691bc4U, 0x10b86018U, 0xc154cc3cU, 0x5fa84f36U);
    SCE->REG_ECH = 0x0000b4a0U;
    SCE->REG_ECH = 0x00000007U;
    HW_SCE_func044();
    HW_SCE_func100(0x3db81cdbU, 0xe2cf8433U, 0x47fde3adU, 0xaf61d028U);
    ...
    HW_SCE_func100(0x79de3d83U, 0xa338d425U, 0x1a178141U, 0xd534e03cU);
    ...
    HW_SCE_func100(0xf6d8e836U, 0xfc5d289eU, 0x01ca0f8dU, 0x4c19d2acU);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        HW_SCE_func102(0x5161c300U, 0x11dab900U, 0x1d1364e2U, 0x0f5362dfU);
...
/***********************************************************************************************************************
End of function ./input_dir/RA6T_Boot/200821/HW_SCE/Cryptographic/HW_SCE_p34i.prc
***********************************************************************************************************************/
