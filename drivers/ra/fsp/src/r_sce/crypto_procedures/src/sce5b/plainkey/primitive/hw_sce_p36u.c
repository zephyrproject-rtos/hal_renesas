...
void HW_SCE_Aes256GcmDecryptUpdateSub(const uint32_t *InData_Text, uint32_t *OutData_Text, const uint32_t MAX_CNT)
{
    ...
    (void)OFS_ADR;
    (void)MAX_CNT2;
    HW_SCE_func100(0x45d21751U, 0xc76d3bd0U, 0xff28574dU, 0xa301121cU);
    ...
    HW_SCE_func101(0x167efd9eU, 0x899bbd08U, 0x3f6fba57U, 0x9db0d6beU);
}

/***********************************************************************************************************************
End of function ./input_dir/RA6T_Boot/200821/HW_SCE/Cryptographic/HW_SCE_p36u.prc
***********************************************************************************************************************/
