...
void HW_SCE_Aes256CmacUpdateSub(uint32_t *InData_Text, uint32_t MAX_CNT)
{
    ...
    HW_SCE_func101(0xc0aa6c5dU, 0xed497fa7U, 0xa5dc3577U, 0x1837d359U);
}

/***********************************************************************************************************************
End of function ./input_dir/RA6T_Boot/200821/HW_SCE/Cryptographic/HW_SCE_p44u.prc
***********************************************************************************************************************/
