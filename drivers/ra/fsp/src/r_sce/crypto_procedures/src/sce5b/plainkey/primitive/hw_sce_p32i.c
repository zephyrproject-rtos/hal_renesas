...
fsp_err_t HW_SCE_Aes128GcmDecryptInitSub(uint32_t *InData_KeyType, uint32_t *InData_KeyIndex, uint32_t *InData_IV)
{
    ...
    HW_SCE_func101(0x7fda755bU, 0x92d0f452U, 0x44006612U, 0xc3b309a5U);
    HW_SCE_func043();
    HW_SCE_func100(0x4154482dU, 0x05bf9a02U, 0x2f0ce0faU, 0x5e08d732U);
    SCE->REG_ECH = 0x0000b4a0U;
    SCE->REG_ECH = 0x00000005U;
    HW_SCE_func044();
    HW_SCE_func100(0x0b7ad5caU, 0xb1a87172U, 0x9c13138dU, 0x411addc3U);
    ...
    HW_SCE_func100(0x84a591bbU, 0x1c869d74U, 0x2ca4901aU, 0x002ee186U);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        HW_SCE_func102(0x4ccff0a9U, 0xdc6022e9U, 0x854f5f03U, 0x7ac74c18U);
...
/***********************************************************************************************************************
End of function ./input_dir/RA6T_Boot/200821/HW_SCE/Cryptographic/HW_SCE_p32i.prc
***********************************************************************************************************************/
