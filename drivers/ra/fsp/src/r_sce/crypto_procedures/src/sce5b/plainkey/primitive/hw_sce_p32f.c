...
fsp_err_t HW_SCE_Aes128GcmDecryptFinalSub(const uint32_t *InData_Text, const uint32_t *InData_TextLen, const uint32_t *InData_DataALen, const uint32_t *InData_DataT, const uint32_t *InData_DataTLen, uint32_t *OutData_Text)
{
    ...
    SCE->REG_E0H = 0x00000080U;
    SCE->REG_1CH = 0x00260000U;
    HW_SCE_func100(0x43adc32bU, 0x9a980ac5U, 0x8385644fU, 0x6488b330U);
    ...
    if (1U == (SCE->REG_1CH_b.B22))
    {
        ...
        HW_SCE_func102(0x791e9b5aU, 0xdcef4d5fU, 0xbef2fd05U, 0x2cae6757U);
    ...
    else
    {
        ...
        HW_SCE_func100(0xf5f0619fU, 0x8fad3443U, 0x7417dc62U, 0xd4b8dbbeU);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            HW_SCE_func100(0x7b9e1409U, 0xe080c554U, 0xdc667286U, 0x33148b81U);
            ...
            HW_SCE_func101(0x9f3721e4U, 0xabcb1c5bU, 0x4c535757U, 0x569db9caU);
        }
        ...
        SCE->REG_1CH = 0x00001800U;
        HW_SCE_func100(0xbe33ee3fU, 0xb1e5ec3cU, 0xa48dc25bU, 0xcfdfc320U);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            HW_SCE_func102(0x85eaf3d1U, 0xe0bb3083U, 0xd1a76718U, 0x501f5606U);
            SCE->REG_1BCH = 0x00000040U;
            /* WAIT_LOOP */
            while (0U != SCE->REG_18H_b.B12)
            {
        ...
        {
            HW_SCE_func102(0xe305ee69U, 0x0be5c1f5U, 0xbb8721e6U, 0x3c7b3e57U);
            SCE->REG_1BCH = 0x00000040U;
            /* WAIT_LOOP */
            while (0U != SCE->REG_18H_b.B12)
            {
...
/***********************************************************************************************************************
End of function ./input_dir/RA6T_Boot/200821/HW_SCE/Cryptographic/HW_SCE_p32f.prc
***********************************************************************************************************************/
