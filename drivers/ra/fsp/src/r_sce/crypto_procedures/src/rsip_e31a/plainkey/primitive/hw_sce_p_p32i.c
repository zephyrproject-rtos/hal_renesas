                                          ...
                                          const uint32_t InData_IV[])
{
    ...
    HW_SCE_p_func101(0x43e6815cU, 0xbfcdf9feU, 0x2c989bfdU, 0xea3c63daU);
    HW_SCE_p_func440(InData_KeyIndex, InData_Key);

    HW_SCE_p_func100(0x93db6b21U, 0xeb7ed869U, 0xca90ca6cU, 0x452f9a4fU);
    WR1_PROG(REG_40H, 0x00400000U);

    if (CHCK_STS(REG_40H, 22, 1))
    {
        HW_SCE_p_func102(0x418a3054U, 0x008da933U, 0xf53f942cU, 0x2d937cbeU);
    ...
    {
        HW_SCE_p_func100(0x8859164fU, 0x32e5c1beU, 0x22e6f7bdU, 0xfaf9a148U);
        ...
        HW_SCE_p_func100(0x3e140dd4U, 0x0df65b7dU, 0x1c15dfa0U, 0xf2a07ca1U);
        ...
        HW_SCE_p_func101(0x4aa45debU, 0xd9fc207cU, 0x3854ae51U, 0x777f8e93U);
