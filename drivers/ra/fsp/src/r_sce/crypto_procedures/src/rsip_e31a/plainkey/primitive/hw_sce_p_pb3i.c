                                          ...
                                          const uint32_t InData_IV[])
{
    ...
    HW_SCE_p_func101(0xdaf5165fU, 0x98b78a5bU, 0x77054fc9U, 0xd4c1a986U);
    HW_SCE_p_func441(InData_KeyIndex, InData_Key);

    HW_SCE_p_func100(0xe2bf50c0U, 0x98ec48f0U, 0xd41eb6b6U, 0x2f7d823eU);
    WR1_PROG(REG_40H, 0x00400000U);

    if (CHCK_STS(REG_40H, 22, 1))
    {
        HW_SCE_p_func102(0x199ab418U, 0x0b47e815U, 0xfd40e0eaU, 0x9078293fU);
    ...
    {
        HW_SCE_p_func100(0x6927212dU, 0xf053392fU, 0x54794ebbU, 0x8ddefeaeU);
        ...
        HW_SCE_p_func100(0x72742dbfU, 0x12ae64ecU, 0x93e86f38U, 0xd03504b0U);
        ...
        HW_SCE_p_func101(0x5f6fba1fU, 0x1104a60fU, 0xb3691419U, 0xe46e27afU);
