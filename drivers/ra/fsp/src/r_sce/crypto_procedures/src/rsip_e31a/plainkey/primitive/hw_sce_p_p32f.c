                                           ...
                                           uint32_t       OutData_Text[])
{
    ...
    HW_SCE_p_func100(0xdce56df3U, 0x04f22dcaU, 0xb7e58cebU, 0x9470c6aeU);
    WR1_PROG(REG_40H, 0x00400000U);

    if (CHCK_STS(REG_40H, 22, 1))
    {
        HW_SCE_p_func102(0xee44d57aU, 0x4bdf62feU, 0xe06e425aU, 0x1447152fU);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0xb0214d45U, 0x16ca2675U, 0x86e0260eU, 0xee4c3362U);
        WR1_PROG(REG_40H, 0x00400000U);

        if (CHCK_STS(REG_40H, 22, 1))
        {
            HW_SCE_p_func100(0xa25c2ba5U, 0x304f4076U, 0xa60311ceU, 0x691d84caU);
            ...
            HW_SCE_p_func101(0xec580b90U, 0xaf4d0cddU, 0x2236d9a3U, 0x095505dcU);
        }
        ...
        HW_SCE_p_func100(0xe6929c71U, 0xc0d63f77U, 0x816474a8U, 0xd56ddaceU);
        WR1_PROG(REG_40H, 0x00400000U);

        if (CHCK_STS(REG_40H, 22, 1))
        {
            HW_SCE_p_func102(0x6193c5d7U, 0x54928188U, 0x319cd4c2U, 0x01d88201U);
            WR1_PROG(REG_6CH, 0x00000040U);
            WAIT_STS(REG_20H, 12, 0);
        ...
        {
            HW_SCE_p_func102(0xbeea5cecU, 0xe05d1b55U, 0xa650948dU, 0x4a19f02aU);
            WR1_PROG(REG_6CH, 0x00000040U);
            WAIT_STS(REG_20H, 12, 0);
