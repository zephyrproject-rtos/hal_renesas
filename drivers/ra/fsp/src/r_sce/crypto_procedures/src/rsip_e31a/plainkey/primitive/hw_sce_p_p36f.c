                                           ...
                                           uint32_t       OutData_Text[])
{
    ...
    HW_SCE_p_func100(0x79cca4baU, 0xb286c18fU, 0xca3455a8U, 0xcecb098eU);
    WR1_PROG(REG_40H, 0x00400000U);

    if (CHCK_STS(REG_40H, 22, 1))
    {
        HW_SCE_p_func102(0x6658753bU, 0x20e33b31U, 0x768e21b3U, 0x27045e59U);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x24155ed5U, 0xc84f70c6U, 0x27ccfdbcU, 0x7d8042c1U);
        WR1_PROG(REG_40H, 0x00400000U);

        if (CHCK_STS(REG_40H, 22, 1))
        {
            HW_SCE_p_func100(0x48f15b02U, 0x3181debdU, 0xdb49fe47U, 0xbd957938U);
            ...
            HW_SCE_p_func101(0x059d8996U, 0xe5eb3583U, 0x71ffe085U, 0x58a4d194U);
        }
        ...
        HW_SCE_p_func100(0x8a6653dbU, 0x65e7a2b7U, 0x81dffdb3U, 0x49b83dbaU);
        WR1_PROG(REG_40H, 0x00400000U);

        if (CHCK_STS(REG_40H, 22, 1))
        {
            HW_SCE_p_func102(0x486de5c4U, 0x0f8b2037U, 0x9c226b67U, 0x79868252U);
            WR1_PROG(REG_6CH, 0x00000040U);
            WAIT_STS(REG_20H, 12, 0);
        ...
        {
            HW_SCE_p_func102(0xdd3c68acU, 0x476f9c82U, 0x5e211f65U, 0x665dac20U);
            WR1_PROG(REG_6CH, 0x00000040U);
            WAIT_STS(REG_20H, 12, 0);
