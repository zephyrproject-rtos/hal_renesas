                                                ...
                                                uint32_t       OutData_Signature[])
{
    ...
    HW_SCE_p_func100(0x05dca902U, 0xf88ebce1U, 0x17e76688U, 0x1c514e5eU);
    ...
    HW_SCE_p_func103();
    HW_SCE_p_func100(0xcbad4599U, 0x1bde7731U, 0xe3f823fdU, 0xf1ae3a22U);
    WR1_PROG(REG_1444H, 0x000000a2U);
    ...
    HW_SCE_p_func103();
    HW_SCE_p_func100(0x3492e50aU, 0xa7e2ccb8U, 0xf83c2789U, 0x1ddf6fe9U);
    WR1_PROG(REG_1444H, 0x000000a2U);
    WR1_PROG(REG_1A24H, 0x0c200104U);
    WAIT_STS(REG_1444H, 31, 1);
    WR1_PROG(REG_1420H, change_endian_long(0x00000000U));
    ...
    HW_SCE_p_func100(0x880922e0U, 0xb51fac88U, 0x51f5f05dU, 0xc05ea579U);
    ...
    HW_SCE_p_func101(0x0de0f6d3U, 0x74c1e510U, 0x0b129652U, 0x82eb2c4eU);
    HW_SCE_p_func089_r1();
    ...
    else
    {
        ...
        else
        {
            ...
            HW_SCE_p_func100(0x6a6eed79U, 0x9b2cbe6cU, 0xa776c5c0U, 0xba7de48aU);
            WR1_PROG(REG_143CH, 0x00400000U);
            ...
            if (CHCK_STS(REG_143CH, 22, 1))
            {
                ...
                HW_SCE_p_func101(0x22b7f176U, 0xc1519730U, 0x1f4d7ca6U, 0x9490846aU);
                HW_SCE_p_func043_r1();
                ...
                HW_SCE_p_func101(0x8a07b867U, 0x73f95379U, 0x84fc568fU, 0xad2fa863U);
            }
            else
            {
                WR1_PROG(REG_1444H, 0x00000bc2U);
                ...
                HW_SCE_p_func101(0xe4ae4bbdU, 0x8bf28f8fU, 0xc223f7c5U, 0x2f197801U);
            }

            HW_SCE_p_func100(0xe148067aU, 0xc864ba2fU, 0x20b99114U, 0xfa587d60U);
            WR1_PROG(REG_143CH, 0x00400000U);

            if (CHCK_STS(REG_143CH, 22, 1))
            {
                HW_SCE_p_func102(0x7d177956U, 0xbd330278U, 0x97b15629U, 0x43128411U);
                WR1_PROG(REG_14B8H, 0x00000040U);
                WAIT_STS(REG_142CH, 12, 0);
            ...
            else
            {
                ...
                HW_SCE_p_func100(0x1b4d3145U, 0x98dad04cU, 0xe979c055U, 0xdf70dea6U);
                WR1_PROG(REG_143CH, 0x00400000U);

                if (CHCK_STS(REG_143CH, 22, 1))
                {
                    HW_SCE_p_func102(0xcf4ab979U, 0x8c7fb574U, 0xc6809ea6U, 0x54e18fe5U);
                    WR1_PROG(REG_14B8H, 0x00000040U);
                    WAIT_STS(REG_142CH, 12, 0);
                ...
                {
                    HW_SCE_p_func100(0x0924a381U, 0x382a12e7U, 0x1a7b040dU, 0x28898e9aU);
                    ...
                    HW_SCE_p_func100(0x31c973efU, 0xc36c913aU, 0x49f1aa11U, 0x533aa324U);
                    WR1_PROG(REG_1404H, 0x11d00000U);
                    WR1_PROG(REG_1A2CH, 0x00000200U);
                    WR1_PROG(REG_1A24H, 0x08008107U);
                    WR1_PROG(REG_1400H, 0x00830031U);
                    ...
                    HW_SCE_p_func102(0xf85b5dc3U, 0x24ac040cU, 0x5585b0abU, 0x2b4fc663U);
                    WR1_PROG(REG_14B8H, 0x00000040U);
                    WAIT_STS(REG_142CH, 12, 0);
