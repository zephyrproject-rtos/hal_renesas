                                                    ...
                                                    const uint32_t InData_DomainParam[])
{
    ...
    HW_SCE_p_func100(0x9f23e235U, 0xce7bfdffU, 0xd64fcc80U, 0x5986685aU);
    ...
    HW_SCE_p_func100(0xbf90e8b5U, 0x62e7ca0fU, 0xc4cdb192U, 0x02eb6c3bU);
    ...
    if (CHCK_STS(REG_143CH, 22, 1))
    {
        ...
        HW_SCE_p_func101(0x77af9960U, 0xf7eb436fU, 0x121dad56U, 0x0c14f34eU);
    }
    else
    {
        HW_SCE_p_func100(0xced0e89eU, 0xa7b44222U, 0xdca32039U, 0x532d5048U);
        ...
        HW_SCE_p_func100(0xb5ef2635U, 0x5034a74dU, 0x09e733d3U, 0x8ccb8c4fU);
        ...
        HW_SCE_p_func100(0xc46be82cU, 0xd088a71dU, 0x142d7836U, 0xf169dae5U);
        WR1_PROG(REG_143CH, 0x00400000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func100(0x07ac2429U, 0x3269dc08U, 0x3e2160e5U, 0x78b69708U);
            ...
            HW_SCE_p_func101(0x3ce2c836U, 0xd47f33ffU, 0x5c818b87U, 0xc84f408eU);
        }
        else
        {
            WR1_PROG(REG_1404H, 0x13e00000U);
            ...
            HW_SCE_p_func101(0x61f4dcefU, 0x7d0314f6U, 0xa8f87fe3U, 0x71656575U);
        }
