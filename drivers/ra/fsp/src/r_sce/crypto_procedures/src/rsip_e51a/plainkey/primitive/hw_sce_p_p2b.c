                         ...
                         uint32_t OutData_PrivKey[])
{
    ...
    HW_SCE_p_func100(0x8b7a6bd3U, 0x35e97dfaU, 0x69b7e5a1U, 0x56d81830U);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func100(0xf0c0887bU, 0xd23b0114U, 0x46259dd1U, 0x3ef4c929U);
        HW_SCE_p_func103();
        ...
        HW_SCE_p_func101(0xe59e3b27U, 0x9f896a6cU, 0xc8369d3fU, 0x534f24b9U);
        HW_SCE_p_func043_r1();
        ...
        HW_SCE_p_func101(0xd6b69ad6U, 0xa3efe4c5U, 0x733b62adU, 0x70d561bcU);
    }
    else
    {
        WR1_PROG(REG_1444H, 0x000000a2U);
        ...
        for (iLoop = 0U; iLoop < 64U; )
        {
            ...
            HW_SCE_p_func100(0x0079ad35U, 0x9d5dff29U, 0xbbe7d5c3U, 0x4e859c8aU);
            WR1_PROG(REG_1A24H, 0x08000105U);
            WR1_PROG(REG_1400H, 0x00830011U);
            WAIT_STS(REG_1404H, 30, 0);
            WR1_PROG(REG_143CH, 0x00001800U);
            ...
            HW_SCE_p_func101(0x603ffb71U, 0x824ebc85U, 0xde8dcf7aU, 0x390d1bbeU);
            iLoop = iLoop + 4U;
        }
        ...
        for (iLoop = 0U; iLoop < 64U; )
        {
            ...
            HW_SCE_p_func100(0xc8cdda49U, 0xa6258351U, 0x36b6fb22U, 0x1012d1d6U);
            WR1_PROG(REG_1A24H, 0x08000105U);
            WR1_PROG(REG_1400H, 0x00830011U);
            WAIT_STS(REG_1404H, 30, 0);
            WR1_PROG(REG_143CH, 0x00001800U);
            ...
            HW_SCE_p_func101(0x203f3b27U, 0xca3d1bb7U, 0x9e2b266fU, 0x762492a2U);
            iLoop = iLoop + 4U;
        }
        ...
        HW_SCE_p_func101(0x1f46b92fU, 0xee1a614eU, 0xb06e6da0U, 0xd60526caU);
    }
    ...
    for (iLoop = 0U; iLoop < 64U; )
    {
        ...
        HW_SCE_p_func100(0xc929b73bU, 0x70b2413cU, 0x321f9bfaU, 0x42a447cbU);
        WR1_PROG(REG_1A24H, 0x08000105U);
        WR1_PROG(REG_1400H, 0x00830011U);
        WAIT_STS(REG_1404H, 30, 0);
        WR1_PROG(REG_143CH, 0x00001800U);
        ...
        HW_SCE_p_func101(0x4eb5ec93U, 0xd7bc18b0U, 0x65cb4b83U, 0xf3c5610fU);
        iLoop = iLoop + 4U;
    }
    ...
    HW_SCE_p_func100(0xaceac635U, 0x4a71e352U, 0xcadf54d6U, 0x9d714a91U);
    WR1_PROG(REG_1A24H, 0x08000104U);
    ...
    HW_SCE_p_func102(0x39f50dd8U, 0xd03509dfU, 0x1ae724baU, 0x6982bf6dU);
    WR1_PROG(REG_14BCH, 0x00000040U);
    WAIT_STS(REG_142CH, 12, 0);
