...
#define SCE_RSIP_E51A_LITTLE_ENDIAN_MODE    (0x00010001)
...
// power on the SCE module 
    ...
    if (FSP_SUCCESS == iret)
    {
        ...
        SCE->REG_1424H = SCE_RSIP_E51A_LITTLE_ENDIAN_MODE;
        SCE->REG_1428H = SCE_RSIP_E51A_LITTLE_ENDIAN_MODE;
                                                       ...
                                                       uint32_t       OutData_R[])
{
    ...
    FSP_PARAMETER_NOT_USED(InData_Cmd);
    uint32_t indata_key_type = 0;
    return HW_SCE_Ecc521ScalarMultiplicationSub(&indata_key_type, InData_KeyIndex, NULL, InData_PubKey, InData_DomainParam, OutData_R);
}
                                                       ...
                                                       uint32_t       OutData_Signature[])
{
    FSP_PARAMETER_NOT_USED(InData_CurveType);
    uint32_t indata_key_type = 0;
    return HW_SCE_EcdsaP521SignatureGenerateSub(&indata_key_type, InData_KeyIndex, NULL, InData_MsgDgst, InData_DomainParam, OutData_Signature);
}
                                                           ...
                                                           const uint32_t InData_DomainParam[])
{
    FSP_PARAMETER_NOT_USED(InData_CurveType);
    FSP_PARAMETER_NOT_USED(InData_KeyIndex);
    return HW_SCE_EcdsaP521SignatureVerificationSub(InData_Key,
                                                    InData_MsgDgst,
                                                    InData_Signature,
                                                    InData_DomainParam);
}
...
{
    FSP_PARAMETER_NOT_USED(OutData_PubKeyIndex);
    return HW_SCE_RSA2048_KeyPairGenerateSub(InData_KeyType, MAX_CNT, OutData_PubKey, OutData_PrivKeyIndex, OutData_PrivKey);
}
...
fsp_err_t HW_SCE_Aes128OutputKeyForDotfSubAdaptor (const uint32_t InData_Cmd[], uint32_t InData_KeyIndex[], uint32_t InData_DOTFSEED[])
{
    ...
    return HW_SCE_Aes128OutputKeyForDotfSub(indata_key_mode, InData_KeyIndex, indata_key, InData_DOTFSEED);
}
...
fsp_err_t HW_SCE_Aes192OutputKeyForDotfSubAdaptor (const uint32_t InData_Cmd[], uint32_t InData_KeyIndex[], uint32_t InData_DOTFSEED[])
{
    ...
    return HW_SCE_Aes192OutputKeyForDotfSub(indata_key_mode, InData_KeyIndex, indata_key, InData_DOTFSEED);
}
...
fsp_err_t HW_SCE_Aes256OutputKeyForDotfSubAdaptor (const uint32_t InData_Cmd[], uint32_t InData_KeyIndex[], uint32_t InData_DOTFSEED[])
{
    ...
    uint32_t indata_key_mode[1] = {0};
    uint32_t indata_key[8]      = {0};
    return HW_SCE_Aes256OutputKeyForDotfSub(indata_key_mode, InData_KeyIndex, indata_key, InData_DOTFSEED);
}
...
{
    FSP_PARAMETER_NOT_USED(OutData_PubKeyIndex);
    return HW_SCE_RSA3072_KeyPairGenerateSub(InData_KeyMode, MAX_CNT, OutData_PubKey, OutData_PrivKeyIndex, OutData_PrivKey);
}
...
fsp_err_t HW_SCE_Rsa2048ModularExponentDecryptSubAdaptor(const uint32_t InData_KeyMode[],
                                                         ...
                                                         uint32_t OutData_Text[])
{
    return HW_SCE_Rsa2048ModularExponentDecryptSub(InData_KeyMode, InData_KeyIndex, InData_Key, InData_Text, OutData_Text);
}
...
fsp_err_t HW_SCE_Rsa3072ModularExponentDecryptSubAdaptor (const uint32_t InData_KeyMode[],
                                                          ...
                                                          uint32_t       OutData_Text[])
{
    return HW_SCE_Rsa3072ModularExponentDecryptSub(InData_KeyMode, InData_KeyIndex, InData_Key, InData_Text, OutData_Text);
}
