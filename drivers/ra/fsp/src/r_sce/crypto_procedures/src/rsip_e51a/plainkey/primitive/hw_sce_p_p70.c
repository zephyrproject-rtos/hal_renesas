...
fsp_err_t HW_SCE_OemKeyIndexValidationSub (const uint32_t InData_Cmd[], const uint32_t InData_KeyIndex[])
{
    ...
    HW_SCE_p_func100(0x29c2045aU, 0x2aae9316U, 0x2e6d3c5fU, 0x3a23a161U);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0x8e50bbaeU, 0xfd32c63fU, 0x409748ecU, 0xea789bcaU);
    ...
    else
    {
        ...
        HW_SCE_p_func101(0x10629b02U, 0x20984b9dU, 0xa6346d14U, 0x0096078eU);
        HW_SCE_p_func043_r1();
