                                                   ...
                                                   uint32_t       OutData_Text[])
{
    ...
    HW_SCE_p_func100(0xa7921210U, 0xb9a80074U, 0x4035a5dfU, 0xde48c518U);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0xf7b4d4f6U, 0x19c3e77fU, 0x072790c6U, 0xc85a93a0U);
    ...
    {
        HW_SCE_p_func100(0x1362387eU, 0xd251b0d3U, 0x0fe0237fU, 0xd120b6dbU);
        ...
        for (iLoop = 0U; iLoop < 96U; )
        {
            ...
            HW_SCE_p_func100(0x0271d444U, 0x49e943a6U, 0xe6db7922U, 0x756aa448U);
            ...
            HW_SCE_p_func101(0x997c25ceU, 0xcebc6276U, 0x627366d1U, 0xa53c6ae6U);
            iLoop = iLoop + 8U;
        }
        ...
        HW_SCE_p_func100(0x6490727fU, 0x9ab0b4c2U, 0xcba2d69cU, 0x9834df46U);
        WR1_PROG(REG_1408H, 0x00020000U);

        HW_SCE_p_func102(0xd0e1effdU, 0xd0fbc555U, 0x48b2bcbaU, 0x4ef45b29U);
        WR1_PROG(REG_14B8H, 0x00000040U);
        WAIT_STS(REG_142CH, 12, 0);
