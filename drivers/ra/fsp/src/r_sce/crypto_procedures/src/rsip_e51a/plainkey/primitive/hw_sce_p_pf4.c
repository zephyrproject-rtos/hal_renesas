                                               ...
                                               uint32_t       OutData_PrivKey[])
{
    ...
    else
    {
        ...
        else
        {
            ...
            HW_SCE_p_func100(0x8dd53a1fU, 0xdb0e9044U, 0xb8c4012cU, 0x1337f2a8U);
            WR1_PROG(REG_143CH, 0x00400000U);

            if (CHCK_STS(REG_143CH, 22, 1))
            {
                HW_SCE_p_func100(0x789f20bdU, 0x9d53ea2dU, 0xea2b0eb7U, 0xdac3df32U);
                HW_SCE_p_func103();
                WR1_PROG(REG_1444H, 0x000000a2U);
                WR1_PROG(REG_1A24H, 0x0c200104U);
                WAIT_STS(REG_1444H, 31, 1);
                ...
                HW_SCE_p_func101(0x13131ca3U, 0x65e1d3dcU, 0x06c102c6U, 0xd1c1b9f8U);
                HW_SCE_p_func043_r1();
                ...
                HW_SCE_p_func101(0xf806a3f4U, 0xd261bb79U, 0xe883396fU, 0xcf429931U);
            }
            else
            {
                HW_SCE_p_func100(0xd4334247U, 0x94cedbcdU, 0x7a95ab4fU, 0xc44d1f4cU);
                WR1_PROG(REG_1404H, 0x13200000U);
                ...
                HW_SCE_p_func101(0x5bd1ef3bU, 0x23b053bbU, 0x67f766a9U, 0x12ffcafdU);
            }

            HW_SCE_p_func100(0xad689995U, 0x79e04765U, 0xc4f1611eU, 0xb7f1af37U);
            ...
            HW_SCE_p_func100(0x392f9554U, 0x25e1f38dU, 0x03e0e351U, 0xd5901ac6U);
            ...
            HW_SCE_p_func102(0x13d20c97U, 0x7612081bU, 0x28af9132U, 0x2b134848U);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
