                                                   ...
                                                   uint32_t       OutData_Text[])
{
    ...
    HW_SCE_p_func100(0x48d3dd61U, 0x776cb4a0U, 0xcab61a94U, 0x4d9ff328U);
    ...
    if (CHCK_STS(REG_143CH, 22, 1))
    {
        ...
        HW_SCE_p_func101(0x40e37c3dU, 0xc5d22dd0U, 0x5f103f90U, 0x769e6274U);
        HW_SCE_p_func043_r1();
        ...
        HW_SCE_p_func101(0x60960357U, 0xb2027543U, 0xdd1eff9cU, 0xfcdea37eU);
    }
    else
    {
        WR1_PROG(REG_1444H, 0x0000ffc2U);
        ...
        HW_SCE_p_func101(0x61a0df1fU, 0x026f3f28U, 0x2484d943U, 0x85b0b9e4U);
    }

    HW_SCE_p_func100(0xcc070660U, 0xd600194aU, 0x62fba44eU, 0xf8842a09U);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0x8dd29adaU, 0xf0ab3957U, 0x70bf7572U, 0xcf2d534cU);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x977f8be6U, 0x27c38247U, 0xcef68320U, 0xf9923107U);
        WR1_PROG(REG_143CH, 0x00400000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func102(0x049c42a6U, 0x266569b6U, 0xd76541e7U, 0x3eec7fe5U);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        ...
        {
            HW_SCE_p_func100(0x81284d43U, 0x51720c7eU, 0x96723506U, 0xee8c7a90U);
            ...
            for (iLoop = 0U; iLoop < 128U; )
            {
                ...
                HW_SCE_p_func100(0x3b1031adU, 0x55d8b236U, 0x26752cb8U, 0x45d0ae28U);
                ...
                HW_SCE_p_func101(0xa8b73162U, 0xdbfe7545U, 0x2b152dffU, 0x6bb41b12U);
                iLoop = iLoop + 8U;
            }
            ...
            HW_SCE_p_func100(0xb638df8eU, 0x4720a8e5U, 0xff139dbaU, 0xa6f718e9U);
            WR1_PROG(REG_1408H, 0x00020000U);

            HW_SCE_p_func102(0xed67dd90U, 0x66c17637U, 0x98120009U, 0xd61172b4U);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
