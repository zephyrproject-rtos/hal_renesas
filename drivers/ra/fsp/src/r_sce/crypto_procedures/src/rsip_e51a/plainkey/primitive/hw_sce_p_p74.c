...
fsp_err_t HW_SCE_Sha224HmacMessageDigest (const uint32_t InData_KeyMode[],
                                          ...
                                          const uint32_t MAX_CNT)
{
    ...
    HW_SCE_p_func100(0x2e919915U, 0xeb2aba5eU, 0x9c60161dU, 0x99888facU);
    ...
    if (CHCK_STS(REG_143CH, 22, 1))
    {
        ...
        HW_SCE_p_func101(0x1a11f6ddU, 0xda94645fU, 0x46492283U, 0x42f94d39U);
        HW_SCE_p_func043_r1();
        ...
        HW_SCE_p_func101(0x3ab5477fU, 0x91c1bd24U, 0x215bdbb0U, 0xda43a0b0U);
    }
    else
    {
        WR1_PROG(REG_1600H, 0x00000800U);
        ...
        HW_SCE_p_func101(0x1fd946adU, 0xb70df681U, 0x4301c3a2U, 0x906846acU);
    }

    HW_SCE_p_func100(0xd3136b0eU, 0x7b432a65U, 0x49e445f2U, 0xe7b4f60bU);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0x61779b66U, 0xaf0830edU, 0x08917015U, 0x632fe85fU);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0xe7d7ea1cU, 0xb49b5384U, 0xadfb6a79U, 0xb21385a9U);
        WR1_PROG(REG_143CH, 0x00400000U);
        ...
        if (CHCK_STS(REG_143CH, 22, 1))
        {
            ...
            if ((InData_MsgLen[0] == 0) && (InData_MsgLen[1] == 0))
            {
                ...
                HW_SCE_p_func101(0x817a461fU, 0xde22e6e8U, 0xc9876532U, 0xa272a608U);
            }
            else
            {
                ...
                HW_SCE_p_func101(0xd501c2ceU, 0xad855a31U, 0xe1fd9f0aU, 0xae5e1822U);
            }
        ...
        else
        {
            ...
            HW_SCE_p_func101(0x981da7ecU, 0x8357e022U, 0x94652f50U, 0x9a7950eaU);
        }
