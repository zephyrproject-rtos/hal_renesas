                                                   ...
                                                   uint32_t       OutData_PrivKey[])
{
    ...
    else
    {
        ...
        HW_SCE_p_func100(0xe7134de0U, 0x431aa142U, 0x1772b652U, 0x512e569dU);
        WR1_PROG(REG_143CH, 0x00400000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func100(0x3681d3b3U, 0xd18cb468U, 0x5fac953eU, 0x997e1a2cU);
            HW_SCE_p_func103();
            ...
            HW_SCE_p_func101(0x0bb17574U, 0x88e78d08U, 0xfc2c8543U, 0x6c125d48U);
            HW_SCE_p_func043_r1();
            ...
            HW_SCE_p_func101(0xc7ea469bU, 0x7252b378U, 0xc445ebf4U, 0x8510d446U);
        }
        else
        {
            HW_SCE_p_func100(0xcf2d1978U, 0xe4307402U, 0x9c5e4b2bU, 0x5abd31bfU);
            WR1_PROG(REG_1A2CH, 0x40000200U);
            ...
            HW_SCE_p_func101(0xad3904f6U, 0x73d4d1aeU, 0xc6847d96U, 0xe93d42b0U);
        }

        HW_SCE_p_func100(0x657ea9cdU, 0x464963c4U, 0x304e52dbU, 0xfcc69ab2U);
        WR1_PROG(REG_1A2CH, 0x40000200U);
        WR1_PROG(REG_1A24H, 0x08008107U);
        ...
        HW_SCE_p_func100(0x544d4f9aU, 0xcdedc0dfU, 0xca25c80fU, 0xd756ed67U);
        WR1_PROG(REG_1A2CH, 0x40000200U);
        WR1_PROG(REG_1A24H, 0x08008107U);
        ...
        HW_SCE_p_func102(0xfcdc88eeU, 0x09c16bb8U, 0x42dd6baaU, 0x5450bf3dU);
        WR1_PROG(REG_14B8H, 0x00000040U);
        WAIT_STS(REG_142CH, 12, 0);
