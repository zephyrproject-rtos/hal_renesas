...
void HW_SCE_Aes256GcmDecryptUpdateSub(const uint32_t *InData_Text, uint32_t *OutData_Text, const uint32_t MAX_CNT)
{
    ...
    (void)OFS_ADR;
    (void)MAX_CNT2;
    HW_SCE_func001(0x41ac49a8U, 0x867b1918U, 0x06f85819U, 0xfd099f46U);
    SCE->REG_104H = 0x000000b5U;
    ...
    HW_SCE_func206();
    HW_SCE_func002(0x91bb8586U, 0x3ad3c555U, 0x7baf6ed8U, 0xe022da48U);
}

/***********************************************************************************************************************
End of function ./input_dir/HW_SCE_Sec_200408/200408/RA4M1/Cryptographic/HW_SCE_p46.prc
***********************************************************************************************************************/
