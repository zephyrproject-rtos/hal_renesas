...
void HW_SCE_Aes128CcmEncryptUpdateSub(const uint32_t *InData_Text, uint32_t *OutData_Text, const uint32_t MAX_CNT)
{
    ...
    (void)OFS_ADR;
    (void)MAX_CNT2;
    HW_SCE_func001(0x574fb855U, 0x3bb4cd74U, 0x3bb0e245U, 0x4d89454aU);
    SCE->REG_104H = 0x000000b1U;
    SCE->REG_A4H = 0x00e006beU;
    ...
    HW_SCE_func207();
    HW_SCE_func002(0x9ee3ad58U, 0x28328df2U, 0x97d79733U, 0x67b60daaU);
}

/***********************************************************************************************************************
End of function ./input_dir/HW_SCE_Sec_200408/200408/RA4M1/Cryptographic/HW_SCE_p71.prc
***********************************************************************************************************************/
