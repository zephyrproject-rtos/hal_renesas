...
void HW_SCE_Aes128CcmDecryptUpdateSub(const uint32_t *InData_Text, uint32_t *OutData_Text, const uint32_t MAX_CNT)
{
    ...
    (void)OFS_ADR;
    (void)MAX_CNT2;
    HW_SCE_func001(0x8fcd9e5fU, 0x6f9ca8f0U, 0x22e9a3dfU, 0x249a2646U);
    ...
    HW_SCE_func207();
    HW_SCE_func002(0x48ebfd0eU, 0xf475c055U, 0x9348b29fU, 0xaada3241U);
}

/***********************************************************************************************************************
End of function ./input_dir/HW_SCE_Sec_230630/230630/RA4M1/Cryptographic/HW_SCE_p74_r1.prc
***********************************************************************************************************************/
