...
void HW_SCE_Aes256CcmEncryptUpdateSub(const uint32_t *InData_Text, uint32_t *OutData_Text, const uint32_t MAX_CNT)
{
    ...
    (void)OFS_ADR;
    (void)MAX_CNT2;
    HW_SCE_func001(0xd86ce509U, 0xa426411bU, 0x0ecedb6bU, 0x1d12ffb6U);
    SCE->REG_104H = 0x000000b1U;
    SCE->REG_B0H = 0x40000000U;
    SCE->REG_A4H = 0x00e086beU;
    ...
    HW_SCE_func207();
    HW_SCE_func002(0xffe1cab8U, 0x6d4114bdU, 0x942c97ddU, 0x3b98d4a8U);
}

/***********************************************************************************************************************
End of function ./input_dir/HW_SCE_Sec_200408/200408/RA4M1/Cryptographic/HW_SCE_p77.prc
***********************************************************************************************************************/
