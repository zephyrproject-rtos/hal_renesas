...
fsp_err_t HW_SCE_Aes128GcmEncryptFinalSub(const uint32_t *InData_Text, const uint32_t *InData_TextLen, const uint32_t *InData_DataALen, uint32_t *OutData_Text, uint32_t *OutData_DataT)
{
    ...
    HW_SCE_p_func100(0x2c66c2a4U, 0xc2eb5cfaU, 0x1d714d5dU, 0xbb0b2839U);
    ...
    if (1U == (SCE->REG_1CH_b.B22))
    {
        ...
        SCE->REG_E0H = 0x00000080U;
        SCE->REG_1CH = 0x00260000U;
        HW_SCE_p_func101(0xbbf5c6ccU, 0x75486aeaU, 0x47964e72U, 0x23095891U);
    }
    else
    {
        SCE->REG_ECH = 0x0000b580U;
        ...
        SCE->REG_E0H = 0x00000080U;
        SCE->REG_1CH = 0x00260000U;
        HW_SCE_p_func101(0xf1eb4b3bU, 0x181c87e8U, 0x7dadf7c5U, 0x2f2766a4U);
    }
    HW_SCE_p_func100(0xc0fd4e69U, 0x3ba09400U, 0x06086078U, 0x1b079f81U);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        HW_SCE_p_func102(0x4f90e3d0U, 0x8b465689U, 0x00083e4cU, 0x5fa523cfU);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0xfe2b5eb8U, 0x09f40409U, 0x07449ce9U, 0x86116556U);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            ...
            HW_SCE_p_func100(0xe989d8f1U, 0x3c5db4caU, 0x30a5e09aU, 0x2dd6ef26U);
            ...
            HW_SCE_p_func101(0xaa2db342U, 0xfdbf9a4bU, 0x6feabdf1U, 0xde682364U);
        }
        ...
        SCE->REG_1CH = 0x00001800U;
        HW_SCE_p_func100(0x20b2bf1fU, 0x7ec79001U, 0x6ab17f25U, 0x01bf43ccU);
        SCE->REG_B0H = 0x00000020U;
        SCE->REG_A4H = 0x000087b5U;
        ...
        HW_SCE_p_func102(0x5fbe76abU, 0xba1b0bb7U, 0x6c4d225dU, 0x2ab8c3f6U);
        SCE->REG_1BCH = 0x00000040U;
        /* WAIT_LOOP */
        while (0U != SCE->REG_18H_b.B12)
        {
...
/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic_PlainKey/HW_SCE_p_p29f_r2.prc
***********************************************************************************************************************/
