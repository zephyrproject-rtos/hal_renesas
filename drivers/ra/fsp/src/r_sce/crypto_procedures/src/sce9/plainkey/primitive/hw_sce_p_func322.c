...
void HW_SCE_p_func322(uint32_t ARG1)
{
    ...
    (void)OFS_ADR;
    (void)MAX_CNT2;
    SCE->REG_104H = 0x00002362U;
    SCE->REG_D0H = 0x00000800U;
    ...
    for (iLoop2 = 0; iLoop2 < 36 ; iLoop2 = iLoop2 + 4)
    {
        ...
        SCE->REG_100H = S_HEAP[ARG1+iLoop2 + 0];
...
/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic_PlainKey/HW_SCE_p_func322.prc
***********************************************************************************************************************/
