...
void HW_SCE_Aes128XtsEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)OFS_ADR;
    (void)MAX_CNT2;
    HW_SCE_p_func100(0xa4bb076dU, 0x0493889bU, 0x2b873600U, 0x5c4453d2U);
    ...
    HW_SCE_p_func101(0x0c801001U, 0x701d60a4U, 0xeabcd548U, 0xb097d101U);
}

/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic_PlainKey/HW_SCE_p_pb3u.prc
***********************************************************************************************************************/
