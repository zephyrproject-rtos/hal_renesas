...
fsp_err_t HW_SCE_Aes192CcmDecryptInitSub(uint32_t *InData_KeyIndex, uint32_t *InData_IV, uint32_t *InData_Header, uint32_t Header_Len)
{
    ...
    SCE->REG_100H = change_endian_long(0x000000b0U);
    HW_SCE_p_func101(0xbdd17f39U, 0x08088efeU, 0x35974f03U, 0x7e5b170cU);
    HW_SCE_p_func043();
    ...
    SCE->REG_100H = change_endian_long(0x000000b0U);
    HW_SCE_p_func101(0x42001f4cU, 0xd3136d01U, 0x69ac7c8bU, 0xc56dd6b8U);
    HW_SCE_p_func044();
    HW_SCE_p_func100(0xb415d07fU, 0x65b938e5U, 0xbcbe29a7U, 0xb22a1080U);
    ...
    HW_SCE_p_func100(0xc53a1e0fU, 0x2de3033dU, 0xf96b4fd1U, 0x9b9529f2U);
    ...
    SCE->REG_1CH = 0x00001800U;
    HW_SCE_p_func100(0x6d67554cU, 0xaf4b35f3U, 0x9e34693bU, 0x6a7e461bU);
    SCE->REG_1CH = 0x00400000U;
    SCE->REG_1D0H = 0x00000000U;
    if (1U == (SCE->REG_1CH_b.B22))
    {
        HW_SCE_p_func102(0x8be5abacU, 0x4d261e29U, 0x2edada3eU, 0x7140c6e9U);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0xd160a2aeU, 0x155a728eU, 0x8e7b2421U, 0xfd62a0e3U);
        SCE->REG_1CH = 0x00400000U;
        SCE->REG_1D0H = 0x00000000U;
        if (1U == (SCE->REG_1CH_b.B22))
        {
            HW_SCE_p_func102(0xfca9b293U, 0xe2bd4011U, 0x35a81beaU, 0x56d06150U);
            SCE->REG_1BCH = 0x00000040U;
            /* WAIT_LOOP */
            while (0U != SCE->REG_18H_b.B12)
            {
...
/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic_PlainKey/HW_SCE_p_pb0i.prc
***********************************************************************************************************************/
