...
fsp_err_t HW_SCE_Aes256CmacInitSub (const uint32_t InData_KeyMode[], const uint32_t InData_KeyIndex[], const uint32_t InData_Key[])
{
    ...
    HW_SCE_p_func100(0x92cb26eeU, 0x9c46bf61U, 0x2f3d503bU, 0x7f6cb1baU);
    ...
    if (CHCK_STS(REG_40H, 22, 1))
    {
        ...
        HW_SCE_p_func101(0x7411266aU, 0x3f75ac3bU, 0xc6828304U, 0xa5cce4e8U);
        HW_SCE_p_func043();
        ...
        HW_SCE_p_func101(0x3ecc4b5bU, 0x520c4460U, 0x3a8930d3U, 0x3505d706U);
        HW_SCE_p_func044();
        ...
        HW_SCE_p_func101(0x852e9c01U, 0x7a8b40b2U, 0x04d5d6b4U, 0x6c8ccb89U);
    }
    else
    {
        ...
        HW_SCE_p_func101(0x5b01e920U, 0xde392ed2U, 0x1011095bU, 0x5e274941U);
    }

    HW_SCE_p_func100(0x33a19901U, 0xc7968c93U, 0xfcdbd693U, 0xe0be5d6fU);
    WR1_PROG(REG_40H, 0x00400000U);
    WR1_PROG(REG_24H, 0x00000000U);

    if (CHCK_STS(REG_40H, 22, 1))
    {
        HW_SCE_p_func102(0xbdc927dfU, 0xd5e4152aU, 0x29a9457bU, 0x3d7c093bU);
    ...
    {
        HW_SCE_p_func100(0xa0865845U, 0xe0e3fc7cU, 0x4acb23b6U, 0xebb07d47U);
        ...
        HW_SCE_p_func100(0x2bf1136cU, 0xd7cb8c22U, 0xeacaac42U, 0x035f0387U);
        ...
        HW_SCE_p_func101(0xdaace5c5U, 0x6efa994fU, 0xac697844U, 0x908b4552U);
