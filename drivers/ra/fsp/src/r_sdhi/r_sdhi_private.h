...
#define SDHI_PRV_CSD_VERSION_2_0                                               \
  (1U) /* value of 1 is CSD 2.0 according to SD spec. */
...
#define SDHI_PRV_OCR_VDD_SUPPORTED                                             \
  (SDHI_PRV_OCR_VDD_2_7_V | SDHI_PRV_OCR_VDD_2_8_V | SDHI_PRV_OCR_VDD_2_9_V |  \
   SDHI_PRV_OCR_VDD_3_0_V | SDHI_PRV_OCR_VDD_3_1_V | SDHI_PRV_OCR_VDD_3_2_V |  \
...
#define SDHI_PRV_EMMC_HIGH_SPEED_MODE                                          \
  (((SDHI_PRV_EMMC_SWITCH_ACCESS_WRITE_BYTE << 24U) |                          \
...
#define SDHI_PRV_EMMC_CMD_SWITCH_WBUSY                                         \
  (0x506U) /* eMMC CMD6 switch command "with response busy" */
...
typedef struct st_sdmmc_priv_csd_reg {
  union {
    ...
    /* All structures in this union must be packed since some bitfields span
     * more than one 32-bit word. */
