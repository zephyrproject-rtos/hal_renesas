...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                   (0x001F7FFFUL)    // Mask of available channels in ADC unit 0.
...
#define BSP_FEATURE_BSP_HAS_DCDC_REGULATOR                (1UL)             // DCDCCTL register is present in SYSC.
