...
#define BSP_FEATURE_BSP_HAS_DSMIF_CLOCK                           (1UL)             // Flag indicating an extra peripheral clock is present.
#define BSP_FEATURE_BSP_HAS_DTCM                                  (1UL)             // Indicates DTCM is available.
#define BSP_FEATURE_BSP_HAS_ESC_CLOCK                             (1UL)             // Flag indicating an extra peripheral clock is present.
...
#define BSP_FEATURE_ESC_NUM_PORTS                                 (2UL)             // Number of ports available.
...
#define BSP_FEATURE_ICU_WUPEN_MASK                                (0xFFFF7F88FB1DFFFFULL)   // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_LPM_DPSIER_MASK                               (0x0000FFFFED1FFFFFULL)   // Mask of valid bit-fields of the DPSIERn registers.
