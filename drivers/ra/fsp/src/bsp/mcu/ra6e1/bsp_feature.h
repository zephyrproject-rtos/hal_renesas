...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS_MASK                      (0x31FFUL)        // Mask of available channels in ADC unit 0.
...
#define BSP_FEATURE_GPT_EVENT_COUNT_CHANNEL_MASK                  (0xF6UL)          // Mask of channels that support event count input (has GTUPSR register).
...
#define BSP_FEATURE_GPT_GTDVU_CHANNEL_MASK                        (0xF6UL)          // Mask of channels that support dead time control.
...
#define BSP_FEATURE_SCI_LIN_CHANNELS_MASK                         (0x04UL)          // Mask of channels that can support LIN.
