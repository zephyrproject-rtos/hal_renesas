...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                           (0x31FFUL)        // Mask of available channels in ADC unit 0.
...
#define BSP_FEATURE_SCI_LIN_CHANNELS                              (0x04UL)          // Mask of channels that can support LIN.
