...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                   (0x000F01FFUL)    // Mask of available channels in ADC unit 0.
#define BSP_FEATURE_ADC_UNIT_1_CHANNELS                   (0x007F007FUL)    // Mask of available channels in ADC unit 1.
