...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS_MASK                      (0x03FE007FUL)    // Mask of available channels in ADC unit 0.
...
#define BSP_FEATURE_CGC_PLL_OUT_MAX_HZ                            (80000000UL)      // Maximum output frequency for PLL unit 1.
...
#define BSP_FEATURE_CGC_PLLCCR_TYPE                               (5UL)             // Indicates the type of PLLCCR register and PLL.
...
#define BSP_FEATURE_CGC_STARTUP_SCKDIVCR                          (0x44004444UL)    // Reset value for the SCKDIVCR register.
...
#define BSP_FEATURE_FLASH_HP_CF_REGION0_BLOCK_SIZE                (0x0800UL)        // Block size of region 0.
#define BSP_FEATURE_FLASH_HP_CF_REGION0_SIZE                      (0x00010000UL)    // Size of region 0.
#define BSP_FEATURE_FLASH_HP_CF_REGION1_BLOCK_SIZE                (0x0800UL)        // Block size of region 1.
#define BSP_FEATURE_FLASH_HP_CF_WRITE_SIZE                        (8UL)             // Write size for code flash.
#define BSP_FEATURE_FLASH_HP_DF_BLOCK_SIZE                        (256UL)           // Block size of data flash.
#define BSP_FEATURE_FLASH_HP_DF_WRITE_SIZE                        (1UL)             // Write size for data flash.
...
#define BSP_FEATURE_FLASH_HP_VERSION                              (4UL)             // Version of the FLASH_HP (FACI) peripheral/hardware.
...
#define BSP_FEATURE_ICU_HAS_LOCO_FILTER                           (1UL)             // Register IRQCR has LOCOSEL.
#define BSP_FEATURE_ICU_HAS_WUPEN1                                (1UL)             // WUPEN1 register is available.
#define BSP_FEATURE_ICU_HAS_WUPEN2                                (1UL)             // WUPEN2 register is available.
...
#define BSP_FEATURE_ICU_WUPEN_MASK                                (0x00000080F30DFFFFULL)   // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_LPM_SNZREQCR_MASK                             (0x7300FFFFULL)   // Mask of valid bits for the SNZREQCRn registers.
...
#define BSP_FEATURE_LVD_EXLVDVBAT_HI_THRESHOLD                    (LVD_THRESHOLD_EXLVDVBAT_LEVEL_3_08V) // External LVD for VBAT reference voltage high threshold.
#define BSP_FEATURE_LVD_EXLVDVBAT_LOW_THRESHOLD                   (LVD_THRESHOLD_EXLVDVBAT_LEVEL_1_59V) // External LVD for VBAT reference voltage low threshold.
#define BSP_FEATURE_LVD_EXLVDVRTC_HI_THRESHOLD                    (LVD_THRESHOLD_LVDVRTC_LEVEL_2_99V)   // External LVD for VRTC reference voltage high threshold.
#define BSP_FEATURE_LVD_EXLVDVRTC_LOW_THRESHOLD                   (LVD_THRESHOLD_LVDVRTC_LEVEL_1_59V)   // External LVD for VRTC reference voltage low threshold.
...
#define BSP_FEATURE_LVD_MONITOR_1_HI_THRESHOLD                    (LVD_THRESHOLD_MONITOR_1_LEVEL_3_10V) // Typical higher bound of the detection threshold for LVD1.
...
#define BSP_FEATURE_LVD_MONITOR_2_HI_THRESHOLD                    (LVD_THRESHOLD_MONITOR_2_LEVEL_3_13V) // Typical higher bound of the detection threshold for LVD2.
#define BSP_FEATURE_LVD_MONITOR_2_LOW_THRESHOLD                   (LVD_THRESHOLD_MONITOR_2_LEVEL_1_67V) // Typical lower bound of the detection threshold for LVD2.
...
#define BSP_FEATURE_LVD_VRTC_LVL_STABILIZATION_TIME_US            (300UL)           // Stabilization wait time after writing to VRTLVDCR.LVL.
...
#define BSP_FEATURE_RSIP_RSIP_E31A_SUPPORTED                      (1UL)             // The device supports cryptography using RSIP-E31A.
...
#define BSP_FEATURE_RTC_HAS_RADJ_ADJ6                             (1UL)             // ADJ6 is appended to upper part of RADJ.ADJ[0:5] as ADJ[6].
...
#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS_MASK               (0x0239UL)        // Mask of channels with data compare match (DCCR) available.
#define BSP_FEATURE_SCI_CHANNELS_MASK                             (0x023BUL)        // Mask of available SCI channels.
...
#define BSP_FEATURE_SCI_IRDA_CHANNEL_MASK                         (0x20UL)          // Mask of channels that support IrDA.
#define BSP_FEATURE_SCI_IRDA_SUPPORTED                            (1UL)             // Indicates IrDA is supported on at least one SCI channel.
#define BSP_FEATURE_SCI_LIN_CHANNELS_MASK                         (0x02UL)          // Mask of channels that can support LIN.
#define BSP_FEATURE_SCI_SPI_SCKSEL_MASK                           (0UL)             // Mask indicating CCR4.SCKSEL is available.
#define BSP_FEATURE_SCI_UART_ABCSE_RESTRICTED_CHANNELS_MASK       (0x02UL)          // List of channels that do not support ABCSE functionality.
#define BSP_FEATURE_SCI_UART_CSTPEN_CHANNELS_MASK                 (0x0239UL)        // Mask of channels which support CTS external pins.
...
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS_MASK                   (0x0239UL)        // Mask of channels which support the UART FIFO.
...
#define BSP_FEATURE_SLCDC_MAX_NUM_SEG                             (47UL)            // Maximum index of supported segment registers.
...
#define BSP_FEATURE_SPI_NUM_CHANNELS                              (3UL)             // Number of available SPI channels.
#define BSP_FEATURE_SPI_SSL_LEVEL_KEEP_VALID_CHANNEL_MASK         (0x07UL)          // Mask of channel indices that support SSL Level Keep.
...
#define BSP_FEATURE_TSN_HAS_LOW_TEMP_REG                          (1UL)             // Determine if the TSCDRL (Low Temperature) is present.
#define BSP_FEATURE_TSN_HAS_ROOM_TEMP_REG                         (1UL)             // Determine if the TSCDRR (Room Temperature) is present.
...
#define BSP_FEATURE_UARTA_HAS_CLOCK_OUTPUT                        (1UL)             // CLKAn can be output from the device.
#define BSP_FEATURE_UARTA_MSTP_OFFSET                             (0UL)             // Offset for the UARTA MSTP bit.
#define BSP_FEATURE_UARTA_PCLK_RESTRICTION                        (1UL)             // The peripheral clock for UARTA must be >= the UARTn operating clock.
