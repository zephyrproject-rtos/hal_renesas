...
#define BSP_FEATURE_DAC_AD_SYNC_UNIT_MASK                    (0U) // Do not need to select ADC Unit on this MCU
...
#define BSP_FEATURE_SLCDC_CONTRAST_MAX_4BIAS                 (6U)
#define BSP_FEATURE_SLCDC_CONTRAST_MAX                       (15U)
