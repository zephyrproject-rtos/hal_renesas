...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS_MASK                      (0x001700EFUL)    // Mask of available channels in ADC unit 0.
#define BSP_FEATURE_ADC_UNIT_1_CHANNELS_MASK                      (0x000300E7UL)    // Mask of available channels in ADC unit 1.
...
#define BSP_FEATURE_BSP_POWER_CHANGE_MSTP_REQUIRED                (1UL)             // Indicates extra modules must be manually stopped before switching the system clock from the PLL.
...
#define BSP_FEATURE_CGC_HOCOWTCR_SCI_SNOOZE_VALUE                 (2UL)             // HOCO stabilization wait time when using SCI0.
...
#define BSP_FEATURE_CGC_STARTUP_SCKDIVCR2                         (0x40UL)          // Reset value for the SCKDIVCR2 register.
...
#define BSP_FEATURE_FLASH_HP_FCACHE_DISABLE_BEFORE_PE             (1UL)             // Constraints exist for flash cache operation during flash programming access.
...
#define BSP_FEATURE_GPT_32BIT_CHANNEL_MASK                        (0x1FFFUL)        // Mask of 32-bit GPT channel indices.
...
#define BSP_FEATURE_GPT_EVENT_COUNT_CHANNEL_MASK                  (0x1FFFUL)        // Mask of channels that support event count input (has GTUPSR register).
#define BSP_FEATURE_GPT_EVENT_COUNT_SUPPORTED                     (1UL)             // At least one channel supports event counts.
#define BSP_FEATURE_GPT_GPTE_CHANNEL_MASK                         (0xF0UL)          // Mask of GPT channels that are the GPTE implementation.
...
#define BSP_FEATURE_GPT_GTDVU_CHANNEL_MASK                        (0x1FFFUL)        // Mask of channels that support dead time control.
...
#define BSP_FEATURE_GPT_MSTP_MSTPD5_MAX_CH                        (7UL)             // Largest channel number associated with GPT on the MSTPCRD.MSTPD5 field on this MCU.
...
#define BSP_FEATURE_GPT_ODC_FREQ_MAX                              (120000000UL)     // Maximum supported frequency of the PWM Delay Generation circuit.
...
#define BSP_FEATURE_ICU_IRQ_CHANNELS_MASK                         (0x3FFFUL)        // Mask of available IRQ control registers.
...
#define BSP_FEATURE_ICU_WUPEN_MASK                                (0xFB4F3FFFULL)   // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_LPM_CHANGE_MSTP_ARRAY                         {{(1UL), (31UL)}, {(2UL), (5UL)}} // An array of tuples (MSTP index, bit) that indicate which modules must enter the stop state before the system enters low power mode or when changes to SCKDIVCR are made.
#define BSP_FEATURE_LPM_CHANGE_MSTP_REQUIRED                      (1UL)             // Indicates some modules must be explicitly stopped before entering low power modes or changing SCKDIVCR.
#define BSP_FEATURE_LPM_DPSIEGR_MASK                              (0x00131FF3ULL)   // Mask of valid bit-fields of the DPSIEGRn registers.
#define BSP_FEATURE_LPM_DPSIER_MASK                               (0x051F1FF3ULL)   // Mask of valid bit-fields of the DPSIERn registers.
...
#define BSP_FEATURE_LPM_HAS_STCONR                                (1UL)             // The STCONR register is available.
...
#define BSP_FEATURE_LPM_SNZEDCR_MASK                              (0xFFUL)          // Mask of valid bits for the SNZEDCRn registers.
#define BSP_FEATURE_LPM_SNZREQCR_MASK                             (0x73423FFFULL)   // Mask of valid bits for the SNZREQCRn registers.
...
#define BSP_FEATURE_RSIP_SCE7_SUPPORTED                           (1UL)             // The device supports cryptography using SCE7.
...
#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS_MASK               (0x031FUL)        // Mask of channels with data compare match (DCCR) available.
#define BSP_FEATURE_SCI_CHANNELS_MASK                             (0x031FUL)        // Mask of available SCI channels.
...
#define BSP_FEATURE_SCI_IRDA_CHANNEL_MASK                         (0x02UL)          // Mask of channels that support IrDA.
#define BSP_FEATURE_SCI_IRDA_SUPPORTED                            (1UL)             // Indicates IrDA is supported on at least one SCI channel.
...
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS_MASK                   (0x031FUL)        // Mask of channels which support the UART FIFO.
...
#define BSP_FEATURE_SDHI_CLOCK                                    (FSP_PRIV_CLOCK_PCLKA)    // Clock source for the SDHI peripheral clock.
...
#define BSP_FEATURE_SDHI_MIN_CLOCK_DIVISION_SHIFT                 (1UL)             // Smallest shift value for the divider pre-scaller available on the SDHI clock.
...
#define BSP_FEATURE_SRAM_SRAMWTSC_WAIT_CYCLE_ENABLE               (0x0EUL)          // Mask of bits needed to enable SRAM wait for all regions.
...
#define BSP_FEATURE_SYSC_CLOCK_FREQ_NO_RAM_WAITS                  (60000000UL)      // The maximum frequency that can be used before wait cycles are necessary.
#define BSP_FEATURE_SYSC_CLOCK_FREQ_ONE_ROM_WAITS                 (40000000UL)      // Maximum frequency allowed before requiring one wait cycle.
#define BSP_FEATURE_SYSC_CLOCK_FREQ_THREE_ROM_WAITS               (0UL)             // Maximum frequency allowed before requiring three wait cycles.
#define BSP_FEATURE_SYSC_CLOCK_FREQ_TWO_ROM_WAITS                 (80000000UL)      // Maximum frequency allowed before requiring two wait cycles.
...
#define BSP_FEATURE_TSN_CALIBRATION32_MASK                        (0x0FFFUL)        // Mask of valid bits for TSN calibration.
...
#define BSP_FEATURE_USB_HAS_CLOCK_SEL                             (0UL)             // Indicates the USB clock has a selectable source.
...
#define BSP_FEATURE_USB_REG_PHYSLEW                               (1UL)             // Indicates the PHYSLEW register is available.
#define BSP_FEATURE_USB_REG_PHYSLEW_VALUE                         (0x0EUL)          // Reset value of the PHYSLEW register.
...
#define BSP_FEATURE_USB_SCKDIVCR2_HAS_CLOCK_DIV                   (1UL)             // Indicates there is a USB clock divider setting as part of the SCKDIVCR2 register.
