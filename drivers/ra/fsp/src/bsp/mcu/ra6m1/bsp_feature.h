...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                           (0x001700EFUL)    // Mask of available channels in ADC unit 0.
#define BSP_FEATURE_ADC_UNIT_1_CHANNELS                           (0x000300E7UL)    // Mask of available channels in ADC unit 1.
...
#define BSP_FEATURE_BSP_MSTP_GPT_MSTPD5_MAX_CH                    (7UL)             // Largest channel number associated with GPT on the MSTPCRD.MSTPD5 field on this MCU.
...
#define BSP_FEATURE_BSP_SCKDIVCR2_HAS_USB_CLOCK_DIV               (1UL)             // Indicates there is a USB clock divider setting as part of the SCKDIVCR2 register.
...
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_NO_RAM_WAITS               (60000000UL)      // The maximum frequency that can be used before wait cycles are necessary.
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_ONE_ROM_WAITS              (40000000UL)      // Maximum frequency allowed before requiring one wait cycle.
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_THREE_ROM_WAITS            (0UL)             // Maximum frequency allowed before requiring three wait cycles.
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_TWO_ROM_WAITS              (80000000UL)      // Maximum frequency allowed before requiring two wait cycles.
...
#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS                    (0x031FUL)        // Mask of channels with data compare match (DCCR) available.
#define BSP_FEATURE_SCI_CHANNELS                                  (0x031FUL)        // Mask of available SCI channels.
...
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS                        (0x031FUL)        // Mask of channels which support the UART FIFO.
