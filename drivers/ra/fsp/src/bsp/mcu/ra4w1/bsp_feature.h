...
#define BSP_FEATURE_ADC_TSN_SLOPE                         (-3650LL)         // Typical slope for the temperature sensor, in uV/degC.
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                   (0x001A0670UL)    // Mask of available channels in ADC unit 0.
...
#define BSP_FEATURE_FLASH_LP_FLASH_CLOCK_SRC              ((fsp_priv_clock_t) FSP_PRIV_CLOCK_FCLK)  // Clock source for the flash memory.
...
#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS            (0x0213UL)        // Mask of channels with data compare match (DCCR) available.
#define BSP_FEATURE_SCI_CHANNELS                          (0x0213UL)        // Mask of available SCI channels.
