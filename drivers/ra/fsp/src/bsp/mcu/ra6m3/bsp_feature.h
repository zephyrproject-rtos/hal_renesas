...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS_MASK                      (0x001F00FFUL)    // Mask of available channels in ADC unit 0.
#define BSP_FEATURE_ADC_UNIT_1_CHANNELS_MASK                      (0x000F00EFUL)    // Mask of available channels in ADC unit 1.
...
#define BSP_FEATURE_ICU_WUPEN_MASK                                (0xFF4FFFFFULL)   // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_LPM_CHANGE_MSTP_ARRAY                         {{(0UL), (15UL)}, {(0UL), (13UL)}, {(1UL), (31UL)}, {(1UL), (6UL)}, {(1UL), (5UL)}, {(1UL), (4UL)}, {(2UL), (5UL)}}   // An array of tuples (MSTP index, bit) that indicate which modules must enter the stop state before the system enters low power mode or when changes to SCKDIVCR are made.
...
#define BSP_FEATURE_LPM_DPSIEGR_MASK                              (0x00137FFFULL)   // Mask of valid bit-fields of the DPSIEGRn registers.
#define BSP_FEATURE_LPM_DPSIER_MASK                               (0x071F7FFFULL)   // Mask of valid bit-fields of the DPSIERn registers.
...
#define BSP_FEATURE_LPM_SNZREQCR_MASK                             (0x7342FFFFULL)   // Mask of valid bits for the SNZREQCRn registers.
...
#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS_MASK               (0x03FFUL)        // Mask of channels with data compare match (DCCR) available.
...
#define BSP_FEATURE_SDRAM_START_ADDRESS                           (0x90000000UL)    // Start address of the external address space for SDRAM memory.
