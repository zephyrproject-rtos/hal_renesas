...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                           (0x001F00FFUL)    // Mask of available channels in ADC unit 0.
#define BSP_FEATURE_ADC_UNIT_1_CHANNELS                           (0x000F00EFUL)    // Mask of available channels in ADC unit 1.
...
#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS                    (0x03FFUL)        // Mask of channels with data compare match (DCCR) available.
