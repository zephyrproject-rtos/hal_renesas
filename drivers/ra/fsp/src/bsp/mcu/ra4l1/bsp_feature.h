...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS_MASK                      (0x03FF007FUL)    // Mask of available channels in ADC unit 0.
...
#define BSP_FEATURE_ICU_WUPEN_MASK                                (0x00000880FB8DFFFFULL)   // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_LPM_SNZEDCR_MASK                              (0x029FUL)        // Mask of valid bits for the SNZEDCRn registers.
#define BSP_FEATURE_LPM_SNZREQCR_MASK                             (0x7380FFFFULL)   // Mask of valid bits for the SNZREQCRn registers.
...
#define BSP_FEATURE_LVD_MONITOR_1_STABILIZATION_TIME_US           (350UL)           // Maximum stabilization time to wait after LVD1 is enabled.
...
#define BSP_FEATURE_LVD_MONITOR_2_STABILIZATION_TIME_US           (650UL)           // Maximum stabilization time to wait after LVD2 is enabled.
...
#define BSP_FEATURE_RSIP_RSIP_E11A_SUPPORTED                      (1UL)             // The device supports cryptography using RSIP-E11A.
...
#define BSP_FEATURE_SLCDC_MAX_NUM_SEG                             (51UL)            // Maximum index of supported segment registers.
