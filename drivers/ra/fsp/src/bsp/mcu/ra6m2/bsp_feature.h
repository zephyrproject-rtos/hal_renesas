...
#define BSP_FEATURE_ADC_UNIT_1_CHANNELS_MASK                      (0x000700E7UL)    // Mask of available channels in ADC unit 1.
...
#define BSP_FEATURE_ICU_WUPEN_MASK                                (0xFB4FFFFFULL)   // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_LPM_CHANGE_MSTP_ARRAY                         {{(0UL), (15UL)}, {(1UL), (31UL)}, {(2UL), (5UL)}}    // An array of tuples (MSTP index, bit) that indicate which modules must enter the stop state before the system enters low power mode or when changes to SCKDIVCR are made.
...
#define BSP_FEATURE_LPM_DPSIEGR_MASK                              (0x00133FFFULL)   // Mask of valid bit-fields of the DPSIEGRn registers.
#define BSP_FEATURE_LPM_DPSIER_MASK                               (0x051F3FFFULL)   // Mask of valid bit-fields of the DPSIERn registers.
