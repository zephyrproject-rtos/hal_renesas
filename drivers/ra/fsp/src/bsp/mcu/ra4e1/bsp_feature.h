...
#define BSP_FEATURE_BSP_MSTP_GPT_MSTPD5_MAX_CH               (0U) // If MSTPCRE is present than the setting is not valid.
...
#define BSP_FEATURE_ELC_PERIPHERAL_MASK                      (0x0003D1FFU) // Deprecated (Removing in FSP v6.0)
...
#define BSP_FEATURE_GPT_VALID_CHANNEL_MASK                   (0x36U)
