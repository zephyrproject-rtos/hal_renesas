...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                           (0x0001381FUL)    // Mask of available channels in ADC unit 0.
...
#define BSP_FEATURE_SCI_CHANNELS                                  (0x0219UL)        // Mask of available SCI channels.
