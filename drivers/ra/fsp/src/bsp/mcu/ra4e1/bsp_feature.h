...
#define BSP_FEATURE_ADC_TSN_SLOPE                                 (0UL)             // DEPRECATED; use BSP_FEATURE_TSN_SLOPE.
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS_MASK                      (0x0001381FUL)    // Mask of available channels in ADC unit 0.
...
#define BSP_FEATURE_AGT_VALID_CHANNEL_MASK                        (0x2FUL)          // A mask of all valid AGTx channels.
...
#define BSP_FEATURE_BSP_NUM_PMSAR                                 (6UL)             // Number of available Port Security Attribution Registers.
...
#define BSP_FEATURE_GPT_32BIT_CHANNEL_MASK                        (0x06UL)          // Mask of 32-bit GPT channel indices.
...
#define BSP_FEATURE_GPT_EVENT_COUNT_CHANNEL_MASK                  (0x36UL)          // Mask of channels that support event count input (has GTUPSR register).
...
#define BSP_FEATURE_GPT_GTDVU_CHANNEL_MASK                        (0x36UL)          // Mask of channels that support dead time control.
...
#define BSP_FEATURE_ICU_IRQ_CHANNELS_MASK                         (0x23FFUL)        // Mask of available IRQ control registers.
...
#define BSP_FEATURE_ICU_WUPEN_MASK                                (0x00000007FB0D23FFULL)   // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_LPM_DPSIEGR_MASK                              (0x001303F3ULL)   // Mask of valid bit-fields of the DPSIEGRn registers.
#define BSP_FEATURE_LPM_DPSIER_MASK                               (0x0D1F03F3ULL)   // Mask of valid bit-fields of the DPSIERn registers.
...
#define BSP_FEATURE_LPM_SNZREQCR_MASK                             (0x00000007730023FFULL)   // Mask of valid bits for the SNZREQCRn registers.
...
#define BSP_FEATURE_SCI_CHANNELS_MASK                             (0x0219UL)        // Mask of available SCI channels.
...
#define BSP_FEATURE_TSN_IS_AVAILABLE                              (0UL)
#define BSP_FEATURE_TSN_CALIBRATION_AVAILABLE                     (0UL)             // Feature not available on this device.
#define BSP_FEATURE_TSN_CALIBRATION32_AVAILABLE                   (0UL)             // Feature not available on this device.
#define BSP_FEATURE_TSN_CALIBRATION32_MASK                        (0x00UL)          // Feature not available on this device.
#define BSP_FEATURE_TSN_CONTROL_AVAILABLE                         (0UL)             // Feature not available on this device.
#define BSP_FEATURE_TSN_HAS_LOW_TEMP_REG                          (0UL)             // Feature not available on this device.
#define BSP_FEATURE_TSN_HAS_ROOM_TEMP_REG                         (0UL)             // Feature not available on this device.
#define BSP_FEATURE_TSN_SLOPE                                     (0UL)             // Feature not available on this device.
