...
#define BSP_PERIPHERAL_AGT_CHANNEL_MASK          (0x2FU)
...
#define BSP_PERIPHERAL_GPT_CHANNEL_MASK          (0x36U)
...
#define BSP_PERIPHERAL_ICU_EXT_IRQ_CHANNEL_MASK  (0x23FFU)
...
#define BSP_PERIPHERAL_PORT_CHANNEL_MASK         (0x3FU)
...
#define BSP_PERIPHERAL_SCI_CHANNEL_MASK          (0x219U)
