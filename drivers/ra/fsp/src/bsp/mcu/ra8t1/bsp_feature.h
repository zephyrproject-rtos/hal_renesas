...
#define BSP_FEATURE_ADC_ADDITION_SUPPORTED                   (1U) // ADC Derived from RA8T1
...
#define BSP_FEATURE_CAN_NUM_CHANNELS                         (0U) // RA8T1 has CAN-FD
...
#define BSP_FEATURE_CGC_HAS_SRAMPRCR2                        (0U) // On the RA8T1 there is another register to enable write access for SRAMWTSC.
...
#define BSP_FEATURE_DWT_CYCCNT                               (1U)          // RA8T1 has Data Watchpoint Cycle Count Register
