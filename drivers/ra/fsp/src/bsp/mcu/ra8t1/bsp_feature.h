...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                   (0x000F01F7UL)    // Mask of available channels in ADC unit 0.
#define BSP_FEATURE_ADC_UNIT_1_CHANNELS                   (0x007F0077UL)    // Mask of available channels in ADC unit 1.
...
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_NO_RAM_WAITS       (120000000UL)     // The maximum frequency that can be used before wait cycles are necessary.
...
#define BSP_FEATURE_GPT_AD_DIRECT_START_CHANNEL_MASK      (0xFFUL)          // Mask of GPT channels supporting A/D conversion start.
...
#define BSP_FEATURE_ICU_WUPEN_MASK                        (0x00007F08F80DFFFFULL)   // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_IIC_FAST_MODE_PLUS                    (3UL)             // Mask of channels which support "Fast Mode Plus": up to 1 Mbps bit rates.
...
#define BSP_FEATURE_LPM_DPSIER_MASK                       (0x2D13FFFFULL)   // Mask of valid bit-fields of the DPSIERn registers.
...
#define BSP_FEATURE_LPM_HAS_LDO_CONTROL                   (1UL)             // LDOs for clock sources can be enabled/disabled.
...
#define BSP_FEATURE_LVD_MONITOR_1_HI_THRESHOLD            ((lvd_threshold_t) 0) // Typical higher bound of the detection threshold for LVD1.
#define BSP_FEATURE_LVD_MONITOR_1_LOW_THRESHOLD           ((lvd_threshold_t) 15)    // Typical lower bound of the detection threshold for LVD1.
#define BSP_FEATURE_LVD_MONITOR_1_STABILIZATION_TIME_US   (30UL)            // Maximum stabilization time to wait after LVD1 is enabled.
#define BSP_FEATURE_LVD_MONITOR_2_HI_THRESHOLD            ((lvd_threshold_t) 0) // Typical higher bound of the detection threshold for LVD2.
#define BSP_FEATURE_LVD_MONITOR_2_LOW_THRESHOLD           ((lvd_threshold_t) 15)    // Typical lower bound of the detection threshold for LVD2.
...
#define BSP_FEATURE_SCI_LIN_CHANNELS                      (0x03UL)          // Mask of channels that can support LIN.
