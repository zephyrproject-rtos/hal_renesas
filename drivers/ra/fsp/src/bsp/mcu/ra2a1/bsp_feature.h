...
#define BSP_FEATURE_ACMPHS_MIN_WAIT_TIME_US                  (3U) // This comes from the Electrical Characteristics in the hardware manual. Can be 1 us if AVCC0 >= 3.3V. Using the largest minimum in this API.
#define BSP_FEATURE_ACMPHS_VREF                              (ACMPHS_REFERENCE_IVREF5)

#define BSP_FEATURE_ACMPLP_HAS_COMPSEL_REGISTERS             (1)
#define BSP_FEATURE_ACMPLP_MIN_WAIT_TIME_US                  (100U)

#define BSP_FEATURE_ADC_ADDITION_SUPPORTED                   (0U)
...
#define BSP_FEATURE_ADC_HAS_ADCER_ADRFMT                     (0U)
...
#define BSP_FEATURE_ADC_HAS_VREFAMPCNT                       (1U)
#define BSP_FEATURE_ADC_MAX_RESOLUTION_BITS                  (16U)
...
#define BSP_FEATURE_CGC_PLL1_NUM_OUTPUT_CLOCKS               (0U)
#define BSP_FEATURE_CGC_PLL2_NUM_OUTPUT_CLOCKS               (0U)
#define BSP_FEATURE_CGC_PLL_OUT_MAX_HZ                       (0U) // Feature not available on this MCU
#define BSP_FEATURE_CGC_PLL_OUT_MIN_HZ                       (0U) // Feature not available on this MCU
#define BSP_FEATURE_CGC_PLL_SRC_MAX_HZ                       (0U) // Feature not available on this MCU
#define BSP_FEATURE_CGC_PLL_SRC_MIN_HZ                       (0U) // Feature not available on this MCU
...
#define BSP_FEATURE_CGC_PLLCCR_VCO_MAX_HZ                    (0U)
...
#define BSP_FEATURE_CGC_STARTUP_SCKDIVCR                     (0x44000404)
...
#define BSP_FEATURE_DAC8_HAS_CHARGEPUMP                      (1U)
#define BSP_FEATURE_DAC8_HAS_DA_AD_SYNCHRONIZE               (1U)
#define BSP_FEATURE_DAC8_HAS_REALTIME_MODE                   (1U)
#define BSP_FEATURE_DAC8_MAX_CHANNELS                        (2U)

#define BSP_FEATURE_DAC_AD_SYNC_UNIT_MASK                    (0U) // Feature not available on this MCU
#define BSP_FEATURE_DAC_HAS_CHARGEPUMP                       (1U)
...
#define BSP_FEATURE_ELC_PERIPHERAL_MASK                      (0x005CD30FU) // Deprecated (Removing in FSP v6.0)
...
#define BSP_FEATURE_FLASH_LP_FLASH_CLOCK_SRC                 ((fsp_priv_clock_t) FSP_PRIV_CLOCK_FCLK) // RA2A1 FlashIF uses FCLK
...
#define BSP_FEATURE_ICU_WUPEN_MASK                           (0xFB8F00FFU)
...
#define BSP_FEATURE_OPAMP_MIN_WAIT_TIME_LP_US                (220U) // This information comes from the Electrical Characteristics chapter of the hardware manual.
