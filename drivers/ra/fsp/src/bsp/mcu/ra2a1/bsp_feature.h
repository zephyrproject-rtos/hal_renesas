...
#define BSP_FEATURE_CGC_PLL_SRC_MAX_HZ                    (0UL)             // Maximum input frequency for PLL unit 1.
#define BSP_FEATURE_CGC_PLL_SRC_MIN_HZ                    (0UL)             // Minimum output frequency for PLL unit 1.
