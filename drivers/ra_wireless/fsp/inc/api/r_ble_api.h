...
#define BLE_ERR_GROUP_EATT     (0x9000)
...
enum RBLE_STATUS_enum
{
    ...
    BLE_ERR_HC_OP_PACKET_TOO_LONG        = 0x1045,
    ...
    BLE_ERR_SMP_LE_KEY_REJECTED              = 0x210F,
    BLE_ERR_SMP_LE_BUSY                      = 0x2110,
    ...
    BLE_ERR_GATT_DATABASE_OUT_OF_SYNC        = 0x3012,
    BLE_ERR_GATT_VALUE_NOT_ALLOWED           = 0x3013,
    ...
    BLE_ERR_EATT_NO_CONNECTION              = 0x9001,
    BLE_ERR_EATT_REFUSED_NO_PSM             = 0x9002,
    BLE_ERR_EATT_REFUSED_SECURITY           = 0x9003,
    BLE_ERR_EATT_REFUSED_NO_RESOURCES       = 0x9004,
    BLE_ERR_EATT_REFUSED_AUTHENTICATION     = 0x9005,
    BLE_ERR_EATT_REFUSED_AUTHORIZATION      = 0x9006,
    BLE_ERR_EATT_REFUSED_KEY_SIZE           = 0x9007,
    BLE_ERR_EATT_REFUSED_ENCRYPTION         = 0x9008,
    BLE_ERR_EATT_REFUSED_INVALID_CID        = 0x9009,
    BLE_ERR_EATT_REFUSED_CID_ALLOCATED      = 0x900A,
    BLE_ERR_EATT_REFUSED_PARAMS             = 0x900B,
    BLE_ERR_EATT_REFUSED_INVALID_PARAM      = 0x900C,
    BLE_ERR_EATT_PENDING_NO_FURTHER_INFO    = 0x900D,
    BLE_ERR_EATT_PENDING_AUTHENTICATION     = 0x900E,
    BLE_ERR_EATT_PENDING_AUTHORIZATION      = 0x900F,
    BLE_ERR_EATT_TIMEOUT                    = 0x9020,
    BLE_ERR_EATT_REJ_NOT_UNDERSTOOD         = 0x9021,
    BLE_ERR_EATT_REJ_MTU_EXCEEDED           = 0x9022,
    BLE_ERR_EATT_REJ_INVALID_CID            = 0x9023,
    BLE_ERR_EATT_REJ_NO_FURTHER_INFO        = 0x9024,
    BLE_ERR_EATT_NO_FURTHER_INFO            = 0x90FF,

};

/* The name was changed in Bluetooth 5.3. */
#define BLE_ERR_GATT_ENC_KEY_SIZE_TOO_SHORT BLE_ERR_GATT_INSUFFICIENT_ENC_KEY_SIZE
...
/**
 * @def BLE_GAP_PERD_ADV_ENABLE_INCLUDE_ADI_FIELD
 * @brief Periodic advertise start with include adi field.
 */
#define BLE_GAP_PERD_ADV_ENABLE_INCLUDE_ADI_FIELD      (0x02)
...
/**
 * @def BLE_GAP_ADV_TX_PWR_HOST_NO_PREF
 * @brief  No preferred for advertise tx power.
 */
#define BLE_GAP_ADV_TX_PWR_HOST_NO_PREF          (0x7F)
...
/* Create Sync options */
/**
 * @def BLE_GAP_SYNC_FILT_USE_WLST
 * @brief White List is used.
 */
#define BLE_GAP_SYNC_FILT_USE_WLST                     (0x01)

/**
 * @def BLE_GAP_SYNC_FILT_USE_ADDR
 * @brief White List is not used.
 */
#define BLE_GAP_SYNC_FILT_USE_ADDR                     (0x00)

/**
 * @def BLE_GAP_SYNC_INIT_PERD_ADV_DISABLE
 * @brief initial periodic advertisement reporting disabled.
 */
#define BLE_GAP_SYNC_INIT_PERD_ADV_DISABLE             (0x02)

/**
 * @def BLE_GAP_SYNC_INIT_PERD_ADV_ENABLE
 * @brief initial periodic advertisement reporting enabled.
 */

#define BLE_GAP_SYNC_INIT_PERD_ADV_ENABLE              (0x00)
/**
 * @def BLE_GAP_SYNC_FILT_DUPLIC_ENABLE
 * @brief Duplicate filter enabled.
 */
#define BLE_GAP_SYNC_FILT_DUPLIC_ENABLE                (0x04)

/**
 * @def BLE_GAP_SYNC_FILT_DUPLIC_DISABLE
 * @brief Duplicate filter disabled.
 */
#define BLE_GAP_SYNC_FILT_DUPLIC_DISABLE               (0x00)

/**
 * @def BLE_GAP_SYNC_CTE_TYPE_NO_AOA
 */
#define BLE_GAP_SYNC_CTE_TYPE_NO_AOA                   (0x01)
/**
 * @def BLE_GAP_SYNC_CTE_TYPE_NO_AOD_1US
 */
#define BLE_GAP_SYNC_CTE_TYPE_NO_AOD_1US               (0x02)
/**
 * @def BLE_GAP_SYNC_CTE_TYPE_NO_AOD_2US
 */
#define BLE_GAP_SYNC_CTE_TYPE_NO_AOD_2US               (0x04)
/**
 * @def BLE_GAP_SYNC_CTE_TYPE_NO_CTE
 */
#define BLE_GAP_SYNC_CTE_TYPE_NO_CTE                   (0x08)
/**
 * @def BLE_GAP_SYNC_CTE_TYPE_ONLY_CTE
 */
#define BLE_GAP_SYNC_CTE_TYPE_ONLY_CTE                 (0x10)
...
/* Primary/Secondary Advertising PHY options */

/**
 * @def BLE_GAP_ADV_PHY_OPTS_NO_PREFERANCE
 * @brief  No preferred or required coding on the LE Coded PHY.
 */
#define BLE_GAP_ADV_PHY_OPTS_NO_PREFERANCE               (0x00)

/**
 * @def BLE_GAP_ADV_PHY_OPTS_PREFER_CODED_S2
 * @brief  Prefers S=2 coding be used on the LE Coded PHY.
 */
#define BLE_GAP_ADV_PHY_OPTS_PREFER_CODED_S2             (0x01)

/**
 * @def BLE_GAP_ADV_PHY_OPTS_PREFER_CODED_S8
 * @brief  Prefers S=8 coding be used on the LE Coded PHY.
 */
#define BLE_GAP_ADV_PHY_OPTS_PREFER_CODED_S8             (0x02)

/**
 * @def BLE_GAP_ADV_PHY_OPTS_REQUIRE_CODED_S2
 * @brief  Requires S=2 coding be used on the LE Coded PHY.
 */
#define BLE_GAP_ADV_PHY_OPTS_REQUIRE_CODED_S2            (0x03)

/**
 * @def BLE_GAP_ADV_PHY_OPTS_REQUIRE_CODED_S8
 * @brief  Requires S=8 coding be used on the LE Coded PHY.
 */
#define BLE_GAP_ADV_PHY_OPTS_REQUIRE_CODED_S8            (0x04)
...
/**
 * @def BLE_GAP_ADV_ENC_SESSION_KEY_LEN
 * @brief Length of Session Key
 */
#define BLE_GAP_ADV_ENC_SESSION_KEY_LEN                  (0x10)

/**
 * @def BLE_GAP_ADV_ENC_IV_LEN
 * @brief Length of IV
 */
#define BLE_GAP_ADV_ENC_IV_LEN                           (0x08)

/**
 * @def BLE_GAP_ALL_LE_FEAT_LEN
 * @brief Largest size LE features bitfield 
 */
#define BLE_GAP_ALL_LE_FEAT_LEN                          (0xF8)
...
#define BLE_ISO_TIMESTAMP_VALID                          (0x01)

#define BLE_ISO_RX_SDU_DATA_VALID                        (0x00)
#define BLE_ISO_RX_SDU_DATA_POSSIBLLY_INVALID            (0x01)
#define BLE_ISO_RX_SDU_DATA_LOST                         (0x02)

#define BLE_ISO_BIG_UNENCRYPTED                          (0x00)
#define BLE_ISO_BIG_ENCRYPTED                            (0x01)

#define BLE_ISO_HOST_PREF_PHY_1M                         (0x01)
#define BLE_ISO_HOST_PREF_PHY_2M                         (0x02)
#define BLE_ISO_HOST_PREF_PHY_CD                         (0x04)
...
/**
 * @ingroup EATT_API
 * @def BLE_EATT_NUM_ECB_BEARERS_MAX
 * @brief Maximum number of supported EATT Channel.
 */
#define BLE_EATT_NUM_ECB_BEARERS_MAX             (3)

/**
 * @ingroup EATT_API
 * @def BLE_EATT_ENABLED
 * @brief EATT Channel Opened.
 */
#define BLE_EATT_ENABLED                         (1)

/**
 * @ingroup EATT_API
 * @def BLE_EATT_DISABLED
 * @brief EATT Channel Closed.
 */
#define BLE_EATT_DISABLED                        (0)

/******************************************************************************************************************//**
 * @enum e_r_ble_eatt_evt_t
 * @brief  EATT Event Identifier
 **********************************************************************************************************************/
typedef enum
{
    /**
     *  @brief  EATT Channel Enabled.
     *  @details
     ...
     */
    BLE_EATT_EVENT_ENABLED = 0x9001,             //!< BLE_EATT_EVENT_ENABLED

    /**
     *  @brief  EATT Channel Disabled.
     *  @details
     ...
     */
    BLE_EATT_EVENT_DISABLED = 0x9002,             //!< BLE_EATT_EVENT_DISABLED

}e_r_ble_eatt_evt_t;

/**@} (end addtogroup EATT_API)*/
...
/**
 * @def BLE_GATTS_CLIENT_SUPPORTED_FEAT_ROBUST_CACHING
 * @brief GATT Client Supported Features values. Supporting Robust Caching.
 */
#define BLE_GATTS_CLIENT_SUPPORTED_FEAT_ROBUST_CACHING              (0x01)

/**
 * @def BLE_GATTS_CLIENT_SUPPORTED_FEAT_EATT
 * @brief GATT Client Supported Features values. Supporting Enhanced ATT Bearer.
 */
#define BLE_GATTS_CLIENT_SUPPORTED_FEAT_EATT                        (0x02)

/**
 * @def BLE_GATTS_CLIENT_SUPPORTED_FEAT_MULTI_NOTIFICATIONS
 * @brief GATT Client Supported Features values. Supporting Multiple Notification.
 */
#define BLE_GATTS_CLIENT_SUPPORTED_FEAT_MULTI_NOTIFICATIONS         (0x04)

/**
 * @def BLE_GATTS_CLIENT_SUPPORTED_FEAT_LEN
 * @brief GATT Client Supported Features values length.
 */
#define BLE_GATTS_CLIENT_SUPPORTED_FEAT_LEN                         (0x01)

/**
 * @def BLE_GATTS_SERVER_SUPPORTED_FEAT_EATT
 * @brief GATT Server Supported Features values. Supporting Enhanced ATT Bearer.
 */
#define BLE_GATTS_SERVER_SUPPORTED_FEAT_EATT                        (0x01)

/**
 * @def BLE_GATTS_DATABASE_HASH_LEN
 * @brief GATT Database Hash values length.
 */
#define BLE_GATTS_DATABASE_HASH_LEN                                 (16)
 ...
 */
#define BLE_GATT_DB_ATTR_DISABLED                 (0x0010)

/**
 * @def BLE_GATT_DB_128_BIT_UUID_FORMAT
 * @brief Attribute with 128 bit UUID.
 */
#define BLE_GATT_DB_128_BIT_UUID_FORMAT           (0x0020)

/**
 * @def BLE_GATT_DB_PEER_SPECIFIC_VAL_PROPERTY
 * @brief Attribute managed by each GATT Client.
 */
#define BLE_GATT_DB_PEER_SPECIFIC_VAL_PROPERTY    (0x0040)

/**
 * @def BLE_GATT_DB_CONST_ATTR_VAL_PROPERTY
 * @brief Fixed attribute value.
 */
#define BLE_GATT_DB_CONST_ATTR_VAL_PROPERTY       (0x0080)

/**
 * @def BLE_GATT_DB_ENABLE_WRITE_WITHOUT_RSP
 * @brief Permit Write Without Response.
 */
#define BLE_GATT_DB_ENABLE_WRITE_WITHOUT_RSP      (0x0100)

/**
 * @def BLE_GATT_DB_ONLY_SIGNED_WRITE
 * @brief Signed writes are allowed.
 */
#define BLE_GATT_DB_ONLY_SIGNED_WRITE             (0x0200)

/**
 * @def BLE_GATT_DB_SECONN_ONLY_READ
 * @brief LE Secure Connection Pairing and 16 byte encryption key size are required in read access.
 */
#define BLE_GATT_DB_SECONN_ONLY_READ              (0x1000)

/**
 * @def BLE_GATT_DB_SECONN_ONLY_WRITE
 * @brief LE Secure Connection Pairing 16 byte encryption key size are required in write access.
 */
#define BLE_GATT_DB_SECONN_ONLY_WRITE             (0x2000)
...
/**
 * @def BLE_GATT_DB_PERMIT_NONE
 * @brief Set if attribute can not be written and read.
 */
#define BLE_GATT_DB_PERMIT_NONE                   (0x00000000)

/**
 * @def BLE_GATT_DB_PERMIT_WRITE
 * @brief Set if attribute can be written.
 */
#define BLE_GATT_DB_PERMIT_WRITE                  (0x00000010)

/**
 * @def BLE_GATT_DB_PERMIT_WRITE_AUTH
 * @brief Set if attribute write requires authentication.
 */
#define BLE_GATT_DB_PERMIT_WRITE_AUTH             (0x00000020)

/**
 * @def BLE_GATT_DB_PERMIT_WRITE_AUTHORIZ
 * @brief Set if attribute write requires authorization.
 */
#define BLE_GATT_DB_PERMIT_WRITE_AUTHORIZ         (0x00000040)

/**
 * @def BLE_GATT_DB_PERMIT_WRITE_ENC
 * @brief Set if attribute write requires encryption
 */
#define BLE_GATT_DB_PERMIT_WRITE_ENC              (0x00000080)

/**
 * @def BLE_GATT_DB_PERMIT_WRITE_ENC_KEY_SIZE_16
 * @brief Set if attribute write requires encryption key size 16.
 */
#define BLE_GATT_DB_PERMIT_WRITE_ENC_KEY_SIZE_16  (0x00000200)

/**
 * @def BLE_GATT_DB_PERMIT_READ
 * @brief Set if attribute can be read.
 */
#define BLE_GATT_DB_PERMIT_READ                   (0x00000001)

/**
 * @def BLE_GATT_DB_PERMIT_READ_AUTH
 * @brief Set if attribute read requires authentication.
 */
#define BLE_GATT_DB_PERMIT_READ_AUTH              (0x00000002)

/**
 * @def BLE_GATT_DB_PERMIT_READ_AUTHORIZ
 * @brief Set if attribute read requires authorization.
 */
#define BLE_GATT_DB_PERMIT_READ_AUTHORIZ          (0x00000004)

/**
 * @def BLE_GATT_DB_PERMIT_READ_ENC
 * @brief Set if attribute read requires encryption
 */
#define BLE_GATT_DB_PERMIT_READ_ENC               (0x00000008)

/**
 * @def BLE_GATT_DB_PERMIT_READ_ENC_KEY_SIZE_16
 * @brief Set if attribute read requires encryption key size 16.
 */
#define BLE_GATT_DB_PERMIT_READ_ENC_KEY_SIZE_16   (0x00000100)
...
typedef enum
{
     ...
     *  @brief   Read Multiple Response has been sent.
     *  @details
     *  This event notifies the application layer that a Read Multiple Variable Response PDU has been sent
     *  from GATT Server to the GATT Client.
     *
     * ## Event Code: 0x3021
     *
     ...
     */
    BLE_GATTS_EVENT_READ_MULTIPLE_VARIABLE_RSP_COMP = 0x3021,    //!< BLE_GATTS_EVENT_READ_MULTIPLE_VARIABLE_RSP_COMP
    ...
    /**
     *  @brief   Notification process has started.
     *  @details
     ...
     */
    BLE_GATTS_EVENT_HDL_VAL_NTF_COMP = 0x301B,            //!< BLE_GATTS_EVENT_HDL_VAL_NTF_COMP

    /**
     *  @brief   Multiple Notification process has started.
     *  @details
     ...
     *  none
     */
    BLE_GATTS_EVENT_HDL_VAL_MULTIPLE_NTF_COMP = 0x3023,            //!< BLE_GATTS_EVENT_HDL_VAL_MULTIPLE_NTF_COMP
    ...
    /**
     *  @brief   GATT Database Hash calculation has been completed.
     *
     * ## Event Code: 0x3083
     *
     *  ## Event Data:
     ...
     */
    BLE_GATTS_EVENT_DB_HASH_CAL_COMP = 0x3083,       //!< BLE_GATTS_EVENT_DB_HASH_CAL_COMP
    
    
    /**
     *  @brief   DBHash when the client becomes change-aware
     *
     * ## Event Code: 0x3084
     *
     *  ## Event Data:
     *  st_ble_gatts_db_hash_evt_t
     */
    BLE_GATTS_EVENT_DB_HASH_AWARENESS_IND = 0x3084,       //!< BLE_GATTS_EVENT_DB_HASH_AWARENESS_IND
...
/** GATT Client Security Level Requirements */

/**
 * @def BLE_GATTC_FILTER_LEVEL_NONE
 * @brief Connection has no security requirements
 */
#define BLE_GATTC_FILTER_LEVEL_NONE                (0x00)

/**
 * @def BLE_GATTC_FILTER_LEVEL_ENC_UNAUTH
 * @brief Connection is encrypted with unauthenticated pairing
 */
#define BLE_GATTC_FILTER_LEVEL_ENC_UNAUTH          (0x01)

/**
 * @def BLE_GATTC_FILTER_LEVEL_ENC_AUTH
 * @brief Connection is encrypted with authenticated pairing
 */
#define BLE_GATTC_FILTER_LEVEL_ENC_AUTH            (0x02)

/**
 * @def BLE_GATTC_FILTER_LEVEL_ENC_AUTH_LESC
 * @brief Connection is encrypted with authenticated LE Secure Connections pairing
 */
#define BLE_GATTC_FILTER_LEVEL_ENC_AUTH_LESC       (0x03)
...
typedef enum
{
     ...
     *                  <td>Insufficient memory to execute this function. </td>
     *                  <td class="paramname">BLE_ERR_RSP_TIMEOUT(0x0011)</td>
     *                  <td>30 seconds or more have passed without receiving a write response
    ...
    /**
     *  @brief  This event notifies the application layer that
     *          the read of multiple variable Characteristics has been completed.
     *
     * ## Event Code: 0x4021
     *
     *  ## result:
     ...
     *                  <td class="paramname">BLE_ERR_RSP_TIMEOUT(0x0011)</td>
     *                  <td>30 seconds or more have passed without receiving a read response
     *                      since GATT Client sent a request for read by R_BLE_GATTC_ReadMultipleVariableLengthChar() to the GATT Server.
     *                  </td>
     *              </tr>
     *          </table>
     *  </dd></dt></dl>
     *
     *  ## Event Data:
     *  st_ble_gattc_rd_multiple_variable_char_evt_t
     */
    BLE_GATTC_EVENT_MULTIPLE_VARIABLE_CHAR_READ_RSP = 0x4021,       //!< BLE_GATTC_EVENT_MULTIPLE_VARIABLE_CHAR_READ_RSP

    /**
     *  @brief  This event notifies the application layer that a Multiple Variable Notifications has been received from a GATT Server.
     *
     * ## Event Code: 0x4023
     *
     *  ## result:
     ...
     *
     *  ## Event Data:
     *  st_ble_gattc_multi_hdl_val_ntf_evt_t
     */
    BLE_GATTC_EVENT_MULTI_HDL_VAL_NTF = 0x4023,               //!< BLE_GATTC_EVENT_MULTI_HDL_VAL_NTF
    ...
    /**
     *  @brief  This event notifies the application layer that a Signed Write process has started on the local host.
     *
     * ## Event Code: 0x40D2
     *
     *  ## result:
     ...
     *
     *  ## Event Data:
     *  st_ble_gattc_char_signed_write_evt_t
     */
    BLE_GATTC_EVENT_CHAR_SIGNED_WRITE = 0x40D2,               //!< BLE_GATTC_EVENT_CHAR_SIGNED_WRITE    
...
/**
 * @def BLE_VS_SKIP_PERIPHERAL_LATENCY_DISABLE
 * @brief Disable skip peripheral latency.
 */
#define BLE_VS_SKIP_PERIPHERAL_LATENCY_DISABLE             (0x00)

/**
 * @def BLE_VS_SKIP_PERIPHERAL_LATENCY_ENABLE
 * @brief Enable skip peripheral latency.
 */
#define BLE_VS_SKIP_PERIPHERAL_LATENCY_ENABLE              (0x01)
...
typedef struct BLE_PACKED_OPTION
{
     ...
     *           If the tx_pwr is BLE_GAP_ADV_TX_PWR_HOST_NO_PREF, Controller select tx_pwr.
     */
    int8_t adv_tx_pwr;

    /**
     *  @brief  Primary Advertising PHY options.
     *  @details
     *      <table>
     *          <tr>
     *              <th>macro</th>
     ...
     *          </tr>
     *          <tr>
     *              <td>BLE_GAP_ADV_PHY_OPTS_NO_PREFERANCE(0x00) </td>
     *              <td>The Host has no preferred or required coding when transmitting on the LE Coded PHY</td>
     *          </tr>
     *          <tr>
     *              <td>BLE_GAP_ADV_PHY_OPTS_PREFER_CODED_S2(0x01)</td>
     *              <td>The Host prefers that S=2 coding be used when transmitting on the LE Coded PHY</td>
     *              </td>
     *          </tr>
     *          <tr>
     *              <td>BLE_GAP_ADV_PHY_OPTS_PREFER_CODED_S8(0x02)</td>
     *              <td>The Host prefers that S=8 coding be used when transmitting on the LE Coded PHY</td>
     *              </td>
     *          </tr>
     *          <tr>
     *              <td>BLE_GAP_ADV_PHY_OPTS_REQUIRE_CODED_S2(0x03)</td>
     *              <td>The Host requires that S=2 coding be used when transmitting on the LE Coded PHY</td>
     *              </td>
     *          </tr>
     *          <tr>
     *              <td>BLE_GAP_ADV_PHY_OPTS_REQUIRE_CODED_S8(0x04)</td>
     *              <td>The Host requires that S=8 coding be used when transmitting on the LE Coded PHY</td>
     *              </td>
     *          </tr>
     *      </table>
     *  @note
     *     S=8 coding will be selected unless BLE_GAP_ADV_PHY_OPTS_REQUIRE_CODED_S2 is specified.
     */
     uint8_t adv_phy_opts;

    /**
     *  @brief Secondary Advertising PHY options
     *  @details
     *      <table>
     *          <tr>
     *              <th>macro</th>
...
typedef struct
{
     ...
     *          </tr>
     *          <tr>
     *              <td>BLE_GAP_SYNC_FILT_USE_WLST (0x01)</td>
     *              <td>Accept List is used.</td>
     *          </tr>
     *          <tr>
     *              <td>BLE_GAP_SYNC_INIT_PERD_ADV_DISABLE (0x02)</td>
     *              <td>initial periodic advertisement reporting disabled.</td>
     *          </tr>
     *          <tr>
     *              <td>BLE_GAP_SYNC_FILT_DUPLIC_ENABLE (0x04)</td>
     *              <td>Duplicate filter enabled.</td>
     *          </tr>
     *      </table>
     */
    ...
    /**
     *  @brief   Bluetooth Device Address to Create Sync.
     */
    ...
    /**
     *  @brief Type of the Constant Tone Extension.
     *  @details
     *  | macro                                   | description                                           |
     *  |:----------------------------------------|:------------------------------------------------------|
     *  | BLE_GAP_SYNC_CTE_TYPE_NO_AOA (0x01)     | Do not sync to packets with an AoA CTE                |
     *  | BLE_GAP_SYNC_CTE_TYPE_NO_AOD_1US (0x02) | Do not sync to packets with an AoD CTE with 1us slots |
     *  | BLE_GAP_SYNC_CTE_TYPE_NO_AOD_2US (0x04) | Do not sync to packets with an AoD CTE with 2us slots |
     *  | BLE_GAP_SYNC_CTE_TYPE_NO_CTE (0x08)     | currently reserved for future use                     |
     *  | BLE_GAP_SYNC_CTE_TYPE_ONLY_CTE (0x10)   | Do not sync to packets without a CTE                  |
     */
    uint8_t cte_type;
}st_ble_gap_create_sync_param_t;
...
/******************************************************************************************************************//**
 *  @struct st_ble_gap_enc_adv_data_t
 *  @brief  Parameters containing data to encrypt.
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
    *  @brief   Session Key.
    *  @details The size of this field is 16 bytes.
    */
    uint8_t * p_session_key;

    /**
    *  @brief   Initializing Vector (IV).
    *  @details The size of this field is 8 bytes.
    */
    uint8_t * p_iv;

    /**
    *  @brief   Plain Data.
    *  @details The size of this field is dependent on the len field.
    *           The format of the field is in the repeating order of AD Length, followed by AD Type and AD Data.
    */
    uint8_t * p_plain_data;

    /**
    *  @brief   Plain Data Length.
    *  @details Valid range is 2 - 245.
    */
    uint16_t len;
} st_ble_gap_enc_adv_data_t;

/******************************************************************************************************************//**
 *  @struct st_ble_gap_dec_adv_data_t
 *  @brief  Parameters containing data to decrypt.
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
    ...
    *  @details The size of this field is dependent of the len field.
    */
    uint8_t * p_enc_data;

    /**
    *  @brief   Encrypted Data Length.
    *  @details Valid range is 11 - 254
    */
    uint16_t len;
} st_ble_gap_dec_adv_data_t;

/******************************************************************************************************************//**
 *  @struct st_ble_gap_conn_rate_param_t
 *  @brief  Connection rate parameters 
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
    *  @brief   Minimum connection interval in units of 125 us.
    *  @details Valid range is 0x0003 - 0x7D00. (per Core Spec)
    */
    uint16_t conn_intv_min;

    /**
    *  @brief   Maximum connection interval in units of 125 us.
    *  @details Valid range is 0x0003 - 0x7D00. (per Core Spec)
    */
    uint16_t conn_intv_max;
    ...
    *  @details Valid range is 0x0001 - 0x01F4. (per Core Spec)
    */
    uint16_t subrate_min;
    ...
    */
    ...
    /**
    *  @brief   Maximum Peripheral latency in units of subrated connection intervals.
    *  @details Valid range is 0x0000 - 0x01F3. (per Core Spec)
    */
    uint16_t max_latency;

    /**
    *  @brief   Minimum continuation number.
    *  @details Valid range is 0x0000 - 0x01F3. (per Core Spec)
    */
    ...
    *  @details Valid range is 0x000A - 0x0C80. (per Core Spec)
    */
    uint16_t supervision_timeout;

    /**
    *  @brief   Minimum CE length in units of 125 us.
    *  @details Valid range is 0x0001 - 0x7CFF. (per Core Spec)
    */
    uint16_t min_ce_length;

    /**
    *  @brief   Maximum CE length in units of 125 us.
    *  @details Valid range is 0x0001 - 0x7CFF. (per Core Spec)
    */
    uint16_t max_ce_length;
} st_ble_gap_conn_rate_param_t;
...
typedef struct BLE_PACKED_OPTION
{
     ...
     *               |:--------- |:------------------------ |
     *               | 0x01      | 1M PHY                   |
     *               | 0x03      | Coded with S=8 PHY       |
     *               | 0x04      | Coded with S=2 PHY       |
     */
    uint8_t adv_phy;
     ...
     *               | 0x03      | The Secondary Advertising PHY configuration was Coded with S=8 PHY. |
     *               | 0x04      | The Secondary Advertising PHY configuration was Coded with S=2 PHY. |
     */
    uint8_t sec_adv_phy;
...
typedef struct BLE_PACKED_OPTION
{
     ...
     *               | 0x01      | AoD Constant Tone Extension with 1 micro second slots.  |
     *               | 0x02      | AoD Constant Tone Extension with 2 micro second slots.  |
...
/* Event Code : BLE_GAP_EVENT_ADV_PARAM_SET_COMP       : st_ble_gap_adv_param_set_comp_evt_t */
...
typedef struct BLE_PACKED_OPTION
{
    ...
    /**
     * @brief Selected Tx Power. Applicable in Advertising Extensions mode only.
     */
    int8_t selected_tx_power;
} st_ble_gap_adv_param_set_comp_evt_t;
...
} st_ble_cte_iq_sample_t;

/* Event Code : BLE_GAP_EVENT_CTE_CONNLESS_REPT */

/******************************************************************************************************************//**
 *  @struct st_ble_gap_cte_connless_rept_evt_t
...
typedef struct BLE_PACKED_OPTION
{
    ...
    st_ble_cte_iq_sample_t sample;
} st_ble_gap_cte_connless_rept_evt_t;

/* Event Code : BLE_GAP_EVENT_CTE_CONN_REPT */

/******************************************************************************************************************//**
 *  @struct st_ble_gap_cte_conn_rept_evt_t
...
typedef struct BLE_PACKED_OPTION
{
    ...
    uint16_t               evt_counter;
    st_ble_cte_iq_sample_t sample;
} st_ble_gap_cte_conn_rept_evt_t;

/* Event Code : BLE_GAP_EVENT_SUBRATE_CHG */

/******************************************************************************************************************//**
 *  @struct  st_ble_subrate_upd_evt_t
...
typedef struct BLE_PACKED_OPTION
{
    ...
    st_ble_gap_sync_est_evt_t sync_info;
...
/* Event Code : BLE_GAP_EVENT_ENC_ADV_DATA_COMP: st_ble_gap_enc_adv_data_comp_evt_t */

/******************************************************************************************************************//**
 *  @struct st_ble_gap_enc_adv_data_comp_evt_t
 *  @brief  Encryption Result related to R_BLE_GAP_EncAdvData
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
     * @brief   Encrypted Data
     * @details This field contains the AD data part of the encrypted advertising payload.
     *          The format of this field is in order of Randomizer, Payload, and MIC.
     */
    uint8_t * p_data;

    /**
     * @brief   Data Length
     * @details This field containes the Randomizer(5 bytes) and MIC(4 bytes) along with the
     *          encrypted payload which makes it bigger than plain data length.
     */
    uint16_t len;
} st_ble_gap_enc_adv_data_comp_evt_t;

/* Event Code : BLE_GAP_EVENT_DEC_ADV_DATA_COMP: st_ble_gap_dec_adv_data_comp_evt_t */
/******************************************************************************************************************//**
 *  @struct st_ble_gap_dec_adv_data_comp_evt_t
 *  @brief  Decryption Result related to R_BLE_GAP_DecAdvData
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
     * @brief   Decrypted Data
     * @details This field contains the decrypted advertising payload. This is the original plain data.
     *          The format of the field is in the repeating order of AD Length, followed by AD Type
     *          and AD Data.
     */
    uint8_t * p_data;
    ...
    /**
     * @brief   Data Length
     * @details Since this field does not contain the Randomizer(5 bytes) and MIC(4 bytes), 
     *          it is smaller than encrypted data length.
     */
    uint16_t len;
} st_ble_gap_dec_adv_data_comp_evt_t;

/* Event Code : BLE_GAP_EVENT_HOST_RPA_UPD_IND: st_ble_gap_host_rpa_upd_evt_t */
/******************************************************************************************************************//**
 *  @struct st_ble_gap_host_rpa_upd_evt_t
 *  @brief  Address Update related to R_BLE_GAP_StartHostPriv
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
     * @brief   Host RPA
     * @details When using Host Privacy, Resolvable Private Address (RPA) is informed in this structure
     */
    st_ble_dev_addr_t addr;
} st_ble_gap_host_rpa_upd_evt_t;

/* Event Code : BLE_GAP_EVENT_READ_ALL_LOCAL_FEAT_IND: st_ble_gap_read_all_local_feat_ind_evt_t */
/******************************************************************************************************************//**
 *  @struct st_ble_gap_read_all_local_feat_ind_evt_t
 *  @brief  Parameters containing local device LE features
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
     *  @brief   Highest page where the bits indicating the LE features supported by the local device have been set to 1.
     *  @details The value of this parameter is the page number of the FeatureSet field that indicates the LE features
     *           supported by the device’s Link Layer.
     *           For details on the FeatureSet field, refer to Bluetooth Core Specification v6.0 or later, Vol 6,
     *           Part B, 4.6 Feature Support.
     *           Valid range is 0x00 - 0x0A
     */
    uint8_t     local_page_max;

    /**
     *  @brief   Bitfield of the FeatureSet indicating supported LE features.
     *  @details Largest size is 0xF8
     */
    uint8_t     features[BLE_GAP_ALL_LE_FEAT_LEN];
} st_ble_gap_read_all_local_feat_ind_evt_t;

/* Event Code : BLE_GAP_EVENT_READ_ALL_REMOTE_FEAT_IND: st_ble_gap_read_all_remote_feat_ind_evt_t */
/******************************************************************************************************************//**
 *  @struct st_ble_gap_read_all_remote_feat_ind_evt_t
 *  @brief  Parameters containing remote device LE features
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
     *  @brief   Connection Handle
     *  @details Valid range is 0x00 - 0x0A
     */
    uint16_t    conn_hdl;

    /**
     *  @brief   Highest page where the bits indicating the LE features supported by the remote device have been set to 1.
     *  @details The value of this parameter is the page number of the FeatureSet field that indicates the LE features
     *           supported by the device’s Link Layer.
     *           For details on the FeatureSet field, refer to Bluetooth Core Specification v6.0 or later, Vol 6,
     *           Part B, 4.6 Feature Support.
     *           Valid range is 0x00 - 0x0A
     */
    uint8_t     remote_page_max;

    /**
     *  @brief   The maximum page number that contains valid data obtained from the remote device.
     *  @details If the value of this parameter is greater than or equal to remote_page_max, 
     *           it means that features include all valid data from the remote device.
     *           Valid range is 0x00 - 0x0A
     */
    uint8_t     valid_page_max;
     ...
     */
    uint8_t     features[BLE_GAP_ALL_LE_FEAT_LEN];
} st_ble_gap_read_all_remote_feat_ind_evt_t;

/* Event Code : BLE_GAP_EVENT_DEF_DATA_LEN_RD_COMP: st_ble_gap_def_data_len_rd_evt_t */
/******************************************************************************************************************//**
 *  @struct st_ble_gap_def_data_len_rd_evt_t
 *  @brief  LE read suggested default data len command complete event
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
     *  @brief   Suggested maximum Tx octets.
     *  @details Valid range is 0x001B - 0x00FB
     */
    uint16_t    suggested_tx_octets_max;

    /**
     *  @brief   Suggested maximum Tx time in us.
     *  @details Valid range is 0x0148 - 0x4290
     */
    uint16_t    suggested_tx_time_max;
} st_ble_gap_def_data_len_rd_evt_t;

/* Event Code : BLE_GAP_EVENT_MIN_INTV_RD_COMP: st_ble_gap_min_intv_rd_evt_t */
/******************************************************************************************************************//**
 *  @struct st_ble_gap_min_intv_rd_evt_t
 *  @brief  LE read minimum supported connection interval command complete event
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
     *  @brief   Minimum supported connection interval in units of 125 us.
     *  @details Range: 0x03 - 0x3C (per Core Spec).
     */
    uint8_t    min_sup_conn_intv;
    ...
    /**
     *  @brief   Minimum supported connection interval in this group in units of 125 us.
     *  @details Range: 0x0003 - 0x7D00 (per Core Spec).
     */ 
    uint16_t * p_group_min;

    /**
     *  @brief   Maximum supported connection interval in this group in units of 125 us.
     *  @details Range: 0x0003 - 0x7D00 (per Core Spec).
     */ 
    uint16_t * p_group_max;

    /**
     *  @brief   The Connection Interval resolution of this group in units of 125 us.
     *  @details Range: 0x0001 - 0x7D00 (per Core Spec).
     */ 
    uint16_t * p_group_stride;
} st_ble_gap_min_intv_rd_evt_t;

/* Event Code : BLE_GAP_EVENT_CONN_RATE_CHG: st_ble_gap_conn_rate_chg_evt_t */
/******************************************************************************************************************//**
 *  @struct st_ble_gap_conn_rate_chg_evt_t
 *  @brief  LE connection rate change event
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
    ...
    /**
     *  @brief   New connection interval in units of 125 us.
     *  @details Range: 0x0003 - 0x7D00 (per Core Spec).
     */ 
    uint16_t conn_intv;

    /**
     *  @brief   New subrate factor.
     *  @details Range: 0x0001 - 0x01F4 (per Core Spec).
     */ 
    uint16_t subrate_factor;

    /**
     *  @brief   New peripheral latency.
     *  @details Range: 0x0000 - 0x01F3 (per Core Spec).
     */ 
    uint16_t peripheral_latency;

    /**
     *  @brief   New continuation number.
     *  @details Range: 0x0000 - 0x01F3 (per Core Spec).
     */ 
    uint16_t continuation_number;
    ...
    /**
     *  @brief   Supervision timeout in units of 10 ms.
     *  @details Range: 0x000A - 0x0C80 (per Core Spec).
     */ 
    uint16_t supervision_timeout;
} st_ble_gap_conn_rate_chg_evt_t;
...
typedef struct BLE_PACKED_OPTION
{
    ...
    /** @brief Channel interval in microseconds.
     *
...
typedef struct BLE_PACKED_OPTION
{
    ...
    /** @brief maximum number of subevents that a Controller should use to
     *  receive data payloads in each interval for a BIS.
     *  BLE_ISO_SYNC_MSE_AUTO to let controller choose.
     *  value range: BLE_ISO_SYNC_MSE_AUTO or 0x01 to 0x1F
     */
    uint8_t max_subevents;

    /** @brief Synchronization timeout for the BIG
...
typedef struct BLE_PACKED_OPTION
{
     ...
     *  @details Value range 0x0000FF - 0x0FFFFF.
     */
    ...
    /** @brief cis param. */
    st_ble_iso_cis_param_t cis_param[BLE_ISO_MAX_GROUP_ISO_COUNT];
...
typedef struct BLE_PACKED_OPTION
{
    ...
    /** @brief connection handles for every CIS.
     *  @details CIS handles are got from event BLE_ISO_EVENT_CIG_PARAM_SET_COMP.
     */
    uint16_t cis_conn_hdl[BLE_ISO_MAX_GROUP_ISO_COUNT];

    /** @brief connection handles of ACL for every CIS.
     */
    uint16_t acl_conn_hdl[BLE_ISO_MAX_GROUP_ISO_COUNT];
...
typedef struct BLE_PACKED_OPTION
{
     ...
     * @details Select value from BLE_ISO_DATA_PATH_DIR_INPUT or BLE_ISO_DATA_PATH_DIR_OUTPUT
     */
    uint8_t path_dir;

    /**
     * @brief path ID
     * @details Only BLE_ISO_DATA_PATH_HCI is accepted.
     */
    uint8_t path_id;
    ...
    /**
     * @brief Codec Configuration length.
     */
...
/**
 * @brief SDU data structure.
 * @details param of R_BLE_ISO_SendData.
 */
 ...
 *  @brief  This is the member variables used in st_ble_iso_cig_test_param_t.
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
     ...
     */
    uint8_t p_bn;
} st_ble_iso_cis_test_param_t;

/******************************************************************************************************************//**
 *  @struct st_ble_iso_set_cig_param_test_param_t
 *  @brief  This is the parameters used in R_BLE_ISO_SetCigParamTest().
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
    ...
    /**
     *  @brief CIS Param configurations.
     */
    st_ble_iso_cis_test_param_t cis_param[BLE_ISO_MAX_GROUP_ISO_COUNT];
} st_ble_iso_cig_test_param_t;
...
typedef struct BLE_PACKED_OPTION
{
     ...
     */
    uint16_t bis_conn_hdl[BLE_ISO_MAX_GROUP_ISO_COUNT];
 ...
 *  @brief  BIG info of a sync established BIG.
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
...
{
    /**
     *  @brief Periodic Sync that has been established for BIG.
     */
    uint16_t sync_hdl;
...
typedef struct BLE_PACKED_OPTION
{
    ...
    /**
     * @brief The ACL connection handle over which this cis is created.
     */
    uint16_t acl_conn_hdl;

    /**
     * @brief The CIS connection handle over which this cis is created.
     */
    uint16_t cis_conn_hdl;
} st_ble_iso_cis_req_evt_t;

/* Event Code : BLE_ISO_EVENT_REPLY_CIS_REQ_COMP */

/******************************************************************************************************************//**
 *  @struct st_ble_iso_reply_cis_req_comp_evt_t
 *  @brief  Reply CIS reqest Complete event
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
     * @brief The CIS handle over which this cis is created.
     */
    uint16_t cis_conn_hdl;

    /**
     *  @brief Whether the local device rejected or accepted
     *  @details
     *  |              macro            |           description            |
     *  |:----------------------------- |:-------------------------------- |
...
{
    /**
     * @brief status of CIS established
     */
    uint8_t status;
...
/* Event Code : BLE_ISO_EVENT_CIS_TERM */

/******************************************************************************************************************//**
 *  @struct st_ble_iso_cis_term_evt_t
 *  @brief  CIS terminate event.
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
     * @brief The CIS Connection handle that cis is terminated.
     */
    uint16_t cis_conn_hdl;

    /**
     * @brief cis terminated reason.
     */
    uint8_t reason;
} st_ble_iso_cis_term_evt_t;

/* Event Code : BLE_ISO_EVENT_ISO_RX_DATA_IND */

/******************************************************************************************************************//**
 *  @struct st_ble_iso_rx_data_ind_evt_t
 *  @brief  ISO SDU Rx data event structure
 **********************************************************************************************************************/
typedef struct  BLE_PACKED_OPTION
{
    /**
    ...
    /**
     *  @brief     SDU packet status
     *  @details   The sdu_status indicates the status of the packet that the Controller receives over the ISO channel.
     *               |              macro                          |   description                                 |
     *               |:------------------------------------------- |:--------------------------------------------- |
...
{
    /** 
     * @brief    connection handle of the ISO packet that was sent 
     */
    uint16_t conn_hdl;

    /** 
     * @brief    sequence number of  ISO packet that was sent 
     */
    uint32_t seq_num;
} st_ble_iso_tx_comp_evt_t;

/* Event Code : BLE_ISO_EVENT_READ_TEST_CNT_COMP: st_ble_iso_test_cnt_info_evt_t */
...
/* Event Code : BLE_ISO_EVENT_TEST_ENDED: st_ble_iso_test_end_rept_evt_t */
...
/* Event Code : BLE_ISO_EVENT_READ_LINK_QUALITY_COMP: st_ble_iso_link_quality_info_evt_t */
...
typedef struct BLE_PACKED_OPTION
{
    ...
    /** 
     * @brief    CIG reference point or BIG anchor point of a transmitted SDU, in microseconds. 
     */
    uint32_t ts;

    /** 
     * @brief    Time offset, in microseconds 
     */
    uint32_t offset;
...
/* Event Code : BLE_ISO_EVENT_CIG_REMOVE_COMP */
...
/* Event Code : BLE_ISO_EVENT_CREATE_BIG_SYNC_COMP */
/* Event Code : BLE_ISO_EVENT_BIG_SYNC_TERM */
...
/* Event Code : BLE_ISO_EVENT_TERMINATE_BIG_COMP */

/******************************************************************************************************************//**
*  @brief  Big handle and big terminate reason.
...
typedef struct BLE_PACKED_OPTION
{
    ...
    /**
     *  @brief     Terminate BIG reason
     */
   uint8_t reason;  
}st_ble_iso_big_terminate_comp_evt_t;

/* Event Code : BLE_ISO_EVENT_BIG_SYNC_LOST */
...
typedef struct BLE_PACKED_OPTION
{
    ...
    /**
     *  @brief     Sync Lost reason
     */
    uint8_t reason;
} st_ble_iso_big_sync_lost_evt_t;

/* Event Code : BLE_ISO_EVENT_SETUP_DATA_PATH_COMP */
/* Event Code : BLE_ISO_EVENT_REMOVE_DATA_PATH_COMP */
/* Event Code : BLE_ISO_EVENT_TX_TEST_COMP */
/* Event Code : BLE_ISO_EVENT_RX_TEST_COMP */

/******************************************************************************************************************//**
 *  @struct st_ble_iso_conn_hdl_evt_t
 *  @brief  ISO Connection handle
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /** 
...
typedef enum
{
     ...
     *  @details
     *  When Resolvable Private Address Timeout in Controller has been updated by either R_BLE_GAP_SetRpaTo() or R_BLE_GAP_SetRpaRandTo(),
     *  this event is notified to the application layer.
     *
     * ## Event Code: 0x111F
     *
     ...
     *                      - The rpa_timeout_min or the rpa_timeout_max specified by R_BLE_GAP_SetRpaRandTo() is out of range.
     *                      - In R_BLE_GAP_SetRpaRandTo(), the provided rpa_timeout_min is greater than the rpa_timeout_max.
     *                  </td>
     *              </tr>
     *          </table>
     *  </dd></dt></dl>
    ...
    /**
     * @brief Periodic advertising sync report receive enable
     *
     * ## Event Data:
     * None
     */
    ...
    /**
     * @brief Periodic advertising sync report receive disable
     *
     * ## Event Data:
     * None
     */
    ...
    /**
     * @brief Default data length read
     * @details
     * This event notifies the application layer that the suggested data length values have been read from the controller.
     * 
     * ## Event Code: 0x112F
     * 
     *  ## result:
     ...
     * st_ble_gap_def_data_len_rd_evt_t 
     */
    BLE_GAP_EVENT_DEF_DATA_LEN_RD_COMP,

    /**
     * @brief Default data length written
     * @details
     * This event notifies the application layer that the suggested data length values have been written to the controller.
     * 
     * ## Event Code: 0x1130
     * 
     *  ## result:
     ...
     *              <tr>
     *                  <td class="paramname">BLE_ERR_INVALID_ARG(0x0003)</td>
     *                  <td>The parameter specified by R_BLE_GAP_WriteDefDataLen() is out of range.</td>
     *              </tr>
     *          </table>
     *  </dd></dt></dl>
     *
     ...
     * None
     */
    BLE_GAP_EVENT_DEF_DATA_LEN_WR_COMP,
     ...
     * st_ble_gap_conn_hdl_evt_t
     */
    BLE_GAP_EVENT_CTE_START_CONN_RECV_SAMPLE_COMP,
     ...
     * st_ble_gap_conn_hdl_evt_t
     */
    BLE_GAP_EVENT_CTE_STOP_CONN_RECV_SAMPLE_COMP,
     ...
     * st_ble_gap_conn_hdl_evt_t
     */
    BLE_GAP_EVENT_PAST_START_SET_INFO_COMP,
    ...
    /**
     *  @brief      Selected host feature has either been set, or cleared.
     *  @details
     *  When a host feature, selected by R_BLE_GAP_SetHostFeat() has either been set, or cleared.
     *
     * ## Event Code: 0x1435
     *
     *  ## result:
    ...
    /**
     *  @brief     Encrypted Data Result.
     *  @details
     *  This event notifies the resulting encrypted data from R_BLE_GAP_EncAdvData
     *
     * ## Event Code: 0x1436
     *
     *  ## result:
     ...
     *  st_ble_gap_enc_adv_data_comp_evt_t
     */
    BLE_GAP_EVENT_ENC_ADV_DATA_COMP,

    /**
     *  @brief     Decrypted Data Result.
     *  @details
     *  This event notifies the resulting decrypted data from R_BLE_GAP_DecAdvData
     *
     * ## Event Code: 0x1437
     *
     *  ## result:
     ...
     *  st_ble_gap_dec_adv_data_comp_evt_t
     */
    BLE_GAP_EVENT_DEC_ADV_DATA_COMP,

    /**
     *  @brief     RPA has been Updated when Host Privacy is used.
     *  @details
     *  This event notifies that the RPA when using host privacy is updated. 
     *  This is called whenever R_BLE_GAP_StartHostPriv privacy is called. 
     *  This is also called when the timer set with R_BLE_GAP_StartHostPriv elapses.
     *
     * ## Event Code: 0x1438
     *
     *  ## result:
     ...
     *  st_ble_gap_host_rpa_upd_evt_t
     */
    BLE_GAP_EVENT_HOST_RPA_UPD_IND,

    /**
     *  @brief      LE features of the control have been read.
     *  @details
     *  When the LE features on the local device have been read by R_BLE_GAP_ReadAllLocalFeat(),
     *  this event is notified to the application layer.
     *
     * ## Event Code: 0x1439
     *
     ...
     *              <tr>
     *                  <td class="paramname">BLE_ERR_UNSUPPORTED(0x0007)</td>
     *                  <td>Local Controller does not support the R_BLE_GAP_ReadAllLocalFeat command</td>
     *              </tr>
     *          </table>
     *  </dd></dt></dl>
     *
     ...
     *  st_ble_gap_read_all_local_feat_ind_evt_t
     */
    BLE_GAP_EVENT_READ_ALL_LOCAL_FEAT_IND,

    /**
     *  @brief      All features used on current connection and supported by the remote device have been requested to be read.
     *  @details
     *  When All features used on current connection and supported by the remote device have been requested to be read
     *   by R_BLE_GAP_ReadAllRemoteFeat(), this event is notified to the application layer.
     *
     * ## Event Code: 0x143A
     *
     *  ## result:
     ...
     *              <tr>
     *                  <td class="paramname">BLE_ERR_UNSUPPORTED(0x0007)</td>
     *                  <td>Local Controller does not support the R_BLE_GAP_ReadAllRemoteFeat command</td>
     *              </tr> 
     *          </table>
     *  </dd></dt></dl>
     *
     ...
     *  none
     */
    BLE_GAP_EVENT_READ_ALL_REMOTE_FEAT_COMP,

    /**
     *  @brief      All features used on current connection and supported by the remote device have been read.
     *  @details
     *  When All features used on current connection and supported by the remote device have been read
     *  this event is notified to the application layer.
     *
     * ## Event Code: 0x143B
     *
     ...
     *  st_ble_gap_read_all_remote_feat_ind_evt_t
     */
    BLE_GAP_EVENT_READ_ALL_REMOTE_FEAT_IND,

    /**
     *  @brief      Connection rate request has been requested.
     *  @details    
     *  This event notifies connection rate request has been generated by R_BLE_GAP_ConnRateReq.
     *
     * ## Event Code: 0x143C
     *
     *  ## result:
     ...
     *              <tr>
     *                  <td class="paramname">BLE_ERR_INVALID_ARG(0x0003)</td>
     *                  <td>The reason for this error is as follows: 
     *                      - Subrate_Max * (Max_Latency + 1) > 500.
     *                      - Connection_Interval_Max * Subrate_Max * (Max_Latency + 1) >= Supervision_Timeout * 40.
     *                      - Connection_Interval_Max < Connection_Interval_Min.
     *                      - Subrate_Max < Subrate_Min.
     *                      - Continuation_Number >= Subrate_Max.
     *                      - Max_CE_Length < Min_CE_Length.
     *                  </td>
     *              </tr> 
     *              <tr>
     *                  <td class="paramname">BLE_ERR_UNSUPPORTED(0x0007)</td>
     *                  <td>The reason for this error is as follows:
     *                      - Connection_Interval_Min and Connection_Interval_Max specify a range of connection 
     *                        intervals which is not supported by the Controller.
     *                      - Connection_Interval_Max < connIntervalRequired.
     *                      - The Connection Rate (Host Support) bit is not set in the local or remote device’s 
     *                        FeatureSet.
     *                  </td>
     *              </tr> 
     *              <tr>
     *                  <td class="paramname">BLE_ERR_INVALID_OPERATION(0x0009)</td>
     *                  <td>The reason for this error is as follows: 
     *                      - One or more CS procedures are enabled.
     *                      - A Connection Parameters Request or Connection Subrate Request procedure is in progress.
     *                  </td>
     *              </tr>
     *              <tr>
     *                  <td class="paramname">BLE_ERR_INVALID_HDL(0x000E)</td>
     *                  <td>The Connection_Handle parameter does not identify an established ACL connection.</td>
     *              </tr>
     *          </table>
     *  </dd></dt></dl>
     *
     ...
     *  none
     */
    BLE_GAP_EVENT_CONN_RATE_REQ_COMP,

    /**
     *  @brief      Default rate parameters have been set.
     *  @details    
     *  This event notifies default rate parameters have been set by R_BLE_GAP_SetDefaultRateParams.
     *
     * ## Event Code: 0x143D
     *
     *  ## result:
     ...
     *  none
     */
    BLE_GAP_EVENT_SET_DEF_RATE_COMP,

    /**
     *  @brief      Minimum supported connection interval parameters have been read.
     *  @details    
     *  This event notifies minimum supported connection interval parameters requested by 
     *  R_BLE_GAP_ReadMinSupportedConnIntervals have been read.
     *
     * ## Event Code: 0x143E
     *
     *  ## result:
     ...
     *  st_ble_gap_min_intv_rd_evt_t
     */
    BLE_GAP_EVENT_MIN_INTV_RD_COMP,

    /**
     *  @brief      Connection rate update procedure has completed.
     *  @details    
     *  This event indicated the connection rate update procedure has completed.
     *
     * ## Event Code: 0x143F
     *
     *  ## result:
     ...
     *              </tr>
     *              <tr>
     *                  <td class="paramname">Other Errors</td>
     *                  <td>Any error indicating the procedure did not complete successfully.</td>
     *              </tr>
     *          </table>
     *  </dd></dt></dl>
     *
...
typedef enum
{
    ...
    /**
     * @brief An CIS connection is terminated.
     *
     * ## Event Data:
     * st_ble_iso_cis_term_evt_t
     */
 ...
 *  @brief  This structure notifies that the EATT Channel has been enabled.
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
     *  @brief     Number of opened eatt channel.
     */
    uint16_t channel_num;

    /**
     *  @brief     MTU for each eatt channel.
     */
    uint16_t mtu[BLE_EATT_NUM_ECB_BEARERS_MAX];
} st_ble_eatt_enabled_evt_t;

/******************************************************************************************************************//**
 * @ingroup EATT_API
 *  @struct st_ble_eatt_disabled_evt_t
 *  @brief  This structure notifies that the EATT Channel has been disabled.
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
     *  @brief     disabled eatt channel cid.
     */
    uint16_t cid;
 ...
 *  @brief  This structure notifies that the GATT Database hash Caluculation has been completed.
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
     *  @brief    GATT database DBHash Value.
     */
    uint8_t db_hash[BLE_GATTS_DATABASE_HASH_LEN];
} st_ble_gatts_db_hash_evt_t;
 ...
 *  @brief  This structure notifies that a Notification process has started on the local host.
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
 ...
 *  @brief  This structure notifies that a Read Multiple Variable Response PDU has been sent from GATT Server.
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
     *  @brief    The number of attribute read by the Read Multiple Variable Request PDU.
     */
    uint16_t count;

    /**
     *  @brief    The list of attribute read by the Read Multiple Variable Request PDU.
     */
    uint16_t * p_attr_hdl_list;
} st_ble_gatts_read_multiple_variable_rsp_evt_t;
 ...
 *  @brief  st_ble_gatts_db_attr_t configures the attributes of the GATT database.
 **********************************************************************************************************************/
typedef struct
{
    /**
    ...
    /**
     * @brief    Attirubte value length. This parameter is ignored when aux_prop set BLE_GATT_DB_FIXED_LENGTH. 
     */
    uint16_t * p_value_len;
    
    /**
     * @brief    Maximum Attirubte value length.
     */
    const uint16_t max_value_len;

    /**
     * @brief    Attribute Permisions
     *            | value                                    | description                                       |
     *            |:-----------------------------------------|:--------------------------------------------------- |
     ...
     *            | BLE_GATT_DB_PERMIT_READ_ENC_KEY_SIZE_16  | Encryption key size 16 is required to read access.  |
     ...
     *            | BLE_GATT_DB_PERMIT_WRITE_ENC_KEY_SIZE_16 | Encryption key size 16 is required to write access. |
     * 
     */
     ...
     *          </tr>
     *          <tr>
     *              <td>BLE_GATT_DB_NO_AUXILIARY_PROPERTY(0x0000)</td>
     *              <td>
     *                  No auxiliary properties.\n
     *                  It is invalid when used with other properties at the same time.
     *              </td>
     *          </tr>
     *          <tr>
     *              <td>BLE_GATT_DB_FIXED_LENGTH_PROPERTY(0x0001)</td>
     *              <td>
     *                  Fixed length attribute value.
     *              </td>
     *          </tr>
     *          <tr>
     *              <td>BLE_GATT_DB_ATTR_DISABLED(0x0010)</td>
     *              <td>
     *                  The attribute is disabled.
     *                  If this value is set, the attribute cannot be found and accessed by a GATT Client.
     *                  It is invalid when used with other properties at the same time.
     ...
     *          </tr>
     *          <tr>
     *              <td>BLE_GATT_DB_128_BIT_UUID_FORMAT(0x0020)</td>
     *              <td>
     *                  Attribute with 128 bit UUID.\n
     *                  If this macro is not set, the attribute value is 16-bits UUID.
     *              </td>
     *          </tr>
     *          <tr>
     *              <td>BLE_GATT_DB_PEER_SPECIFIC_VAL_PROPERTY(0x0040)</td>
     *              <td>
     *                  Attribute managed by each GATT Client.
     *              </td>
     *          </tr>
     *          <tr>
     *              <td>BLE_GATT_DB_CONST_ATTR_VAL_PROPERTY(0x0080)</td>
     *              <td>
     *                  Fixed attribute value.\n
     *                  Writing from Client and setting from Server are prohibited.
     *              </td>
     *          </tr>
     *          <tr>
     *              <td>BLE_GATT_DB_ENABLE_WRITE_WITHOUT_RSP(0x0100)</td>
     *              <td>
     ...
     *          </tr>
     *          <tr>
     *              <td>BLE_GATT_DB_ONLY_SIGNED_WRITE(0x0200)</td>
     *              <td>
     ...
     *          </tr>
     *          <tr>
     *              <td>BLE_GATT_DB_SECONN_ONLY_READ(0x1000)</td>
     *              <td>
     *                  LE Secure Connection Pairing is required in read access.
     *              </td>
     *          </tr>
     *          <tr>
     *              <td>BLE_GATT_DB_SECONN_ONLY_WRITE(0x2000)</td>
     *              <td>
     *                  LE Secure Connection Pairing is required in write access.
     *              </td>
     *          </tr>
     *      </table>
     */
 ...
 *  @brief  st_ble_gatts_db_group_t is the type of data register gatt database to host.
 **********************************************************************************************************************/
typedef struct 
{
    /**
     * @brief    attributes
     */
    st_ble_gatts_db_attr_t * p_attrs;

    /**
     * @brief    number of attributes
     */
    uint16_t num_of_attr;

    /**
     * @brief    GATT Database Group Start handle register to host stack.
     */
    uint16_t start_hdl;

    /**
     * @brief    Start handle registered GATT Database Group by host stack.
     *           This parameter is output parameter and set by host stack.
     */
    uint16_t actual_start_hdl;

    /**
     * @brief    End handle registered GATT Database Group by host stack. 
     *           This parameter is output parameter and set by host stack.
     */
    uint16_t actual_end_hdl;
}st_ble_gatts_db_group_t;

/******************************************************************************************************************//**
 *  @struct e_ble_gatts_core_service_index_t
 *  @brief  e_ble_gatts_core_service_index_t is the type of the enumration using R_BLE_GATTS_GetCoreServiceHandle
 **********************************************************************************************************************/
typedef enum
{
    /** 
     * @brief GAP Service Start Handle 
     */
    BLE_GATTS_GAP_SERV_START_IDX = 0x0000, 
    /** 
     * @brief GAP Service Device Name Characteristic Declaration Handle 
     */
    BLE_GATTS_GAP_SERV_DEV_NAME_DECL_IDX,
    /** 
     * @brief GAP Service Device Name Characteristic Value Handle 
     */
    BLE_GATTS_GAP_SERV_DEV_NAME_VAL_IDX,
    /** 
     * @brief GAP Service Apperance Characteristic Declaration Handle 
     */
    BLE_GATTS_GAP_SERV_APPEARANCE_DECL_IDX,
    /** 
     * @brief GAP Service Apperance Characteristic Value Handle 
     */
    BLE_GATTS_GAP_SERV_APPEARANCE_VAL_IDX,
    /** 
     * @brief GAP Service Periferal Prefer Connection Param Characteristic Declaration Handle 
     */
    BLE_GATTS_GAP_SERV_PER_PREF_CONN_PARAM_DECL_IDX,
    /** 
     * @brief GAP Service Periferal Prefer Connection Param Characteristic Value Handle 
     */
    BLE_GATTS_GAP_SERV_PER_PREF_CONN_PARAM_VAL_IDX,
    /** 
     * @brief GAP Service Central Address Resolution Characteristic Declaration Handle 
     */
    BLE_GATTS_GAP_SERV_CENT_ADDR_RSLV_DECL_IDX,
    /** 
     * @brief GAP Service Central Address Resolution Characteristic Value Handle 
     */
    BLE_GATTS_GAP_SERV_CENT_ADDR_RSLV_VAL_IDX,
    /** 
     * @brief GAP Service Resolve Privacy Address Only Characteristic Value Handle 
     */
    BLE_GATTS_GAP_SERV_RSLV_PRIV_ADDR_ONLY_DECL_IDX,
    /** 
     * @brief GAP Service Resolve Privacy Address Only Characteristic Declaration Handle 
     */
    BLE_GATTS_GAP_SERV_RSLV_PRIV_ADDR_ONLY_VAL_IDX,
    /** 
     * @brief GAP Service Encryption Data Key Materials Characteristic Declaration Handle 
     */
    BLE_GATTS_GAP_SERV_ENC_DATA_KEY_MATERIAL_DECL_IDX,
    /** 
     * @brief GAP Service Encryption Data Key Materials Characteristic Value Handle 
     */
    BLE_GATTS_GAP_SERV_ENC_DATA_KEY_MATERIAL_VAL_IDX,
    /** 
     * @brief GAP Service Encryption Data Key Materials Characteristic Client Configuration Descriptor Handle 
     */
    BLE_GATTS_GAP_SERV_ENC_DATA_KEY_MATERIAL_CLI_CNFG_DESC_IDX,
    /** 
     * @brief GAP Service LE GATT Security Levels Characteristic Declaration Handle 
     */
    BLE_GATTS_GAP_SERV_LE_GATT_SEC_LEVELS_DECL_IDX,
    /** 
     * @brief GAP Service LE GATT Security Levels Characteristic Value Handle 
     */
    BLE_GATTS_GAP_SERV_LE_GATT_SEC_LEVELS_VAL_IDX,
    /** 
     * @brief GAP Service End Handle 
     */
    BLE_GATTS_GAP_SERV_END_IDX,
    
    /** 
     * @brief GATT Service Start Handle 
     */
    BLE_GATTS_GATT_SERV_START_IDX,
    /** 
     * @brief GATT Service Service Changed Characteristic Declaration Handle 
     */
    BLE_GATTS_GATT_SERV_SERV_CHGED_DECL_IDX,
    /** 
     * @brief GATT Service Service Changed Characteristic Value Handle 
     */
    BLE_GATTS_GATT_SERV_SERV_CHGED_VAL_IDX,
    /** 
     * @brief GATT Service Service Changed Client Configuration Descriptor Handle
     */
    BLE_GATTS_GATT_SERV_SERV_CHGED_CLI_CNFG_DESC_IDX,
    /** 
     * @brief GATT Service Client Support Feature Declaration Characteristic Handle
     */
    BLE_GATTS_GATT_SERV_CLI_SPRT_FEAT_DECL_IDX,
    /** 
     * @brief GATT Service Client Support Feature Value Characteristic Handle
     */
    BLE_GATTS_GATT_SERV_CLI_SPRT_FEAT_VAL_IDX,
    /** 
     * @brief GATT Service Database Hash Declaration Characteristic Handle
     */
    BLE_GATTS_GATT_SERV_DB_HASH_DECL_IDX,
    /** 
     * @brief GATT Service Database Hash Value Characteristic Handle
     */
    BLE_GATTS_GATT_SERV_DB_HASH_VAL_IDX,
    /** 
     * @brief GATT Service Server Support Feature Characteristic Declaration Handle
     */
    BLE_GATTS_GATT_SERV_SRV_SPRT_FEAT_DECL_IDX,
    /** 
     * @brief GATT Service Server Support Feature Characteristic Value Handle
     */
    BLE_GATTS_GATT_SERV_SRV_SPRT_FEAT_VAL_IDX,
    /** 
     * @brief GATT Service End Handle 
     */
...
/******************************************************************************************************************//**
 *  @struct st_ble_gattc_hdl_filter_pair_t
 *  @brief  This is used in R_BLE_GATTC_SetIndNtfEventFilter() to specify the attr_hdl pair for notification and
 *          indication event filter.
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
     *  @brief    Attribute handle to set the minimum security level.
     */
    uint16_t attr_hdl;
    /**
     *  @brief    The minimum security level for filtering following events on the local GATT client.
     *            - BLE_GATTC_EVENT_HDL_VAL_NTF
     *            - BLE_GATTC_EVENT_HDL_VAL_IND
     *            - BLE_GATTC_EVENT_MULTI_HDL_VAL_NTF
     *  @details
     *    |                value                       |                             description                     |
     *    |:------------------------------------------ |:----------------------------------------------------------- |
     *    | BLE_GATTC_FILTER_LEVEL_NONE(0x00)          | No security requirements.                                   |
     *    | BLE_GATTC_FILTER_LEVEL_ENC_UNAUTH(0x01)    | Encrypted with unauthenticated pairing.                     |
     *    | BLE_GATTC_FILTER_LEVEL_ENC_AUTH(0x02)      | Encrypted with authenticated pairing.                       |
    *     | BLE_GATTC_FILTER_LEVEL_ENC_AUTH_LESC(0x03) | Encrypted with authenticated LE Secure Connections pairing. |
     */
     uint8_t  filter_level;
} st_ble_gattc_hdl_filter_pair_t;
...
typedef struct BLE_PACKED_OPTION
{
     ...
     *                  </tr>
     *                  <tr>
     *                      <td>BLE_ERR_GATT_DATABASE_OUT_OF_SYNC(0x3012)</td>
     *                      <td>The server requests the client to rediscover the database.
     *                      </td>
     *                  </tr>
     *                  <tr>
     *                      <td>BLE_ERR_GATT_VALUE_NOT_ALLOWED(0x3013)</td>
     *                      <td>The attribute parameter value was not allowed.
     *                      </td>
     *                  </tr>
     *                  <tr>
     *                      <td>0x3080 - 0x309F</td>
...
/******************************************************************************************************************//**
 *  @struct st_ble_gattc_multi_hdl_val_ntf_evt_t 
 *  @brief  This structure notifies that a Multiple Variable Notifications PDU has been received from a GATT Server.
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
     *  @brief    Raw Data that causes the Multiple Notifications.
     */
    uint8_t * p_data;
    uint16_t  length;
} st_ble_gattc_multi_hdl_val_ntf_evt_t ;
...
/******************************************************************************************************************//**
 *  @struct st_ble_gattc_char_signed_write_evt_t
 *  @brief  This structure notifies that write process of R_BLE_GATTC_SignedWriteChar() has started.
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
     *  @brief   Value handle of the characteristic or characteristic descriptor that is being written.
     */
    uint16_t value_hdl;
} st_ble_gattc_char_signed_write_evt_t;
...
/******************************************************************************************************************//**
 *  @struct st_ble_gattc_rd_multiple_variable_char_evt_t
 *  @brief  This structure notifies that read response to R_BLE_GATTC_ReadMultipleVariableLengthChar() has been received
 *          from a GATT Server.
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
     *  @brief   The Length of the data that has been read.
     */
    uint16_t length;

    /**
     *  @brief   The contents of the data that have been read.
     */
    uint8_t *p_data;
...
typedef enum
{
    ...
    /**
     *  @brief This event notifies that skip peripheral latency enable command is completed.
     *
     * ## Event Code: 0x8047
     *
     *  ## result:
     ...
     *              <tr>
     *                  <td class="paramname">BLE_ERR_INVALID_ARG(0x0003)</td>
     *                  <td>The conn_hdl or enable field specified by R_BLE_VS_SkipPeripheralLatencyEnable()
     *                      is out of range, or conn_hdl is not in peripheral role, or not in LE ACL.</td>
     *              </tr>
     *              <tr>
     *                  <td class="paramname">BLE_ERR_INVALID_HDL(0x000E)</td>
     *                  <td>The conn_hdl specified by R_BLE_VS_SkipPeripheralLatencyEnable()
     *                      is not in connection.</td>
     *              </tr>
     *          </table>
     *  </dd></dt></dl>
     *
     ...
     *  none
     */
    BLE_VS_EVENT_SKIP_PERIPHERAL_LATENCY_ENABLE_COMP = 0x8047,
 ...
 * @retval  BLE_ERR_INVALID_STATE(0x0008) The task for host stack is not running.
 * @retval  BLE_ERR_INVALID_OPERATION(0x0009) Host Privacy is being used.
 * @retval  BLE_ERR_MEM_ALLOC_FAILED(0x000C) Insufficient memory is needed to generate this function.
 **********************************************************************************************************************/
...
/******************************************************************************************************************//**
ble_status_t R_BLE_GAP_StartPerdAdvEx(uint8_t adv_hdl, uint8_t options)
 * @brief   Start periodic advertising.
 * @details This function starts periodic advertising.
 *          Set periodic advertising parameters to the advertising set, before starting periodic advertising.
 *          The result of this API call is notified in BLE_GAP_EVENT_PERD_ADV_ON event.
 * @param[in]  adv_hdl   Advertising handle identifying the advertising set which starts periodic advertising.
 * @param[in]  options   Periodic Advertise enable option Include the ADI field in AUX_SYNC_IND PDUs.
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_ARG(0x0003) adv_hdl or enable are out of range. 
 * @retval  BLE_ERR_UNSUPPORTED(0x0007) Not supported.
 * @retval  BLE_ERR_INVALID_STATE(0x0008) The task for host stack is not running.
 * @retval  BLE_ERR_MEM_ALLOC_FAILED(0x000C) Insufficient memory is needed to generate this function.
 **********************************************************************************************************************/
...
/******************************************************************************************************************//**
 *  @fn ble_status_t R_BLE_GAP_SetPerAdvRecvEnable(uint16_t sync_hdl, uint8_t enable)
...
/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GAP_CreateSyncEx(st_ble_gap_create_sync_param_t * p_create_sync_param)
 * @brief   Request for a periodic sync establishment.
 * @details This function sends a request for establishment of a periodic sync to a advertiser.
 *          In order to create a periodic sync, scan needs to be starting by R_BLE_GAP_StartScan().
 *          When Controller has received the request from host stack,
 *          BLE_GAP_EVENT_CREATE_SYNC_COMP event is notified to the application layer.
 *          When the periodic sync is established, BLE_GAP_EVENT_SYNC_EST event is notified to the application layer.
 * @param[in] p_create_sync_param Create Sync Parametes.
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_PTR(0x0001) p_create_sync_param is specified as NULL.
 * @retval  BLE_ERR_INVALID_ARG(0x0003) The following parameter is out of range.
 *                                      - address type in peer_addr
 *                                      - adv_sid
 *                                      - skip
 *                                      - sync_to
 * @retval  BLE_ERR_UNSUPPORTED(0x0007) Not supported.
 ...
 * @retval  BLE_ERR_MEM_ALLOC_FAILED(0x000C) Insufficient memory is needed to generate this function.
 **********************************************************************************************************************/
ble_status_t R_BLE_GAP_CreateSyncEx(st_ble_gap_create_sync_param_t *p_create_sync_param);
...
/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GAP_EnableCteConnless(uint8_t adv_hdl, uint8_t enable)
 ...
 *  @retval  BLE_SUCCESS(0x0000) Success
 **********************************************************************************************************************/
ble_status_t R_BLE_GAP_EnableCteConnless(uint8_t adv_hdl, uint8_t enable);
...
/******************************************************************************************************************//**
 *  @fn ble_status_t R_BLE_GAP_StartCteConnRecvSampling(st_ble_gap_cte_conn_rx_param_t * p_cte_param)
 *  @brief Set the parameters for the receiving of Constant Tone Extensions in ACL link.
 *          and start sampling.
 *  @param[in] p_cte_param parameters of type, length, and antenna switching pattern.
 *  @retval  BLE_SUCCESS(0x0000) Success
 **********************************************************************************************************************/
ble_status_t R_BLE_GAP_StartCteConnRecvSampling(st_ble_gap_cte_conn_rx_param_t * p_cte_param);
...
/******************************************************************************************************************//**
 *  @fn ble_status_t R_BLE_GAP_StopCteConnReq(uint16_t conn_hdl)
 *  @brief Stop sending request of Constant Tone Extensions in ACL link to peer.
 *  @param[in] conn_hdl handle of the ACL link which carries the CTE info.
 *  @retval  BLE_SUCCESS(0x0000) Success
 **********************************************************************************************************************/
ble_status_t R_BLE_GAP_StopCteConnReq(uint16_t conn_hdl);
...
/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GAP_StartPerdAdvSetInfoTransfer(uint8_t adv_hdl, uint16_t conn_hdl, uint16_t service_data)
 ...
 *
 **********************************************************************************************************************/
ble_status_t R_BLE_GAP_StartPerdAdvSetInfoTransfer(uint8_t adv_hdl, uint16_t conn_hdl, uint16_t service_data);
...
/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GAP_SetHostFeat(uint16_t bit_number, uint8_t bit_value)
 * @brief   Set or clear a bit controlled by the local Host.
 * @details This funtion sets or clears bits by the Host in the Link Layer FeatureSet stored in the Controller.
 *          When the specified bit is set or cleard, BLE_GAP_EVENT_SET_HOST_FEAT_COMP event is notified.
 * @param[in] bit_number Bit position in the FeatureSet. For details on the FeatureSet field,
 *                       refer to Bluetooth Core Specification v6.0 or later, Vol 6, Part B, 4.6 Feature Support.
 * @param[in] bit_value Value of the bit
 * @retval  BLE_SUCCESS(0x0000) Success, otherwise "HCI Spec Error" in enum RBLE_STATUS_enum.
 **********************************************************************************************************************/
ble_status_t R_BLE_GAP_SetHostFeat(uint16_t bit_number, uint8_t bit_value);

/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GAP_EncAdvData(st_ble_gap_enc_adv_data_t * p_enc_data);
 * @brief   Encrypt Data to be used for Advertising using AES-CCM.
 * @details This API call enables the BLE_GAP_EVENT_ENC_ADV_DATA_COMP event.
 * @param[in] p_enc_data Parameters containing data to encrypt
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_PTR(0x0001) The reason for this error is as follows.
 *                                      - p_enc_data is specified as NULL.
 *                                      - p_session_key in p_enc_data is specified as NULL.
 *                                      - p_iv in p_enc_data is specified as NULL.
 *                                      - p_plain_data in p_enc_data is specified as NULL.
 * @retval  BLE_ERR_INVALID_ARG(0x0003) len in p_enc_data is out of range
 * @retval  BLE_ERR_ALREADY_IN_PROGRESS(0x000A) Encryption has already started
 * @retval  BLE_ERR_MEM_ALLOC_FAILED(0x000C) Insufficient memory is needed to generate this function.
 **********************************************************************************************************************/
ble_status_t R_BLE_GAP_EncAdvData(st_ble_gap_enc_adv_data_t * p_enc_data);

/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GAP_DecAdvData(st_ble_gap_dec_adv_data_t * p_dec_data)
 * @brief   Decrypt Encrypted Data found in BLE_GAP_EVENT_ADV_REPT_IND using AES-CCM.
 * @details This API call enables the BLE_GAP_EVENT_DEC_ADV_DATA_COMP event.
 * @param[in] p_dec_data Parameters containing data to encrypt
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_PTR(0x0001) The reason for this error is as follows.
 *                                      - p_dec_data is specified as NULL.
 *                                      - p_session_key in p_dec_data is specified as NULL.
 *                                      - p_iv in p_dec_data is specified as NULL.
 *                                      - p_plain_data in p_dec_data is specified as NULL.
 * @retval  BLE_ERR_INVALID_ARG(0x0003) len in p_dec_data is out of range
 * @retval  BLE_ERR_ALREADY_IN_PROGRESS(0x000A) Decryption has already started
 * @retval  BLE_ERR_MEM_ALLOC_FAILED(0x000C) Insufficient memory is needed to generate this function.
 **********************************************************************************************************************/
ble_status_t R_BLE_GAP_DecAdvData(st_ble_gap_dec_adv_data_t * p_dec_data);

/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GAP_StartHostPriv(uint16_t change_interval)
 * @brief   Start Host Privacy and set time interval to update RPA
 * @details This API call enables BLE_GAP_EVENT_HOST_RPA_UPD_IND event. While Advertising, Scanning,
 *          or Connecting, BLE_GAP_EVENT_HOST_RPA_UPD_IND event is enabled whenever set time interval
 *          elapses.\n
 * @note    Advertising, Scanning, and Connecting actions must be stopped in order to update RPA.\n
 *          After this API is called, R_BLE_GAP_SetRandAddr and R_BLE_VS_SetBdAddr are disabled until
 *          R_BLE_GAP_StopHostPriv is called.\n
 *          own_addr_type in parameters for Advertising, Scanning, and Connecting actions must be set
 *          to BLE_GAP_ADDR_RAND. If not, RPA for Host Privacy cannot be used.\n
 * @param[in] change_interval Time interval to update RPA is seconds
 *                            The valid range is 0x0001 - 0xFFFF.
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_ARG(0x0003) change_interval is set to 0x0000
 * @retval  BLE_ERR_INVALID_STATE(0x0008) This function is called while host privacy is already active
 **********************************************************************************************************************/
ble_status_t R_BLE_GAP_StartHostPriv(uint16_t change_interval);

/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GAP_StopHostPriv(void)
 * @brief   Stop Host Privacy.
 * @details This API call does not enable any event.
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_STATE(0x0008) This function is called when host privacy is not active
 **********************************************************************************************************************/
ble_status_t R_BLE_GAP_StopHostPriv(void);

/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GAP_ReadAllLocalFeat(void)
 * @brief   Read all LE features for the controller.
 * @details This function reads all LE features supported by controller of the local device.
 *          The result of this API call in notified in the BLE_GAP_READ_ALL_LOCAL_FEAT_IND event.
 * @retval  BLE_SUCCESS(0x0000) Success
 **********************************************************************************************************************/
ble_status_t R_BLE_GAP_ReadAllLocalFeat(void);

/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GAP_ReadAllRemoteFeat(uint16_t conn_hdl, uint8_t req_page_num)
 * @brief   Read all features used on current connection and supported by the remote device.
 * @details This function reads from the remote device identified by the conn_hdl, the features used on the connection
 *          and the features supported by the remote device.
 *          The result of this API call is notified in BLE_GAP_READ_ALL_REMOTE_FEAT_COMP event.
 *          When the reception of remote features is complete, BLE_GAP_READ_ALL_REMOTE_FEAT_IND event is notified.
 * @param[in] conn_hdl     Connection handle identifying the remote device whose information to be retrieved.
 * @param[in] req_page_num Highest page among the pages in the remote device's LE features to be confirmed.
 *                         The value of this parameter is the page number of the FeatureSet field that indicates the
 *                         LE features supported by the device’s Link Layer. For details on the FeatureSet field,
 *                         refer to Bluetooth Core Specification v6.0 or later, Vol 6, Part B, 4.6 Feature Support.
 *                         Valid range is 0x00 - 0x0A
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_ARG(0x0003) req_page_num is out of range
 * @retval  BLE_ERR_INVALID_OPERATION(0x0009) Function called again before the
 *                                            BLE_GAP_READ_ALL_REMOTE_FEAT_IND is notified
 * @retval  BLE_ERR_INVALID_HDL(0x000E) The remote device specified by conn_hdl is not found.
 **********************************************************************************************************************/
ble_status_t R_BLE_GAP_ReadAllRemoteFeat(uint16_t conn_hdl, uint8_t req_page_num);

/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GAP_SetRpaRandTo(uint16_t rpa_timeout_min, uint16_t rpa_timeout_max)
 * @brief   Set the range of time to update resolvable private address.
 * @details This function sets range of time to update the resolvable private address.
 *          The controller will select a random time in the provided range for updates.
 *          The result of this API call is notified in BLE_GAP_EVENT_SET_RPA_TO_COMP event.
 * @param[in] rpa_timeout_min  Minimum time interval to update resolvable private address in seconds.
 *                             Valid range is 0x0001 - 0x0E10.
 *                             Default is 480s.
 * @param[in] rpa_timeout_max  Maximum time interval to update resolvable private address in seconds.
 *                             Valid range is 0x0001 - 0x0E10.
 *                             Default is 900s.
 * @retval  BLE_SUCCESS(0x0000) Success
 **********************************************************************************************************************/
ble_status_t R_BLE_GAP_SetRpaRandTo(uint16_t rpa_timeout_min, uint16_t rpa_timeout_max);

/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GAP_ReadDefDataLen(void)
 * @brief   Read the suggested default data length values.
 * @details Read the suggested default values for the maximum transmission payload length
 *          and the maximum packet transmission time to be used for the transmission
 *          packets of new connections.
 *          When the suggested default values are read, the BLE_GAP_EVENT_DEF_DATA_LEN_RD_COMP event is notified. 
 * @retval  BLE_SUCCESS(0x0000) Success
 **********************************************************************************************************************/
ble_status_t R_BLE_GAP_ReadDefDataLen(void);

/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GAP_WriteDefDataLen(uint16_t tx_octets, uint16_t tx_time)
 * @brief   Write the suggested default data length values.
 * @details Write the suggested default values for the maximum transmission payload length
 *          and the maximum packet transmission time to be used for the transmission
 *          packets of new connections.
 *          When the suggested default values are written, the BLE_GAP_EVENT_DEF_DATA_LEN_WR_COMP event is notified. 
 * @param[in] tx_octets The suggested value for the maximum transmitted number of payload for new connections.
 *                      Valid range is 0x001B - 0x00FB. Default is 0x001B.
 * @param[in] tx_time   The suggested value for the maximum packet transmission time of packets for new connections.
 *                      Valid range is 0x0148 - 0x4290. Default is 0x0148.
 * @retval  BLE_SUCCESS(0x0000) Success
 **********************************************************************************************************************/
ble_status_t R_BLE_GAP_WriteDefDataLen(uint16_t tx_octets, uint16_t tx_time);

/******************************************************************************************************************//**
 * @fn ble_status_t  R_BLE_GAP_ConnRateReq (uint16_t conn_hdl, st_ble_gap_conn_rate_param_t * p_conn_rate_req)
 * @brief   Request a change to existing connection parameters.
 * @details Request a change to existing connection parameters. When the request is received by the controller,
 *          BLE_GAP_EVENT_CONN_RATE_REQ_COMP event is notified. When the connection rate update procedure has  
 *          completed, BLE_GAP_EVENT_CONN_RATE_CHG event is notified.
 * @param[in] conn_hdl         Connection handle.
 * @param[in] p_conn_rate_req  Connection rate parameters.
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_PTR(0x0001) p_conn_rate_req param parameter is specified as NULL. 
 * @retval  BLE_ERR_INVALID_ARG(0x0003) The below p_conn_rate_req parameter value is out of range.
 *                                        - conn_intv_min
 *                                        - conn_intv_max
 *                                        - subrate_min
 *                                        - subrate_max
 ...
 * @retval  BLE_ERR_INVALID_HDL(0x000E) The remote device specified by conn_hdl is not found.
 **********************************************************************************************************************/
ble_status_t R_BLE_GAP_ConnRateReq(uint16_t conn_hdl, st_ble_gap_conn_rate_param_t * p_conn_rate_req);

/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GAP_SetDefaultRateParams(st_ble_gap_conn_rate_param_t * p_default_rate_params)
 * @brief   Set the initial values of the acceptable connection rate parameters.
 * @details Set the initial values of the acceptable parameters for the Connection Rate Request procedure 
 *          for all future ACL connections where the controller is Central. The result of this API call is 
 *          notified in BLE_GAP_EVENT_SET_DEF_RATE_COMP event.
 * @param[in] p_default_rate_params  Connection rate parameters.
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_PTR(0x0001) p_default_rate_params param parameter is specified as NULL. 
 * @retval  BLE_ERR_INVALID_ARG(0x0003) The below p_default_rate_params parameter value is out of range.
 *                                        - conn_intv_min
 *                                        - conn_intv_max
 *                                        - subrate_min
 *                                        - subrate_max
 ...
 *                                        - max_ce_length
 **********************************************************************************************************************/
ble_status_t R_BLE_GAP_SetDefaultRateParams(st_ble_gap_conn_rate_param_t * p_default_rate_params);

/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GAP_ReadMinSupportedConnIntervals(void)
 * @brief   Read minimum supported connection interval information.
 * @details Read minimum supported connection interval information. The result of this API call is 
 *          notified in BLE_GAP_EVENT_MIN_INTV_RD_COMP event.
 * @retval  BLE_SUCCESS(0x0000) Success
 **********************************************************************************************************************/
ble_status_t R_BLE_GAP_ReadMinSupportedConnIntervals(void);
 ...
 *  @brief Create a BIG.
 *  @param[in] big_hdl BIG handle is assigned by application and identify created big.
...
/******************************************************************************************************************//**
 *  @fn ble_status_t R_BLE_ISO_TerminateBig(uint8_t big_hdl, uint8_t reason)
 *  @brief  Terminate a BIG of the big_handle
 *  @param[in] big_hdl handle of the BIG to be terminated.
 *  @param[in] reason  The reason for disconnection.
 *                     Usually, set 0x13 which indicates that a user disconnects the link.
 *                     If setting other than 0x13, refer the error code described
 *                     in Core Specification Vol.2 Part D ,"2 Error Code Descriptions".
 ...
 *  @param[in] big_hdl BIG handle is assigned by application, and value is passed out.
 ...
 *  @param[in] cig_id CIG is assigned by application, and value is passed out.
 ...
 *  @param[in] cig_id CIG id to be removed.
 *  @retval  BLE_SUCCESS(0x0000) Success
 **********************************************************************************************************************/
ble_status_t R_BLE_ISO_RemoveCig(uint8_t cig_id);

/******************************************************************************************************************//**
 *  @fn ble_status_t R_BLE_ISO_TerminateCis(uint16_t cis_conn_hdl)
 *  @brief  Terminate a CIS
 *  @param[in] cis_conn_hdl connection handle of the CIS to be terminated.
 *  @retval  BLE_SUCCESS(0x0000) Success
 **********************************************************************************************************************/
ble_status_t R_BLE_ISO_TerminateCis(uint16_t cis_conn_hdl);

/******************************************************************************************************************//**
 *  @fn ble_status_t R_BLE_ISO_ReplyCisRequest(uint16_t cis_conn_hdl, uint8_t response, uint8_t reason)
 ...
 *          The result of this API call is returned by a return value.
 *          After this API is executed, @ref BLE_ISO_EVENT_REPLY_CIS_REQ_COMP is notified.
 *          @ref BLE_ISO_EVENT_CIS_EST is notified when CIS is established.
 *  @param[in] cis_conn_hdl Connection Handle for CIS.
 *  @param[in] response     Accept or reject the pairing request from the remote device.
 *               |              macro            |           description            |
 *               |:----------------------------- |:-------------------------------- |
 *               | BLE_ISO_CIS_ACCEPT(0x00)      | Accept the CIS request.      |
...
/******************************************************************************************************************//**
 *  @fn ble_status_t R_BLE_ISO_SetupDataPath(uint16_t conn_hdl, st_ble_iso_data_path_t * p_path)
...
/******************************************************************************************************************//**
 *  @fn ble_status_t R_BLE_ISO_SendData(uint16_t conn_hdl, st_ble_iso_sdu_t * p_sdu_info)
 ...
 *  @retval  BLE_ERR_MEM_ALLOC_FAILED(0x000C) Insufficient memory is needed to generate this function.
 *  @retval  BLE_ERR_INVALID_HDL(0x000E) The reason for this error is as follows.
 ...
 * @details
 * @param[in] big_hdl Used to identify a BIG.
 * @param[in] adv_hdl Used to identify an advertising set.
 * @param[in] p_big_test_param specified parameter of BIG param test
 * @retval  BLE_SUCCESS(0x0000) Success, otherwise "HCI Spec Error" in enum RBLE_STATUS_enum.
 **********************************************************************************************************************/
 ...
 * @param[in] cig_id cig ID is assigned by host stack, and value is passed out.
 * @param[in] p_cig_test_param specified parameter of CIG param_test
 * @retval  BLE_SUCCESS(0x0000) Success, otherwise "HCI Spec Error" in enum RBLE_STATUS_enum.
 **********************************************************************************************************************/
...
/******************************************************************************************************************//**
 *  @fn R_BLE_ISO_RemoveDataPath(uint16_t conn_hdl, uint8_t path_dir)
 *  @brief Remove the input and/or output data path(s) associated with a CIS, CIS configuration, or BIS
 *         identified by the Connection_Handle parameter.
 *  @details
 *  @param[in] conn_hdl     Connection handle of the CIS or BIS
 *  @param[in] path_dir     Data path direction.This parameter set by bitfield.
...
/* ========================================== EATT API Declarations ========================================== */

/** @defgroup EATT_API EATT
 *  @ingroup BLE_API
 *  @{
 */
...
/******************************************************************************************************************//**
 * @ingroup EATT_API
 * @fn ble_status_t R_BLE_EATT_Enable(uint16_t conn_hdl)
 * @brief   Enable EATT bearers.
 * @details When this API is called, to request L2CAP channel Enhanced Credit Based Flow Control Mode.          
 * @param[in] conn_hdl Connection handle identifying the remote device.

 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_STATE(0x0008) R_BLE_EATT_Enable has been called.
...
/******************************************************************************************************************//**
 * @ingroup EATT_API
 * @fn ble_status_t R_BLE_EATT_GetState(uint16_t conn_hdl, uint8_t * p_state)
 * @brief   Check if EATT is enabled for the connection.
 * @details Check if EATT is enabled for the connection.
 * @param[in] conn_hdl Connection handle identifying the remote device.
 * @param[out] p_state wheather EATT is enabled for the connection.
 *        |              macro      |   description                       |
 *        |:----------------------- |:------------------------------------|
 *        | BLE_EATT_DISABLED(0x00) | EATT channel has not been enabled.  |
 *        | BLE_EATT_ENABLED (0x01) | EATT channel has been enabled.      |
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_PTR(0x0001) The p_state parameter is NULL.
 * @retval  BLE_ERR_INVALID_HDL(0x000E) The remote device specified by conn_hdl was not found.
 **********************************************************************************************************************/
...
/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GATTS_AddDbGroup(st_ble_gatts_db_group_t * p_attr_group)
 * @brief   This function adds GATT Database Group to host stack.
 * @details The result of this API call is returned by a return value.
 * @param[in] p_attr_group GATT Database to be set.
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_PTR(0x0001) The reason for this error is as follows.
 *                                      - The p_attr_group parameter is specified as NULL.
 * @retval BLE_ERR_MEM_ALLOC_FAILED(0x000C) memory allocation failure for GATT Database group.
 **********************************************************************************************************************/
ble_status_t R_BLE_GATTS_AddDbGroup(st_ble_gatts_db_group_t * p_attr_group);

/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GATTS_RemoveDbGroup(st_ble_gatts_db_group_t * p_attr_group)
 * @brief   This function remove GATT Database group in host stack.
 * @details The result of this API call is returned by a return value.
 * @param[in] p_attr_group GATT Database to be removed.
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_PTR(0x0001) The reason for this error is as follows.
 *                                      - The p_attr_group parameter is specified as NULL.
 * @retval BLE_ERR_NOT_FOUND(0x000D) Specified GATT Database group is not registed in host stack.
 **********************************************************************************************************************/
ble_status_t R_BLE_GATTS_RemoveDbGroup(st_ble_gatts_db_group_t * p_attr_group);

/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GATTS_GetCoreServiceHandle(uint8_t attr_index, uint16_t * p_attr_hdl)
 * @brief   This function get GAP Service characteristic and descriptor attribute handles in GATT Database group in host stack.
 * @details The result of this API call is returned by a return value.
 * @param[in]  attr_index core service attribute index refer e_ble_gatts_core_service_index_t;
 * @param[out] p_attr_hdl handle information
 * @retval  BLE_SUCCESS(0x0000) Success
 **********************************************************************************************************************/
ble_status_t R_BLE_GATTS_GetCoreServiceHandle(uint8_t attr_index, uint16_t * p_attr_hdl);

/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GATTS_SetStoredClientSupportedFeature(uint16_t conn_hdl, uint8_t *p_csf_value, uint8_t csf_length)
 * @brief   This function sets Client Supported Feature to host in order to process some feature such robust caching. 
 * @details This function sets to the host stack the value of Client Supported Feature that a bonded client wrote before disconnecting.
 *          The result of this API call is returned by a return value.
 * @note    This function does not set any values ​​in the GATT database.
 * @param[in] conn_hdl Connection handle identifying the remote device to be set the client supported feature.
 * @param[in] p_csf_value Client Supported Feature value.
 * @param[in] csf_length Client Supported Feature value length.
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_PTR(0x0001) The reason for this error is as follows.
 *                                      - The p_csf_value parameter is specified as NULL.
 * @retval  BLE_ERR_INVALID_ARG(0x0003) The csf_length is not adapted.
 * @retval  BLE_ERR_INVALID_HDL(0x000E) The remote device specified by conn_hdl was not found.
 **********************************************************************************************************************/
ble_status_t R_BLE_GATTS_SetStoredClientSupportedFeature(uint16_t conn_hdl, uint8_t *p_csf_value, uint8_t csf_length);

/******************************************************************************************************************//**
 * @fn R_BLE_GATTS_SetClientAwareDbHash(uint16_t conn_hdl, uint8_t *p_db_hash)
 * @brief   This function sets GATT Database Hash value when client became client-aware state to host stack.
 * @details The host stack compares this db_hash value with the hash value of the current GATT database to determine the
 *          value of the client's Client Aware State at the time of connection.
 *          If the db_hash value matches the current GATT database value,
 *          the host stack determines that the client is in a Client-Aware State.
 *          If they do not match, the host stack determines that the client is in a Client-Unaware State.
 *          The result of this API call is returned by a return value.
 * @note    This function does not set any values ​​in the GATT database.
 * @param[in] conn_hdl Connection handle identifying the remote device to be set the db_hash.
 * @param[in] p_db_hash GATT Database Hash value.
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_PTR(0x0001) The reason for this error is as follows.
 ...
 *          The result of this API call is returned by a return value.
 *          BLE_GATTS_EVENT_HDL_VAL_NTF_COMP event notifies the application that notification process has started.
...
/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GATTS_MultipleVariableLengthNotfications(uint16_t conn_hdl, st_ble_gatt_hdl_value_pair_t * p_value_pairs, uint8_t pair_num)
 * @brief   This function sends notifications specify attribute handle and attribute's value.
 * @details The maximum length of the attribute value that can be sent with notification is MTU-3.\n
 *          The result of this API call is returned by a return value.
 *          BLE_GATTS_EVENT_HDL_VAL_MULTIPLE_NTF_COMP event notifies the application that notification process has started.
 * @param[in] conn_hdl Connection handle identifying the remote device to be sent the notification.
 * @param[in] p_value_pairs The attribute value handle pair to send.
 * @param[in] pair_num The number of attribute to send.
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_PTR(0x0001) The p_ntf_data parameter or the value field in the value field in
 *                                      the p_ntf_data parameter is NULL.
 * @retval  BLE_ERR_INVALID_ARG(0x0003) The value_len field in the value field in the p_ntf_data parameter is 0
...
/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GATTC_ReadMultipleVariableLengthChar(uint16_t conn_hdl, st_ble_gattc_rd_multi_req_param_t * p_list)
 * @brief   This function reads multiple variable length Characteristics in a GATT Server.
 * @details The contents of the multiple variable length Characteristics that has been read is notified to the application layer
 *          by BLE_GATTC_EVENT_MULTIPLE_VARIABLE_CHAR_READ_RSP  event.
 * @param[in] conn_hdl Connection handle that identifies Characteristic to be read to GATT Server.
 * @param[in] p_list List of Value Handles that point the Characteristics to be read.
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_PTR(0x0001) The p_list parameter or the p_hdl_list field in the p_list parameter is
 ...
 * @retval  BLE_ERR_INVALID_HDL(0x000E) The GATT Server specified by conn_hdl was not found.
 **********************************************************************************************************************/
ble_status_t R_BLE_GATTC_ReadMultipleVariableLengthChar( uint16_t conn_hdl, st_ble_gattc_rd_multi_req_param_t * p_list );
 ...
 * @details The result is returned from the API.
 *          BLE_GATTC_EVENT_CHAR_WRITE_WITHOUT_RSP event is notified when the Write Without Response process started.
 * @param[in] conn_hdl Connection handle that identifies Characteristic to be read to GATT Server.
 ...
 * @details The result is returned from the API.
 *          BLE_GATTC_EVENT_CHAR_SIGNED_WRITE event is notified when the Signed Write process started.
...
/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GATTC_SetDefIndNtfEventFilter(uint16_t conn_hdl, uint8_t filter_level)
 * @brief   Set the minimum security level for all GATT client handle notifications and indications
 *          on a specific connection. 
 * @details If the specified connection security level is insufficient, notifications and indications events
 *          from the GATT Server will be ignored.\n
 *          If this API is not called, the default minimum security level will be @ref BLE_GATTC_FILTER_LEVEL_NONE.\n
 *          By this API function call, no events occur.
 * @param[in] conn_hdl Connection handle identifying the target GATT Server.
 * @param[in] filter_level Minimum security level for all services notifications and indications event filter.
 *        |              macro                         |                           description                        |
 *        |:------------------------------------------ |:------------------------------------------------------------ |
 *        | BLE_GATTC_FILTER_LEVEL_NONE(0x00)          | No security requirements.                                    |
 *        | BLE_GATTC_FILTER_LEVEL_ENC_UNAUTH(0x01)    | Encrypted with unauthenticated pairing.                      |
 ...
 *        | BLE_GATTC_FILTER_LEVEL_ENC_AUTH_LESC(0x03) | Encrypted with authenticated LE Secure Connections pairing.  |
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_ARG(0x0003) The filter_level parameter is out of range.
 * @retval  BLE_ERR_INVALID_HDL(0x000E) The GATT Server specified by conn_hdl was not found.
 **********************************************************************************************************************/
ble_status_t R_BLE_GATTC_SetDefIndNtfEventFilter(uint16_t conn_hdl, uint8_t filter_level);

/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GATTC_SetIndNtfEventFilter(uint16_t conn_hdl,
 *                                                   st_ble_gattc_hdl_filter_pair_t * p_filter_pair,
 *                                                   uint16_t pair_num);
 * @brief   Set the minimum security level for all GATT client handle notifications and indications 
 *          on a specific connection with attribute handle pair.
 * @details If the specified connection and attribute handle security level is insufficient, notifications and
 *          indications events from the GATT Server will be ignored.\n
 *          These security levels will override the default configuration applied through
 *          \ref R_BLE_GATTC_SetDefIndNtfEventFilter.\n
 *          By this API function call, no events occur.
 * @note    This function should be called once, with a complete list of attribute handles and specific
 *          security levels for each subsequent calls overwrite the previous settings.\n
 *          Calling this API function with the p_filter_pair parameter set to NULL and the pair_num parameter 
 *          set to 0 will clear any previous settings.
 * @param[in] conn_hdl Connection handle identifying the target GATT Server.
 * @param[in] p_filter_pair A pair of handles to filter notification and indication events.
 * @param[in] pair_num The number of the pairs specified by the p_filter_pair parameter.
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_PTR(0x0001) The p_filter_pair parameter is NULL and pair_num parameter is not 0.
 * @retval  BLE_ERR_INVALID_ARG(0x0003) The reason for this error is as follows.
 *          - The filter_level parameter in the p_filter_pair field is out of range.
 *          - The p_filter_pair parameter is not NULL and pair_num parameter is 0.
 * @retval  BLE_ERR_MEM_ALLOC_FAILED(0x000C) Insufficient memory is needed to generate this function.
 * @retval  BLE_ERR_INVALID_HDL(0x000E) The GATT Server specified by conn_hdl was not found.
 **********************************************************************************************************************/
ble_status_t R_BLE_GATTC_SetIndNtfEventFilter(uint16_t conn_hdl,
                                              st_ble_gattc_hdl_filter_pair_t * p_filter_pair,
                                              uint16_t pair_num);
 ...
 * @retval  BLE_SUCCESS(0x0000) Success
 * @retval  BLE_ERR_INVALID_ARG(0x0003) The rand_size parameter is out of range.
 * @retval  BLE_ERR_INVALID_STATE(0x0008) The task for host stack is not running.
 * @retval  BLE_ERR_ALREADY_IN_PROGRESS(0x000A) Random number generation has been already started.
 * @retval  BLE_ERR_CONTEXT_FULL(0x000B) The API call could not be processed, because the Host Stack queue was full.
 * @retval  BLE_ERR_MEM_ALLOC_FAILED(0x000C) There are no memories for Vendor Specific Command.
 **********************************************************************************************************************/
...
/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_VS_SkipPeripheralLatencyEnable(uint16_t conn_hdl, uint8_t enable)
 * @brief   This function controls skipping the Peripheral latency feature.
 * @details Peripheral Latency is a power-saving feature that reduces power consumption by decreasing 
 *          the frequency at which peripheral devices respond to specific connection events.\n
 *          This API provides functionality to enable or disable peripheral latency.\n
 *          This API allows control of skipping Peripheral latency feature for the specified link.\n
 *          The result of this API call is notified via the BLE_VS_EVENT_SKIP_PERIPHERAL_LATENCY_ENABLE_COMP event.
 * @param[in] conn_hdl Connection handle indicating the link to skip Peripheral latency.
 * @param[in] enable The flag enables the skipping of Peripheral latency.
 *        |              macro                           |   description                                                           |
 *        |:-------------------------------------------- |:----------------------------------------------------------------------- |
 *        | BLE_VS_SKIP_PERIPHERAL_LATENCY_DISABLE(0x00) | Disables the skipping of the Peripheral latency feature.(Default State) |
 *        | BLE_VS_SKIP_PERIPHERAL_LATENCY_ENABLE(0x01)  | Enables the skipping of the Peripheral latency feature.                 |
 * @retval  BLE_SUCCESS(0x0000)  Success
 **********************************************************************************************************************/
ble_status_t R_BLE_VS_SkipPeripheralLatencyEnable(uint16_t conn_hdl, uint8_t enable);
