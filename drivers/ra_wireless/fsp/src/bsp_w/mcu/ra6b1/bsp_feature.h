...
#define BSP_FEATURE_ACOMP_W_MIN_WAIT_TIME_US             (0x3FU)

#define BSP_FEATURE_ADC_W_B_IS_AVAILABLE                 (1UL)
#define BSP_FEATURE_ADC_W_B_MAX_RESOLUTION_BITS          (16UL) // Maximum ADC resolution supported.
#define BSP_FEATURE_ADC_W_B_MAX_NUM_CHANNELS             (8U)

#define BSP_FEATURE_BSP_HAS_GPT_CLOCK                    (0U)
#define BSP_FEATURE_BSP_HAS_I3C_CLOCK                    (0U)
#define BSP_FEATURE_BSP_HAS_ICU                          (1)
#define BSP_FEATURE_BSP_HAS_QDEC                         (1)
#define BSP_FEATURE_BSP_HAS_WIFI                         (0)

/**
 * Buffer size is registered using the following equation
 * ( MAX_BUFFER_SIZE = 2 ^ (BSP_FEATURE_MTB_MAX_BUFFER_SIZE + 4) )Bytes
 */
#define BSP_FEATURE_MTB_MAX_BUFFER_SIZE                  (8U)

#define BSP_FEATURE_CGC_HAS_PCLKA                        (1U)
#define BSP_FEATURE_CGC_HAS_PCLKB                        (0U)
#define BSP_FEATURE_CGC_HAS_PCLKC                        (0U)
#define BSP_FEATURE_CGC_HAS_PCLKD                        (0U)
#define BSP_FEATURE_CGC_HAS_PLL                          (1U)
#define BSP_FEATURE_CGC_HAS_PLL2                         (0U)
#define BSP_FEATURE_CGC_HAS_POWER_LVL_REG                (1U)
#define BSP_FEATURE_CGC_HAS_RCHS_SPEEDS                  (1U)
#define BSP_FEATURE_CGC_HAS_RCLP_SPEEDS                  (1U)
#define BSP_FEATURE_CGC_HAS_SOSC                         (1U)
#define BSP_FEATURE_CGC_HAS_XTALM_DBLR                   (1U)
#define BSP_FEATURE_CGC_HAS_XTALM_READY_COUNTER          (0U)
#define BSP_FEATURE_CGC_RCHS_STABILIZATION_MAX_US        (0U)
#define BSP_FEATURE_CGC_RCX_STABILIZATION_MAX_US         (5000U)
#define BSP_FEATURE_CGC_RCLP_STABILIZATION_MAX_US        (0U)
#define BSP_FEATURE_CGC_PLL_STABILIZATION_MAX_US         (0U) // No standard (fixed) stabilization time but there is a stabilization wait flag.
#define BSP_FEATURE_CGC_DIGITAL_STABILIZATION_MAX_US     (0U)
#define BSP_FEATURE_CGC_ANY_LP_CLK_CAN_BE_SYS_CLK        (0)
#define BSP_FEATURE_CGC_HAS_HCLK_DIV                     (0U)
#define BSP_FEATURE_CGC_HAS_PCLK_DIV                     (1U)
#define BSP_FEATURE_CGC_HAS_QCLK_DIV                     (1U)
#define BSP_FEATURE_CGC_HAS_LP_CLOCK                     (1U)
#define BSP_FEATURE_CGC_HAS_RCHS                         (1U)
#define BSP_FEATURE_CGC_HAS_RCLP                         (1U)
#define BSP_FEATURE_CGC_HAS_RCX                          (1U)
#define BSP_FEATURE_CGC_HAS_RCX_CONTROL                  (1U)
#define BSP_FEATURE_CGC_HAS_XTALM_SWITCH                 (1U)

#define BSP_FEATURE_USB_NUM_IP                           (1UL)

#define BSP_FEATURE_TCS_APPLY                            (1U)
...
#define BSP_FEATURE_CRYPTO_HAS_AES                       (1U)
#define BSP_FEATURE_CRYPTO_HAS_AES_WRAPPED               (1U)
#define BSP_FEATURE_CRYPTO_HAS_CTR_DRBG                  (1U)
#define BSP_FEATURE_CRYPTO_HAS_ECC                       (1U)
#define BSP_FEATURE_CRYPTO_HAS_ECC_WRAPPED               (1U)
#define BSP_FEATURE_CRYPTO_HAS_HASH                      (1U)
#define BSP_FEATURE_RSIP_RSIP_E31B_SUPPORTED             (1U)

#define BSP_FEATURE_DMAC_W_B                             (1)
#define BSP_FEATURE_DMAC_HAS_SHARED_IRQ                  (0)
#define BSP_FEATURE_DMAC_MAX_CHANNEL                     (8U)

#define BSP_FEATURE_DOC_VERSION                          (2U)

#define BSP_FEATURE_TRANSFER_HAS_DTC                     (1)

#define BSP_FEATURE_DTC_TRANSFER_INFO_ALIGNMENT          (4)

#define BSP_FEATURE_ELC_MISSING                          (0U)
#define BSP_FEATURE_ELC_PERIPHERAL_MASK                  (0x3FFFFFFFU) // Positions of event link set registers (ELSRs) available on this MCU

#define BSP_FEATURE_FLASH_NVMC_W_BLANK_WORD_VALUE        (UINT64_MAX)
#define BSP_FEATURE_FLASH_NVMC_W_NSC_CODE_START          (0x04000000)
#define BSP_FEATURE_FLASH_NVMC_W_NS_CODE_START           (0x14000000)
#define BSP_FEATURE_FLASH_NVMC_W_NS_DATA_START           (0x34000000)
#define BSP_FEATURE_FLASH_NVMC_W_S_DATA_START            (0x24000000)
#define BSP_FEATURE_FLASH_NVMC_W_BLOCK_SIZE              (0x1000U)                             // Sector/Block in bytes (512 words X 8 Bytes/word)
#define BSP_FEATURE_FLASH_NVMC_W_SIZE_BYTES              (BSP_ROM_SIZE_BYTES)
#define BSP_FEATURE_FLASH_NVMC_W_BLOCK_NUM               (BSP_FEATURE_FLASH_NVMC_W_SIZE_BYTES / \
                                                          BSP_FEATURE_FLASH_NVMC_W_BLOCK_SIZE) // Total number of Sectors/Blocks
#define BSP_FEATURE_FLASH_NVMC_W_WRITE_SIZE              (8)                                   // Word size in bytes, in program/erase mode
#define BSP_FEATURE_FLASH_NVMC_W_VERSION                 (1)
#define BSP_FEATURE_FLASH_SUPPORTS_ACCESS_WINDOW         (0)
#define BSP_FEATURE_FLASH_SUPPORTS_BLANK_CHECK           (0)
#define BSP_FEATURE_FLASH_SUPPORTS_ID_CODE               (0)
#define BSP_FEATURE_FLASH_SUPPORTS_SWAP_BLOCK            (0)
#define BSP_FEATURE_FLASH_IS_INTERNAL                    (1)

#define BSP_FEATURE_I3C_IS_AVAILABLE                     (1U)
#define BSP_FEATURE_I3C_MAX_DEV_COUNT                    (8U)
#define BSP_FEATURE_I3C_NUM_CHANNELS                     (1U)
#define BSP_FEATURE_I3C_XFER_FIFO_DEPTH                  (32U)

#define BSP_FEATURE_ICU_FIXED_IELSR_COUNT                (0U)

#define BSP_FEATURE_I2C_VERSION                          (1)
#define BSP_FEATURE_I2C_VALID_CHANNEL_MASK               (0x0EU)
#define BSP_FEATURE_I2C_HAS_DEDICATED_IRQS               (1)
#define BSP_FEATURE_I2C_HAS_SEPARATE_PD                  (BSP_PD_COM)

#define BSP_FEATURE_IO_HAS_WEAK_CONFIG_PER_PORT          (1U)
#define BSP_FEATURE_IO_HAS_LATCHING                      (1U)
#define BSP_FEATURE_IO_PORT_COUNT                        (3U)
#define BSP_FEATURE_IO_PORT0_GPIO_COUNT                  (32U)
#define BSP_FEATURE_IO_PORT1_GPIO_COUNT                  (8U)
#define BSP_FEATURE_IO_PORT2_GPIO_COUNT                  (8U)

#define BSP_FEATURE_MOTOR_IS_AVAILABLE                   (0U)

#define BSP_FEATURE_PM_ENABLE_OPTIONS                    (4U)
#define BSP_FEATURE_PM_SENSE_AND_REACT_SUPPORTED         (1U)

#define BSP_FEATURE_POWER_DOMAIN_NUM                     (9U)
#define BSP_FEATURE_POWER_DOMAIN_RTC_AVAILABLE           (1U)

#define BSP_FEATURE_QSPI_DEVICE_START_ADDRESS            (0x16000000U)
#define BSP_FEATURE_QSPI_DEVICE_START_ADDRESS_DATA       (0x36000000U)
#define BSP_FEATURE_QSPI_MAX_CHANNEL                     (1U)
#define BSP_FEATURE_QSPI_HAS_DDR_SUPPORT                 (1U)

#define BSP_FEATURE_SPI_VALID_CHANNEL_MASK               (0x0EU)
#define BSP_FEATURE_SPI_MAX_CHANNEL                      (3U)

#define BSP_FEATURE_TIM_W_VALID_CHANNEL_MASK             (0x1FEU)
#define BSP_FEATURE_TIM_W_NUM_OF_CCM_CHANNELS            (0x8U)
#define BSP_FEATURE_TIM_W_HAS_IRQ_PER_CAPTURE_CHANNEL    (0x1U)
#define BSP_FEATURE_TIM_W_LINEAR_SRC_DIV_STEP            (0x0U)
#define BSP_FEATURE_TIM_W_SUPPORTS_COMPARE_MATCH         (0x1U)
#define BSP_FEATURE_TIM_W_SUPPORTS_PAUSE_NATIVELY        (0x1U)
#define BSP_FEATURE_TIM_W_SUPPORTS_SEQ_CAPTURES          (0x1U)
#define BSP_FEATURE_TIM_W_SUPPORTS_OVERFLOW_UNDERFLOW    (0x1U)
#define BSP_FEATURE_TIM_W_SUPPORTS_RESET_NATIVELY        (0x1U)

#define BSP_FEATURE_UART_FIFO_DEPTH                      (16U)
#define BSP_FEATURE_UART_CHANNEL_MAX                     (4U)
#define BSP_FEATURE_UART_CHANNELS_WITHOUT_FLOW_CTRL      (1U)
#define BSP_FEATURE_UART_VALID_CHANNEL_MASK              (0x1EU)
#define BSP_FEATURE_SMCI_CHANNELS                        (0x1U)

#define BSP_FEATURE_PD_CTRL_VALID_ENTRIES                (16U)

#define BSP_FEATURE_PROD_HEADER_OFFSET                   (0x2000)
#define BSP_FEATURE_PROD_HEADER_LENGTH                   (0x200)
#define BSP_FEATURE_FLASH_CODE_FLASH_START               (BSP_FEATURE_FLASH_NVMC_W_NSC_CODE_START + \
                                                          BSP_FEATURE_PROD_HEADER_OFFSET +          \
                                                          BSP_FEATURE_PROD_HEADER_LENGTH)

#define BSP_FEATURE_RTC_IS_AVAILABLE                     (1U)
#define BSP_FEATURE_RTC_CAPTURE_CHANNELS                 (4U)
 ...
 **********************************************************************************************************************/
 ...
 #define BSP_FEATURE_BSP_HAS_SP_MON                        (0)
 ...
 #define BSP_FEATURE_BSP_VBATT_HAS_VBTCR1_BPWSWSTP         (0)
