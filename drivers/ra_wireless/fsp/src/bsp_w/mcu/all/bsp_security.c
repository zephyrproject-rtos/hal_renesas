...
#else /* BSP_MCU_GROUP_RA6W3 */
 #define BSP_SAU_REGION_SRAM_NSC          (0U) // SAU Region 0
 #define BSP_SAU_REGION_OSPI_NSC          (1U) // SAU Region 1
 #define BSP_SAU_REGION_CODE_ROM_NS       (2U) // SAU Region 2
 #define BSP_SAU_REGION_DATA_ROM_NS       (3U) // SAU Region 3
 #define BSP_SAU_REGION_DATA_PERIPH1_NS   (4U) // SAU Region 4
 #define BSP_SAU_REGION_DATA_PERIPH2_NS   (5U) // SAU Region 5
#endif
...
#else /* BSP_MCU_GROUP_RA6W3 */
 #define BSP_SAU_REGION_SRAM_NSC_BASE_ADDRESS           (0x0304F000U)
 #define BSP_SAU_REGION_SRAM_NSC_LIMIT_ADDRESS          (0x0304FFFFU)
 #define BSP_SAU_REGION_OSPI_NSC_BASE_ADDRESS           (0x087FF000U)
 #define BSP_SAU_REGION_OSPI_NSC_LIMIT_ADDRESS          (0x087FFFFFU)
 #define BSP_SAU_REGION_CODE_ROM_NS_BASE_ADDRESS        (0x10000000U)
 #define BSP_SAU_REGION_CODE_ROM_NS_LIMIT_ADDRESS       (0x1FFFFFFFU)
 #define BSP_SAU_REGION_DATA_ROM_NS_BASE_ADDRESS        (0x30000000U)
 #define BSP_SAU_REGION_DATA_ROM_NS_LIMIT_ADDRESS       (0x3FFFFFFFU)
 #define BSP_SAU_REGION_DATA_PERIPH1_NS_BASE_ADDRESS    (0x50000000U)
 #define BSP_SAU_REGION_DATA_PERIPH1_NS_LIMIT_ADDRESS   (0x5FFFFFFFU)
 #define BSP_SAU_REGION_DATA_PERIPH2_NS_BASE_ADDRESS    (0x70000000U)
 #define BSP_SAU_REGION_DATA_PERIPH2_NS_LIMIT_ADDRESS   (0x7FFFFFFFU)
#endif
...
#if BSP_MCU_GROUP_RA6W3
/**
 * Configure a single SAU region
 */
static void sau_configure_region(uint32_t region, uint32_t base, uint32_t limit, uint32_t nsc)
{
    SAU->RNR = region;
    SAU->RBAR = base & SAU_RBAR_BADDR_Msk;
    SAU->RLAR = (limit & SAU_RLAR_LADDR_Msk) | (nsc ? SAU_RLAR_NSC_Msk : 0) | SAU_RLAR_ENABLE_Msk;
}
#endif
...
#else
    SYSB->TZ_FLASHB_REG = (uint32_t) FLASH_NS_START & SYSB_TZ_FLASHB_REG_TZ_FLASHB_Msk;
    SYSB->TZ_RAMB_REG_b.TZ_RAMB = (uint32_t) (((uint32_t)RAMCODE_NS_START) >> SYSB_TZ_RAMB_REG_TZ_RAMB_Pos);
    SYSB->TZ_PSRAMB_REG = (uint32_t) (0x06000000);
#endif
...
#else /* BSP_MCU_GROUP_RA6W3 */
    /* SRAM NSC */
    sau_configure_region(BSP_SAU_REGION_SRAM_NSC, BSP_SAU_REGION_SRAM_NSC_BASE_ADDRESS, BSP_SAU_REGION_SRAM_NSC_LIMIT_ADDRESS, 1);

    /* OSPI NSC */
    sau_configure_region(BSP_SAU_REGION_OSPI_NSC, BSP_SAU_REGION_OSPI_NSC_BASE_ADDRESS, BSP_SAU_REGION_OSPI_NSC_LIMIT_ADDRESS, 1);

    /* NS CBUS ROM */
    sau_configure_region(BSP_SAU_REGION_CODE_ROM_NS, BSP_SAU_REGION_CODE_ROM_NS_BASE_ADDRESS, BSP_SAU_REGION_CODE_ROM_NS_LIMIT_ADDRESS, 0);
   
    /* NS SBUS ROM */
    sau_configure_region(BSP_SAU_REGION_DATA_ROM_NS, BSP_SAU_REGION_DATA_ROM_NS_BASE_ADDRESS, BSP_SAU_REGION_DATA_ROM_NS_LIMIT_ADDRESS, 0);

    /* NS SBUS Peripherals */
    sau_configure_region(BSP_SAU_REGION_DATA_PERIPH1_NS, BSP_SAU_REGION_DATA_PERIPH1_NS_BASE_ADDRESS, BSP_SAU_REGION_DATA_PERIPH1_NS_LIMIT_ADDRESS, 0);    

    /* NS SBUS Peripherals */
    sau_configure_region(BSP_SAU_REGION_DATA_PERIPH2_NS, BSP_SAU_REGION_DATA_PERIPH2_NS_BASE_ADDRESS, BSP_SAU_REGION_DATA_PERIPH2_NS_LIMIT_ADDRESS, 0);    
#endif
