...
{
    BSP_IO_PORT_03_PIN_10,             ///< Associated with TAMPICR1->CH0EN
    BSP_IO_PORT_03_PIN_11,             ///< Associated with TAMPICR1->CH1EN
    BSP_IO_PORT_03_PIN_12              ///< Associated with TAMPICR1->CH2EN
};
#endif
