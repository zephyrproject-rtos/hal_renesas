...
typedef struct                         /*!< (@ 0x8742C400) R_GPT0 Structure                                           */
{
    ...
    union
    {
        ...
        struct
        {
            ...
            uint32_t                 : 2;
            __IOM uint32_t EIVTC2    : 2; /*!< [17..16] Extended Interrupt Skipping Counter 2 Count Source Select     */
...
#if defined(__BIG) && defined(__GNUC__)
            uint32_t              : 25;
            __IOM uint32_t EADTBL : 3; /*!< [6..4] GTADTRB A/D Conversion Start Request Extended
                                        * Skipping Function Select                                                    */
            uint32_t              : 1;
            __IOM uint32_t EADTAL : 3; /*!< [2..0] GTADTRA A/D Conversion Start Request Extended
                                        * Skipping Function Select                                                    */
#else
            __IOM uint32_t EADTAL : 3; /*!< [2..0] GTADTRA A/D Conversion Start Request Extended
                                        * Skipping Function Select                                                    */
    ...
    union
    {
        ...
        {
#if defined(__BIG) && defined(__GNUC__)
            __IOM uint32_t ADCMSCNT2 : 4;   /*!< [31..28] A/D Conversion Start Request Compare Match Skipping
                                             * Counter 2                                                              */
            ...
            __IOM uint32_t ADCMSCNT1 : 4;   /*!< [15..12] A/D Conversion Start Request Compare Match Skipping
                                             * Counter 1                                                              */
...
#if defined(__BIG) && defined(__GNUC__)
            uint32_t              : 11;
            __IOM uint32_t GTIOBB : 5; /*!< [20..16] GTIOB Buffer                                                     */
            uint32_t              : 11;
            __IOM uint32_t GTIOAB : 5; /*!< [4..0] GTIOA Buffer                                                       */
#else
            __IOM uint32_t GTIOAB : 5; /*!< [4..0] GTIOA Buffer                                                       */
            uint32_t              : 11;
            __IOM uint32_t GTIOBB : 5; /*!< [20..16] GTIOB Buffer                                                     */
    ...
    union
    {
        ...
        struct
        {
            ...
            uint32_t              : 5;
            __IOM uint32_t ICBCLK : 1; /*!< [24..24] Enable Count Clock as Source of Other Channel GTCCRB Input
                                        * Capture                                                                     */
            __IOM uint32_t ICBFPU : 1; /*!< [23..23] Enable Underflow as Source of Other Channel GTCCRB Input
                                        * Capture                                                                     */
            __IOM uint32_t ICBFPO : 1; /*!< [22..22] Enable Overflow as Source of Other Channel GTCCRB Input Capture  */
            __IOM uint32_t ICBFF  : 1; /*!< [21..21] Enable GTCCRF Register Compare Match as Source of Other Channel
                                        * GTCCRB Input Capture                                                        */
            __IOM uint32_t ICBFE : 1;  /*!< [20..20] Enable GTCCRE Register Compare Match as Source of Other Channel
                                        * GTCCRB Input Capture                                                        */
            __IOM uint32_t ICBFD : 1;  /*!< [19..19] Enable GTCCRD Register Compare Match as Source of Other Channel
                                        * GTCCRB Input Capture                                                        */
            __IOM uint32_t ICBFC : 1;  /*!< [18..18] Enable GTCCRC Register Compare Match as Source of Other Channel
                                        * GTCCRB Input Capture                                                        */
            __IOM uint32_t ICBFB : 1;  /*!< [17..17] Enable GTCCRB Register Compare Match/Input Capture as Source of
                                        * Other Channel GTCCRB Input Capture                                          */
            __IOM uint32_t ICBFA : 1;  /*!< [16..16] Enable GTCCRA Register Compare Match/Input Capture as Source of
                                        * Other Channel GTCCRB Input Capture                                          */
            __IOM uint32_t ICAGRP : 2; /*!< [15..14] GTCCRA Input Capture Group Select                                */
            uint32_t              : 5;
            __IOM uint32_t ICACLK : 1; /*!< [8..8] Enable Count Clock as Source of Other Channel GTCCRA Input
                                        * Capture                                                                     */
            __IOM uint32_t ICAFPU : 1; /*!< [7..7] Enable Underflow as Source of Other Channel GTCCRA Input Capture   */
            __IOM uint32_t ICAFPO : 1; /*!< [6..6] Enable Overflow as Source of Other Channel GTCCRA Input Capture    */
            __IOM uint32_t ICAFF  : 1; /*!< [5..5] Enable GTCCRF Register Compare Match as Source of Other Channel
                                        * GTCCRA Input Capture                                                        */
            __IOM uint32_t ICAFE : 1;  /*!< [4..4] Enable GTCCRE Register Compare Match as Source of Other Channel
                                        * GTCCRA Input Capture                                                        */
            __IOM uint32_t ICAFD : 1;  /*!< [3..3] Enable GTCCRD Register Compare Match as Source of Other Channel
                                        * GTCCRA Input Capture                                                        */
            __IOM uint32_t ICAFC : 1;  /*!< [2..2] Enable GTCCRC Register Compare Match as Source of Other Channel
                                        * GTCCRA Input Capture                                                        */
            __IOM uint32_t ICAFB : 1;  /*!< [1..1] Enable GTCCRB Register Compare Match/Input Capture as Source of
                                        * Other Channel GTCCRA Input Capture                                          */
            __IOM uint32_t ICAFA : 1;  /*!< [0..0] Enable GTCCRA Register Compare Match/Input Capture as Source of
                                        * Other Channel GTCCRA Input Capture                                          */
#else
            __IOM uint32_t ICAFA : 1;  /*!< [0..0] Enable GTCCRA Register Compare Match/Input Capture as Source of
                                        * Other Channel GTCCRA Input Capture                                          */
            ...
            __IOM uint32_t ICBFA  : 1; /*!< [16..16] Enable GTCCRA Register Compare Match/Input Capture as Source of
                                        * Other Channel GTCCRB Input Capture                                          */
            __IOM uint32_t ICBFB : 1;  /*!< [17..17] Enable GTCCRB Register Compare Match/Input Capture as Source of Other Channel GTCCRB Input Capture */
            __IOM uint32_t ICBFC : 1;  /*!< [18..18] Enable GTCCRC Register Compare Match as Source of Other Channel
                                        * GTCCRB Input Capture                                                        */
            __IOM uint32_t ICBFD : 1;  /*!< [19..19] Enable GTCCRD Register Compare Match as Source of Other Channel
                                        * GTCCRB Input Capture                                                        */
    ...
    union
    {
        union
        {
            __IOM uint32_t GTSYNCFCR;  /*!< (@ 0x000000F0) General PWM Timer-linked Synchronization Control Register  */

            struct
            {
#if defined(__BIG) && defined(__GNUC__)
                uint32_t            : 15;
                __IOM uint32_t SYST : 1; /*!< [16..16] Timer-Internal Synchronization Signal Synchronization Control  */
                uint32_t            : 16;
#else
                uint32_t            : 16;
                __IOM uint32_t SYST : 1; /*!< [16..16] Timer-Internal Synchronization Signal Synchronization Control  */
        ...
        union
        {
            __IOM uint32_t GTSYNCSCR;  /*!< (@ 0x000000F0) General PWM Timer-linked Synchronization Signal
...
#if defined(__BIG) && defined(__GNUC__)
                uint32_t            : 30;
                __IOM uint32_t SYSG : 2; /*!< [1..0] Timer-Linked Synchronization Signal and Timer-Internal
                                          *   Synchronization Signal Output Enable                                    */
#else
                __IOM uint32_t SYSG : 2; /*!< [1..0] Timer-Linked Synchronization Signal and Timer-Internal
                                          *   Synchronization Signal Output Enable                                    */
                uint32_t : 30;
