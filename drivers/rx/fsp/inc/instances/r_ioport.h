...
typedef enum e_ioport_port_pin_t
{
    ...
    IOPORT_PORT_15_PIN_04 = 0x0F04,    ///< IO port 15 pin 4
    IOPORT_PORT_15_PIN_05 = 0x0F05,    ///< IO port 15 pin 5
    IOPORT_PORT_15_PIN_06 = 0x0F06,    ///< IO port 15 pin 6
    IOPORT_PORT_15_PIN_07 = 0x0F07,    ///< IO port 15 pin 7
    IOPORT_PORT_15_PIN_08 = 0x0F08,    ///< IO port 15 pin 8
    IOPORT_PORT_15_PIN_09 = 0x0F09,    ///< IO port 15 pin 9
    IOPORT_PORT_15_PIN_10 = 0x0F0A,    ///< IO port 15 pin 10
    IOPORT_PORT_15_PIN_11 = 0x0F0B,    ///< IO port 15 pin 11
    IOPORT_PORT_15_PIN_12 = 0x0F0C,    ///< IO port 15 pin 12
    IOPORT_PORT_15_PIN_13 = 0x0F0D,    ///< IO port 15 pin 13
    IOPORT_PORT_15_PIN_14 = 0x0F0E,    ///< IO port 15 pin 14
    IOPORT_PORT_15_PIN_15 = 0x0F0F,    ///< IO port 15 pin 15

    IOPORT_PORT_16_PIN_00 = 0x1000,    ///< IO port 16 pin 0
    IOPORT_PORT_16_PIN_01 = 0x1001,    ///< IO port 16 pin 1
    IOPORT_PORT_16_PIN_02 = 0x1002,    ///< IO port 16 pin 2
    IOPORT_PORT_16_PIN_03 = 0x1003,    ///< IO port 16 pin 3
    IOPORT_PORT_16_PIN_04 = 0x1004,    ///< IO port 16 pin 4
    IOPORT_PORT_16_PIN_05 = 0x1005,    ///< IO port 16 pin 5
    IOPORT_PORT_16_PIN_06 = 0x1006,    ///< IO port 16 pin 6
    IOPORT_PORT_16_PIN_07 = 0x1007,    ///< IO port 16 pin 7
    IOPORT_PORT_16_PIN_08 = 0x1008,    ///< IO port 16 pin 8
    IOPORT_PORT_16_PIN_09 = 0x1009,    ///< IO port 16 pin 9
    IOPORT_PORT_16_PIN_10 = 0x100A,    ///< IO port 16 pin 10
    IOPORT_PORT_16_PIN_11 = 0x100B,    ///< IO port 16 pin 11
    IOPORT_PORT_16_PIN_12 = 0x100C,    ///< IO port 16 pin 12
    IOPORT_PORT_16_PIN_13 = 0x100D,    ///< IO port 16 pin 13
    IOPORT_PORT_16_PIN_14 = 0x100E,    ///< IO port 16 pin 14
    IOPORT_PORT_16_PIN_15 = 0x100F,    ///< IO port 16 pin 15
} ioport_port_pin_t;
