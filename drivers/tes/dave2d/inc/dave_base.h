/*
 * SPDX-License-Identifier: LicenceRef-renesas-open-license
 */
//--------------------------------------------------------------------------
// Project: D/AVE
...
*    d1_ma_bigendian   -  data in system mem is big endian -> swap before letting hardware access it
*
*/
...
*
*  Flags:
*    d1_cf_shorts - data consists of 16 bit values: swaps both bytes within each 16 bit value on big endian systems
*    d1_cf_ints   - data consists of 32 bit values: swaps all four bytes within each 32 bit value on big endian systems
...
*    d1_ma_bigendian  - Data in CPU memory is big endian. A swap might be needed before letting
*                       hardware access it (see: <d1_copytovidmem>).
*/
