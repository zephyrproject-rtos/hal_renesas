...
#define CPG_BUS_MCPU3_MSTOP			(CPG_BASE + 0x0B90)	/* MSTOP register BUS_MCPU3 */
...
#define PL3A_DDIV_DIVPL3F_WEN						(1 << 28)
...
#define CLKSTATUS_DIVPL3F_STS						(1 << 12)
