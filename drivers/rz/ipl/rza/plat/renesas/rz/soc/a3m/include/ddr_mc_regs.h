...
#define BASE_MC             DDR_MC_BASE
#define USER_DEF_REG_0_ADDR (BASE_MC + 0x064C)
#define USER_DEF_REG_1_ADDR (BASE_MC + 0x0650)
#define USER_DEF_REG_2_ADDR (BASE_MC + 0x0654)
#define USER_DEF_REG_3_ADDR (BASE_MC + 0x0658)
#define USER_DEF_REG_4_ADDR (BASE_MC + 0x065C)
#define USER_DEF_REG_5_ADDR (BASE_MC + 0x0660)
#define USER_DEF_REG_6_ADDR (BASE_MC + 0x0664)
#define USER_DEF_REG_7_ADDR (BASE_MC + 0x0668)
#define USER_DEF_REG_8_ADDR (BASE_MC + 0x066C)
#define USER_DEF_REG_9_ADDR (BASE_MC + 0x0670)
#define USER_DEF_REG_10_ADDR (BASE_MC + 0x0674)
#define USER_DEF_REG_11_ADDR (BASE_MC + 0x0678)
#define USER_DEF_REG_12_ADDR (BASE_MC + 0x067C)
#define USER_DEF_REG_13_ADDR (BASE_MC + 0x0680)
#define USER_DEF_REG_14_ADDR (BASE_MC + 0x0684)
#define USER_DEF_REG_15_ADDR (BASE_MC + 0x0688)
