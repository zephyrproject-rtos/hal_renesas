...
struct st_gpt_extended_cfg
{
    ...
    uint8_t   cycle_end_trough_ipl;               ///< Cycle end (Overflow) /Trough (Underflow) interrupt priority.
    ...
    IRQn_Type cycle_end_trough_irq;               ///< Cycle end (Overflow) /Trough (Underflow) interrupt
