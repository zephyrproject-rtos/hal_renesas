...
typedef enum e_spi_mrioclk_analog_delay
{
    ...
    SPI_MRIOCLK_ANALOG_DELAY_1_1_NS,   ///< 1.1 ns (1.4 ns on T2H and T2N)
    SPI_MRIOCLK_ANALOG_DELAY_2_2_NS,   ///< 2.2 ns (2.8 ns on T2H and T2N)
    SPI_MRIOCLK_ANALOG_DELAY_3_3_NS,   ///< 3.3 ns (4.2 ns on T2H and T2N)
    SPI_MRIOCLK_ANALOG_DELAY_4_4_NS,   ///< 4.4 ns (5.6 ns on T2H and T2N)
    SPI_MRIOCLK_ANALOG_DELAY_5_5_NS,   ///< 5.5 ns (7.0 ns on T2H and T2N)
    SPI_MRIOCLK_ANALOG_DELAY_6_6_NS,   ///< 6.6 ns (8.4 ns on T2H and T2N)
    SPI_MRIOCLK_ANALOG_DELAY_7_7_NS,   ///< 7.7 ns (9.8 ns on T2H and T2N)
