...
/** Channel control block. DO NOT INITIALIZE.  Initialization occurs when @ref RZN::timer_api_t::open is called. Please refer to the struct st_cmtw_instance_ctrl. */
