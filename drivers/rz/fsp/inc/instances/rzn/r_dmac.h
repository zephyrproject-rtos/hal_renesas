...
/** Control block used by driver. DO NOT INITIALIZE - this structure will be initialized in @ref RZN::transfer_api_t::open. */
...
/** Control block used by driver. DO NOT INITIALIZE - this structure will be initialized in @ref RZN::transfer_api_t::open. Please refer to the struct st_dmac_instance_ctrl. */
...
struct st_dmac_extended_cfg
{
    ...
    /** Placeholder for user data.  Passed to the user p_callback in RZN::transfer_callback_args_t. */
    void * p_context;
