...
/** Channel control block. DO NOT INITIALIZE.  Initialization occurs when @ref RZA::timer_api_t::open is called. */
...
/** Channel control block. DO NOT INITIALIZE.  Initialization occurs when @ref RZA::timer_api_t::open is called. Please refer to the struct st_gtm_instance_ctrl. */
