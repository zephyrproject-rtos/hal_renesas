...
/** Channel control block. DO NOT INITIALIZE.  Initialization occurs when @ref RZA::st_spi_api::open is called. */
...
/** Channel control block. DO NOT INITIALIZE.  Initialization occurs when @ref RZA::st_spi_api::open is called. Please refer to the struct st_rspi_instance_ctrl. */
