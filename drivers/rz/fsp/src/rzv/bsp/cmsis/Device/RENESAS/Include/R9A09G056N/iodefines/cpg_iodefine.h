...
typedef struct
{
    ...
    union
    {
        __IOM uint32_t CPG_ERRORRST_SEL9;
        struct
        {
            __IOM uint32_t ERRRSTSEL0      : 1;
            __IOM uint32_t ERRRSTSEL1      : 1;
