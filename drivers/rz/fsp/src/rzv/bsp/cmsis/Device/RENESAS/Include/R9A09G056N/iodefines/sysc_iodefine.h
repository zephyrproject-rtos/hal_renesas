...
typedef struct
{
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t SXDRW0_AWPU  : 1;
            __IOM uint32_t SXDRW0_AWNS  : 1;
            uint32_t                    : 1;
            __IOM uint32_t SXDRW0_AWSEL : 1;
            uint32_t                    : 4;
            __IOM uint32_t SXDRW1_AWPU  : 1;
            __IOM uint32_t SXDRW1_AWNS  : 1;
            uint32_t                    : 1;
            __IOM uint32_t SXDRW1_AWSEL : 1;
            uint32_t                    : 4;
        } SYS_MSTACCCTL18_b;
    };
    __IM uint8_t RESERVED3[180];
    union
    {
