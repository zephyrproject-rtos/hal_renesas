...
typedef struct
{
    ...
    union
    {
        ...
        struct
        {
            __IM uint32_t RFDN : 5;    /*!< [4..0] Receive FIFO data store stage number                               */
            uint32_t           : 27;
        } SPRFSR_b;
    };
...
#define R_SPI_B0_BASE    0x12800000
#define R_SPI_B1_BASE    0x12800400
#define R_SPI_B2_BASE    0x12800800
