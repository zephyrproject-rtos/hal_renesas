 ...
 * - Initialize the control structure for use in other @ref RZN_SPI_API functions.
 *
 ...
 * @return     See @ref RZN_RENESAS_ERROR_CODES or functions called by this function for other possible return codes. This
 ...
 * - Update control structure so it will not work with @ref RZN_SPI_API functions.
 *
 ...
 * @return                     See @ref RZN_RENESAS_ERROR_CODES for other possible return codes. This function internally
 *                             calls @ref RZN::transfer_api_t::open.
 **********************************************************************************************************************/
static fsp_err_t r_spi_transfer_config (spi_cfg_t const * const p_cfg)
{
    fsp_err_t err = FSP_SUCCESS;
 ...
 * @retval     FSP_ERR_IN_USE    A transfer is already in progress.
 * @return                       See @ref RZN_RENESAS_ERROR_CODES for other possible return codes. This function internally
 *                               calls @ref RZN::transfer_api_t::reconfigure.
 **********************************************************************************************************************/
static fsp_err_t r_spi_write_read_common (spi_ctrl_t * const    p_ctrl,
                                          void const          * p_src,
                                          void                * p_dest,
