 ...
 * - Initialize the control structure for use in other @ref RZG_SPI_API functions.
 *
 ...
 * @return     See @ref RZG_RENESAS_ERROR_CODES or functions called by this function for other possible return codes.
 ...
 * - Update control structure so it will not work with @ref RZG_SPI_API functions.
 *
 ...
 * @return                     See @ref RZG_RENESAS_ERROR_CODES for other possible return codes. This function internally
 ...
 * data register. Although this register is not documented in some hardware manual, it does seem to be available
 * on all of them.
 **********************************************************************************************************************/
static void r_rspi_bit_width_config (rspi_instance_ctrl_t * p_ctrl)
{
 ...
 * @retval     FSP_ERR_INVALID_ARGUMENT  A bit length not supported by this device was assigned to the argument.
 * @return                       See @ref RZG_RENESAS_ERROR_CODES for other possible return codes. This function internally
 *                               calls @ref RZG::transfer_api_t::reconfigure.
 **********************************************************************************************************************/
static fsp_err_t r_rspi_write_read_common (spi_ctrl_t * const    p_api_ctrl,
                                           void const          * p_src,
                                           void                * p_dest,
