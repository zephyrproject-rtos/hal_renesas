...
#elif (31 == BSP_FEATURE_GPT_CHANNEL)
 #define BSP_MSTP_REG_FSP_IP_GPT(channel)           *((26U >= channel) ? &R_SYSC_NS->MSTPCRC : &R_SYSC_S->MSTPCRG)
...
#define BSP_MSTP_DMY_FSP_IP_ETHSS(channel)          ((0U == channel) ? R_ETHSS->PRCMD : bsp_assert_channel(0))
 ...
 #define BSP_MSTP_DMY_FSP_IP_ENCIF(channel)          ((0U == channel) ? R_ENCIF->DUMMY : bsp_assert_channel(0))
#endif
...
#if BSP_FEATURE_ESWM_SUPPORTED
 #define BSP_MSTP_REG_FSP_IP_ESWM(channel)             R_SYSC_NS->MSTPCRE
 #define BSP_MSTP_BIT_FSP_IP_ESWM(channel)             (1U << (20U))
 #define BSP_MSTP_DMY_FSP_IP_ESWM(channel) /* The register does not exist. */
#endif

#if BSP_FEATURE_HPSW_SUPPORTED
 #define BSP_MSTP_REG_FSP_IP_HPSW(channel)             R_SYSC_NS->MSTPCRE
 #define BSP_MSTP_BIT_FSP_IP_HPSW(channel)             (1U << (21U))
 #define BSP_MSTP_DMY_FSP_IP_HPSW(channel) /* When accessing the HPSW register from specific bus masters, \
                                            * there are limitations on the region attributes and the instructions that can be used.\
                                            * Therefore, this macro does not define a register for dummy read. */
#endif
...
#define BSP_MSTP_DMY_FSP_IP_RTC(channel) /* After module stop release, the waiting process is performed by the driver, \
 ...
 #define BSP_MSTP_BIT_FSP_IP_CLMA(channel)          ((2U >= channel) ? (1U << (9U + channel)) : \
                                                     (1U << (8U)))
 ...
 #define BSP_MSTP_REG_FSP_IP_CLMA(channel)          R_SYSC_S->MSTPCRG
 #define BSP_MSTP_BIT_FSP_IP_CLMA(channel)          ((5U >= channel) ? (1U << (9U + channel)) : \
                                                     (1U << (8U)))
 #define BSP_MSTP_DMY_FSP_IP_CLMA(channel) \
    do                                     \
    {                                      \
...
#if BSP_FEATURE_NANDC_SUPPORTED
 #define BSP_MSTP_REG_FSP_IP_NANDC(channel)         R_SYSC_NS->MSTPCRH
 #define BSP_MSTP_BIT_FSP_IP_NANDC(channel)         (1U << (4U))
 #define BSP_MSTP_DMY_FSP_IP_NANDC(channel)         ((0U == channel) ? R_NANDC->CMDREG0 : bsp_assert_channel(0))
#endif
 ...
 #define BSP_MSTP_BIT_FSP_IP_PHOSTIF(channel)       (1U << (5U))
...
#elif (8U == BSP_FEATURE_BSP_AFMT_UNIT)
 #define BSP_MSTP_REG_FSP_IP_AFMT(channel)          R_SYSC_NS->MSTPCRJ
 #define BSP_MSTP_BIT_FSP_IP_AFMT(channel)          (1U << (channel * 4U))
 #define BSP_MSTP_DMY_FSP_IP_AFMT(channel) \
    do                                     \
    {                                      \
        switch (channel)                   \
...
#elif (8 == BSP_FEATURE_BSP_HDSL_UNIT)
 #define BSP_MSTP_REG_FSP_IP_HDSL(channel)          R_SYSC_NS->MSTPCRJ
 #define BSP_MSTP_BIT_FSP_IP_HDSL(channel)          (1U << ((channel * 4U) + 1U))
 #define BSP_MSTP_DMY_FSP_IP_HDSL(channel) \
    do                                     \
    {                                      \
        switch (channel)                   \
...
#elif (8 == BSP_FEATURE_BSP_BISS_UNIT)
 #define BSP_MSTP_REG_FSP_IP_BISS(channel)          R_SYSC_NS->MSTPCRJ
 #define BSP_MSTP_BIT_FSP_IP_BISS(channel)          (1U << ((channel * 4U) + 2U))
 #define BSP_MSTP_DMY_FSP_IP_BISS(channel) \
    do                                     \
    {                                      \
        switch (channel)                   \
...
#elif (8 == BSP_FEATURE_BSP_ENDAT_UNIT)
 #define BSP_MSTP_REG_FSP_IP_ENDAT(channel)            R_SYSC_NS->MSTPCRJ
 #define BSP_MSTP_BIT_FSP_IP_ENDAT(channel)            ((8U >= channel) ? (1U << ((channel * 4U) + 3U)) : \
                                                        (1U << (((channel - 8U) * 4U) + 3U)))
 #define BSP_MSTP_DMY_FSP_IP_ENDAT(channel) \
    do                                       \
    {                                        \
 ...
 #define BSP_MSTP_DMY_FSP_IP_LCDC(channel) /* After module stop release, the waiting process is performed by the driver, \
 ...
 #if (1 == BSP_FEATURE_BSP_PCIE_TYPE)
  ...
  #define BSP_MSTP_DMY_FSP_IP_PCIE(channel)          ((0U == channel) ? R_PCIE_LNK->PCIE_LINKMODE : \
                                                       bsp_assert_channel(0))
 #elif (2 == BSP_FEATURE_BSP_PCIE_TYPE)
  #define BSP_MSTP_REG_FSP_IP_PCIE(channel)          R_SYSC_NS->MSTPCRM
  #define BSP_MSTP_BIT_FSP_IP_PCIE(channel)          (1U << (8U))
  #define BSP_MSTP_DMY_FSP_IP_PCIE(channel)          ((0U == channel) ? R_PCIE_SPL0->PCIE_MODE : \
                                                       bsp_assert_channel(0))
 #endif
#endif
 ...
 #if (2 == BSP_FEATURE_BSP_CA55_CORE_NUM)
  #define BSP_MSTP_DMY_FSP_IP_CA55(channel)         ((1U >= channel) ? R_CA55->RVBA[channel].L : \
                                                     bsp_assert_channel(0))
 #elif (4 == BSP_FEATURE_BSP_CA55_CORE_NUM)
  #define BSP_MSTP_DMY_FSP_IP_CA55(channel)         ((3U >= channel) ? R_CA55->RVBA[channel].L : \
                                                     bsp_assert_channel(0))
 #endif
#endif

#if (4 == BSP_FEATURE_BSP_BISSL_UNIT)
 #define BSP_MSTP_REG_FSP_IP_BISSL(channel)          R_SYSC_NS->MSTPCRO
 #define BSP_MSTP_BIT_FSP_IP_BISSL(channel)          (1U << (channel * 4U))
 #define BSP_MSTP_DMY_FSP_IP_BISSL(channel) \
    do                                      \
    {                                       \
        switch (channel)                    \
        {                                   \
...
#if (4 == BSP_FEATURE_BSP_ENDAT3_UNIT)
 #define BSP_MSTP_REG_FSP_IP_ENDAT3_RXTX(channel)      R_SYSC_NS->MSTPCRO
 #define BSP_MSTP_BIT_FSP_IP_ENDAT3_RXTX(channel)      (1U << ((channel * 4U) + 1U))
 #define BSP_MSTP_DMY_FSP_IP_ENDAT3_RXTX(channel) \
    do                                            \
    {                                             \
        switch (channel)                          \
        {                                         \
            case 0:                               \
            {                                     \
                R_ENDAT30->VERSION_INFO;          \
                break;                            \
            }                                     \
            case 1:                               \
            {                                     \
                R_ENDAT31->VERSION_INFO;          \
                break;                            \
            }                                     \
            case 4:                               \
            {                                     \
                R_ENDAT34->VERSION_INFO;          \
                break;                            \
            }                                     \
            case 5:                               \
            {                                     \
                R_ENDAT35->VERSION_INFO;          \
                break;                            \
            }                                     \
            default:                              \
            {                                     \
 ...
 #define BSP_MSTP_REG_FSP_IP_ENDAT3_SYSTEM(channel)    R_SYSC_NS->MSTPCRO
 #define BSP_MSTP_BIT_FSP_IP_ENDAT3_SYSTEM(channel)    (1U << ((channel * 4U) + 2U))
 #define BSP_MSTP_DMY_FSP_IP_ENDAT3_SYSTEM(channel) \
    do                                              \
    {                                               \
        switch (channel)                            \
        {                                           \
...
#if BSP_FEATURE_BSP_HAS_OTFD_PERIPHERAL
 #define BSP_MSTP_REG_FSP_IP_OTFD(channel)             R_SYSC_NS->MSTPCRP
 #define BSP_MSTP_BIT_FSP_IP_OTFD(channel)             (1U << channel)
 #define BSP_MSTP_DMY_FSP_IP_OTFD(channel) \
    do                                     \
    {                                      \
        switch (channel)                   \
        {                                  \
...
#if BSP_FEATURE_BSP_HAS_OTFDE_PERIPHERAL
 #define BSP_MSTP_REG_FSP_IP_OTFDE(channel)            R_SYSC_NS->MSTPCRP
 #define BSP_MSTP_BIT_FSP_IP_OTFDE(channel)            (1U << 4U)
 #define BSP_MSTP_DMY_FSP_IP_OTFDE(channel)            ((0U == channel) ? R_OTFDE_MISC->OTFDE_CONVAREAST : \
                                                        bsp_assert_channel(0))
#endif
