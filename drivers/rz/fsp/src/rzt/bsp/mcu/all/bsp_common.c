...
const uint32_t g_bsp_system_clock_select_ckio[] =
{
    BSP_PRV_CKIO_FREQ_100_MHZ,         // CKIO = 000b
    BSP_PRV_CKIO_FREQ_66_7_MHZ,        // CKIO = 001b
    BSP_PRV_CKIO_FREQ_50_MHZ,          // CKIO = 010b
    BSP_PRV_CKIO_FREQ_40_MHZ,          // CKIO = 011b
    BSP_PRV_CKIO_FREQ_33_3_MHZ,        // CKIO = 100b
    BSP_PRV_CKIO_FREQ_28_6_MHZ,        // CKIO = 101b
    BSP_PRV_CKIO_FREQ_25_MHZ,          // CKIO = 110b
    BSP_PRV_CKIO_FREQ_NOT_SUPPORTED,   // CKIO = 111b
};
#endif
...
/* System clock frequency information for SDHI_IMCLK */
const uint32_t g_bsp_system_clock_select_sdhi_imclk[] =
{
    BSP_PRV_SDHI_IMCLK_FREQ_150_MHZ,   // SDHInCLKSEL = 0b
    BSP_PRV_SDHI_IMCLK_FREQ_200_MHZ,   // SDHInCLKSEL = 1b
};
...
#elif (3 == BSP_FEATURE_CGC_PCLKSCI_CLOCK_FREQ_TYPE)
const uint32_t g_bsp_system_clock_select_spi_clk[] =
{
    BSP_PRV_PCLKSPI_FREQ_75_MHZ,       // SPInASYNCSEL = 00b
    BSP_PRV_PCLKSPI_FREQ_80_MHZ,       // SPInASYNCSEL = 01b
