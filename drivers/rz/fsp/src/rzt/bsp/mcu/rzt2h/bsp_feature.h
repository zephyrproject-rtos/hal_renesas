...
#define BSP_FEATURE_ADDRESS_EXPANDER_ADXCTL_NUM                (13U)
...
#define BSP_FEATURE_BSP_MODULE_STOP_DUMMY_READ_COUNT           (7U)
...
#define BSP_FEATURE_CGC_LOCO_STABILIZATION_MAX_US              (5U)
...
#define BSP_FEATURE_CGC_SSC_MODULATION_RATE_DIVISOR_M_PLL0     (96U)
#define BSP_FEATURE_CGC_SSC_MODULATION_RATE_DIVISOR_M_PLL2     (64U)
...
#define BSP_FEATURE_DDR_TYPE                                   (1U)
...
#define BSP_FEATURE_ELC_GPT_EVENT_MASK_TYPE                    (1U)
#define BSP_FEATURE_ELC_GPT_EVENT_SOURCE_NUM                   (26U)
#define BSP_FEATURE_ELC_GPT_INTMSK_MASK                        (0x3FFF3FFFU)
...
#define BSP_FEATURE_ESC_DEFAULT_PFC_ESC_RESETOUT               (0x12U)
...
#define BSP_FEATURE_GMAC_B_TYPE                                (1U)
...
#define BSP_FEATURE_ICU_ERROR_CA55_ERR_REG_MASK                (0x00001FFFU)
...
#define BSP_FEATURE_ICU_ENCIF_ENCSEL_TYPE                      (2U)
...
#define BSP_FEATURE_PCIE_REGISTER_MASK_TYPE                    (1)
#define BSP_FEATURE_PCIE_EP_PHY_XCFGD_SETTING_VALUE_NUM        (27)
#define BSP_FEATURE_PCIE_EP_PHY_XCFGA_CMN_SETTING_VALUE_NUM    (16)
#define BSP_FEATURE_PCIE_RC_PHY_XCFGD_SETTING_VALUE_NUM        (27)
#define BSP_FEATURE_PCIE_RC_PHY_XCFGA_CMN_SETTING_VALUE_NUM    (16)
#define BSP_FEATURE_PCIE_PHY_XCFG_SETTING_PATTERN              (1)
#define BSP_FEATURE_PCIE_SUPPORT_GEN                           (3)
#define BSP_FEATURE_PCIE_SUPPORT_LINK_WIDTH                    (2)
#define BSP_FEATURE_PCIE_TRIMMING_CODE_LOW_ADDRESS             (0) // Feature not available on this device.
#define BSP_FEATURE_PCIE_TRIMMING_CODE_HIGH_ADDRESS            (0) // Feature not available on this device.
...
#define BSP_FEATURE_SCIE_CHANNEL                               (12U)
#define BSP_FEATURE_SCIE_CHANNELS                              (0xFFFU)
#define BSP_FEATURE_SCIE_SUPPORTED                             (1U)
#define BSP_FEATURE_SCIE_UART_CTSPEN_CHANNELS                  (BSP_FEATURE_SCIE_CHANNELS)
#define BSP_FEATURE_SCIE_UART_FIFO_CHANNELS                    (BSP_FEATURE_SCIE_CHANNELS)
#define BSP_FEATURE_SCIE_UART_FIFO_DEPTH                       (BSP_FEATURE_SCI_UART_FIFO_DEPTH)

#define BSP_FEATURE_SDHI_CLOCK                                 (FSP_PRIV_CLOCK_SDHI0_IMCLK)
...
#define BSP_FEATURE_SDHI_HAS_IOVCTRL                           (0)
#define BSP_FEATURE_SDHI_CH_HAS_DEDICATED_CLOCK_SOURCE         (0)
...
#define BSP_FEATURE_TZC400_NUM                                 (9U)
