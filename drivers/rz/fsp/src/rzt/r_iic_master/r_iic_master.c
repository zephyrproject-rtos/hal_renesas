...
/* Worst case ratio of (CPUnCLK/PCLKL) = 24 approximately.
 */
#define IIC_MASTER_PERIPHERAL_REG_MAX_WAIT          (0x18U)
...
static fsp_err_t iic_master_run_hw_master (iic_master_instance_ctrl_t * const p_instance_ctrl)
{
...
#if (2U == BSP_FEATURE_CGC_SCKCR_TYPE) || (3U == BSP_FEATURE_CGC_SCKCR_TYPE)
     ...
     * When cpufsel is 0U, CA55CLK/PCLKL is 12 (or 9.6). Similarly, 1U is 24 (or 19.2).
  ...
  #endif
 #endif
    timeout_count = ((12U << cpufsel) * p_instance_ctrl->p_reg->ICBRL) >> 2U;
