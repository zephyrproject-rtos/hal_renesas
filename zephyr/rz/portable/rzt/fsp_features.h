...
typedef enum e_fsp_ip
{
    ...
    FSP_IP_ESWM          = 52,         ///< Layer 3 Ethernet Switch Module
    FSP_IP_HPSW          = 53,         ///< Cortex-A55 CPUn Module Stop
    FSP_IP_NANDC         = 54,         ///< NAND Flash Controller
    FSP_IP_PHOSTIF       = 55,         ///< Parallel Host Interface
    FSP_IP_BISSL         = 56,         ///< BiSS-Line
    FSP_IP_ENDAT3_RXTX   = 57,         ///< EnDat 3.0 RX/TX
    FSP_IP_ENDAT3_SYSTEM = 58,         ///< EnDat 3.0 System
    FSP_IP_OTFD          = 59,         ///< On-the-fly Decryption
    FSP_IP_OTFDE         = 60,         ///< On-the-fly Decryption/Encryption
} fsp_ip_t;
