...
#else
#error "Invalid HOCO frequency, only can be set to 48MHz, 64MHz, 80MHz, 24MHz, 32MHz, 40MHz"
#endif
...
#define BSP_CFG_UARTA0_CLOCK_SOURCE BSP_CFG_UTASEL_CLOCK_SOURCE
#define BSP_CFG_UARTA1_CLOCK_SOURCE BSP_CFG_UTASEL_CLOCK_SOURCE
