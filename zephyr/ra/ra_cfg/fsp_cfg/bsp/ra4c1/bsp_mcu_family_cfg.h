...
#define BSP_TZ_CFG_PSARB                                                       \
  (((((RA_NOT_DEFINED > 0) ? 0U : 1U) << 0) /* UARTA0 */ &                     \
   ...
   (((RA_NOT_DEFINED > 0) ? 0U : 1U) << 17) /* SPI1 */ |                       \
   (((RA_NOT_DEFINED > 0) ? 0U : 1U) << 18) /* SPI2 */ |                       \
...
#define BSP_TZ_CFG_PSARC                                                       \
  ((((RA_NOT_DEFINED > 0) ? 0U : 1U) << 0) /* CAC */ |                         \
   ...
   (((RA_NOT_DEFINED > 0) ? 0U : 1U) << 31) /* RSIP-E31A */ |                  \
   0x77ffdee4) /* Unused */
#endif
...
#if (RA_NOT_DEFINED > 0) || (RA_NOT_DEFINED > 0) || (RA_NOT_DEFINED > 0) ||    \
    (RA_NOT_DEFINED > 0) || (RA_NOT_DEFINED > 0)
#define BSP_TZ_CFG_LVDSAR (0U)
#else
#define BSP_TZ_CFG_LVDSAR (0x703U)
#endif
#endif
...
#define BSP_TZ_CFG_CGFSAR (0xF3FBF602U)
#else
...
#define BSP_TZ_CFG_SRAMSAR                                                     \
  (1 | ((BSP_CFG_CLOCKS_SECURE == 0) ? (1U << 1U) : 0U) | 4 | 0xFFFFFFFAU)
#endif
