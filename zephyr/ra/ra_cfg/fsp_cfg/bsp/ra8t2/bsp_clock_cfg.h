...
#define BSP_CFG_PLODIVQ RA_CGC_CLK_DIV(DT_NODELABEL(pllq), div, 6)
#define BSP_CFG_PLL1Q_FREQUENCY_HZ (RA_CGC_PROP_HAS_STATUS_OKAY_OR(DT_NODELABEL(pllq), freq, 0))
#define BSP_CFG_PLODIVR RA_CGC_CLK_DIV(DT_NODELABEL(pllr), div, 5)
...
#define BSP_CFG_PLL2_DIV RA_CGC_CLK_DIV(DT_NODELABEL(pll), div, 3)
...
#define BSP_CFG_PL2ODIVP RA_CGC_CLK_DIV(DT_NODELABEL(pll2p), div, 4)
#define BSP_CFG_PLL2P_FREQUENCY_HZ (RA_CGC_PROP_HAS_STATUS_OKAY_OR(DT_NODELABEL(pll2p), freq, 0))
#define BSP_CFG_PL2ODIVQ RA_CGC_CLK_DIV(DT_NODELABEL(pll2q), div, 3)
#define BSP_CFG_PLL2Q_FREQUENCY_HZ (RA_CGC_PROP_HAS_STATUS_OKAY_OR(DT_NODELABEL(pll2q), freq, 0))
#define BSP_CFG_PL2ODIVR RA_CGC_CLK_DIV(DT_NODELABEL(pll2r), div, 5)
...
#define BSP_CFG_CPUCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(cpuclk0), div, 1)
#define BSP_CFG_CPUCLK1_DIV RA_CGC_CLK_DIV(DT_NODELABEL(cpuclk1), div, 4)
#define BSP_CFG_MRICLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(mriclk), div, 4)
#define BSP_CFG_FCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(mrpclk), div, 8)
#define BSP_CFG_ICLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(iclk), div, 4)
#define BSP_CFG_PCLKA_DIV RA_CGC_CLK_DIV(DT_NODELABEL(pclka), div, 8)
#define BSP_CFG_PCLKB_DIV RA_CGC_CLK_DIV(DT_NODELABEL(pclkb), div, 16)
...
#define BSP_CFG_PCLKE_DIV RA_CGC_CLK_DIV(DT_NODELABEL(pclke), div, 4)
#define BSP_CFG_BCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(bclk), div, 8)
#define BSP_CFG_BCLKA_SOURCE RA_CGC_CLK_SRC(DT_CLOCKS_CTLR(DT_NODELABEL(bclka)))
#define BSP_CFG_BCLKA_DIV RA_CGC_CLK_DIV(DT_NODELABEL(bclka), div, 6)
...
#define BSP_CFG_SCICLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(sciclk), div, 4)
...
#define BSP_CFG_GPTCLK_SOURCE RA_CGC_CLK_SRC(DT_CLOCKS_CTLR(DT_NODELABEL(gptclk)))
#define BSP_CFG_GPTCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(gptclk), div, 2)
...
#define BSP_CFG_I3CCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(i3cclk), div, 4)
#define BSP_CFG_UCLK_SOURCE RA_CGC_CLK_SRC(DT_CLOCKS_CTLR(DT_NODELABEL(uclk)))
#define BSP_CFG_UCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(uclk), div, 10)
...
#define BSP_CFG_ADCCLK_SOURCE RA_CGC_CLK_SRC(DT_CLOCKS_CTLR(DT_NODELABEL(adcclk)))
#define BSP_CFG_ADCCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(adcclk), div, 4)
#define BSP_CFG_ESWCLK_SOURCE RA_CGC_CLK_SRC(DT_CLOCKS_CTLR(DT_NODELABEL(eswclk)))
#define BSP_CFG_ESWCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(eswclk), div, 4)
#define BSP_CFG_ESWPHYCLK_SOURCE RA_CGC_CLK_SRC(DT_CLOCKS_CTLR(DT_NODELABEL(eswphyclk)))
#define BSP_CFG_ESWPHYCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(eswphyclk), div, 2)
#define BSP_CFG_ETHPHYCLK_SOURCE RA_CGC_CLK_SRC(DT_CLOCKS_CTLR(DT_NODELABEL(ethphyclk)))
#define BSP_CFG_ETHPHYCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(ethphyclk), div, 32)
#define BSP_CFG_ESCCLK_SOURCE RA_CGC_CLK_SRC(DT_CLOCKS_CTLR(DT_NODELABEL(escclk)))
#define BSP_CFG_ESCCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(escclk), div, 8)
#define BSP_CFG_DSMIFCLK_SOURCE RA_CGC_CLK_SRC(DT_CLOCKS_CTLR(DT_NODELABEL(dsmifclk)))
#define BSP_CFG_DSMIFCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(dsmifclk), div, 2)
