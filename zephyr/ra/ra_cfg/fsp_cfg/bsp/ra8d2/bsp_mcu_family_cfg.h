...
#define BSP_TZ_CFG_MSSAR                                                       \
  ((1U << 0) /* SRAM0 */ | (1U << 1) /* SRAM1 */ | (1U << 2) /* SRAM2 */ |     \
   (1U << 3) /* SRAM3 */ | (1U << 22) /* DTC0_DMAC0 */ |                       \
   (1U << 23) /* DTC1_DMAC1 */ |                                               \
...
#define BSP_TZ_CFG_LPMSAR                                                      \
  ((RA_NOT_DEFINED > 0) ? BSP_CFG_CLOCKS_SECURE == 0                           \
                        : (0x002E0116U | (BSP_CFG_CLOCKS_SECURE == 0)))
#endif
...
#define BSP_TZ_CFG_ICUSARB                                                     \
  (0 ? 7U                                                                      \
     : 0U) /* Should follow the secure attribution set in AIRCR.BFHFNMINS. */
#endif
...
/* Security attribution register for ELCR, ELSEGR0, ELSEGR1, ELSEGR2, ELSEGR3
...
#if (0U == BSP_CFG_CPU_CORE)
#define BSP_CFG_DCACHE_FORCE_WRITETHROUGH                                      \
  IS_ENABLED(CONFIG_CPU_RA_DCACHE_FORCE_WRITETHROUGH)
#else
#define BSP_CFG_DCACHE_FORCE_WRITETHROUGH                                      \
  IS_ENABLED(CONFIG_CPU_RA_DCACHE_FORCE_WRITETHROUGH)
#endif
