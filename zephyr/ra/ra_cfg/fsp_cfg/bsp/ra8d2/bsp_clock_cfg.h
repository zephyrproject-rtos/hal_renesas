...
#define BSP_CFG_LCDCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(lcdclk), div, 2)
...
#define BSP_CFG_USB60CLK_SOURCE RA_CGC_CLK_SRC(DT_CLOCKS_CTLR(DT_NODELABEL(usb60clk)))
#define BSP_CFG_USB60CLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(usb60clk), div, 8)
