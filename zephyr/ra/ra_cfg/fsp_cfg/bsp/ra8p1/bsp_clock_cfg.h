...
#define BSP_CFG_NPUCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(npuclk), div, 2)
...
#define BSP_CFG_FCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(mrpclk), div, 32)
...
#define BSP_CFG_SPICLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(spiclk), div, 8)
#define BSP_CFG_CANFDCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(canfdclk), div, 10)
#define BSP_CFG_GPTCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(gptclk), div, 4)
#define BSP_CFG_LCDCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(lcdclk), div, 4)
#define BSP_CFG_I3CCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(i3cclk), div, 5)
#define BSP_CFG_UCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(uclk), div, 5)
#define BSP_CFG_USB60CLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(usb60clk), div, 5)
#define BSP_CFG_OCTACLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(octaspiclk), div, 4)
#define BSP_CFG_ADCCLK_DIV RA_CGC_CLK_DIV(DT_NODELABEL(adcclk), div, 4)
#define BSP_CFG_GPT_COUNT_CLOCK_SOURCE RA_CGC_CLK_SRC(DT_CLOCKS_CTLR(DT_NODELABEL(pclkd)))
