...
#define BSP_CLOCK_CFG_MAIN_OSC_POPULATED (DT_NODE_HAS_STATUS_OKAY(DT_NODELABEL(xtal)))
#endif
...
#define BSP_CLOCK_CFG_SUBCLOCK_POPULATED (DT_NODE_HAS_STATUS_OKAY(DT_NODELABEL(subclk)))
#endif
