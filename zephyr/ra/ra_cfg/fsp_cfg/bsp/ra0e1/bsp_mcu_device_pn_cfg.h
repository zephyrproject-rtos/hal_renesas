...
#define BSP_ROM_SIZE_BYTES (DT_REG_SIZE(DT_NODELABEL(code_flash)))
#define BSP_RAM_SIZE_BYTES (12288)
#define BSP_DATA_FLASH_SIZE_BYTES (DT_REG_SIZE(DT_NODELABEL(data_flash)))
