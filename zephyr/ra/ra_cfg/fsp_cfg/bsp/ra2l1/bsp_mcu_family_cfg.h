...
#define BSP_CFG_ROM_REG_OFS1 (0x7FFFFEC3 | (1 << 2) | (3 << 3) | (0 << 8) | \
(BSP_CFG_ROM_REG_OFS1_ICSATS))
 ...
 * BSP_ID_CODE_PERMANENTLY_LOCKED in the compiler settings. WARNING: This
 * will disable debug access to the part and cannot be reversed by a
 * debug probe.
 */
