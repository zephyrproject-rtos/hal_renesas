...
#define BSP_TZ_CFG_PSARB                                                                         \
	((((RA_NOT_DEFINED > 0) ? 0U : 1U) << 3) /* CEC */ |                                      \
	 ...
	 (((1 > 0) ? 0U : 1U) << 31) /* SCI0 */ | 0x7FB3F7E7U) /* Unused */
#endif
...
#define BSP_TZ_CFG_PSARC                                                                         \
	((((RA_NOT_DEFINED > 0) ? 0U : 1U) << 0) /* CAC */ |                                     \
	 ...
	 (((RA_NOT_DEFINED > 0) ? 0U : 1U) << 28) /* TRNG */ | 0xE7FFDEFC) /* Unused */
#endif
...
#define BSP_TZ_CFG_PSARD                                                                         \
	((((RA_NOT_DEFINED > 0) ? 0U : 1U) << 2) /* AGT1 */ |                                    \
	 ...
	 (((RA_NOT_DEFINED > 0) ? 0U : 1U) << 22) /* TSN */ | 0xFFAE87F3) /* Unused */
#endif
...
#define BSP_TZ_CFG_PSARE                                                                         \
	((((RA_NOT_DEFINED > 0) ? 0U : 1U) << 0) /* WDT */ |                                     \
	 ...
	 (((RA_NOT_DEFINED > 0) ? 0U : 1U) << 31) /* GPT0 */ | 0x3f3ff8) /* Unused */
#endif
#ifndef BSP_TZ_CFG_MSSAR
#define BSP_TZ_CFG_MSSAR                                                                         \
	((((RA_NOT_DEFINED > 0) ? 0U : 1U) << 0) /* ELC */ |                                     \
	 (((RA_NOT_DEFINED > 0) ? 0U : 1U) << 1) /* DTC_DMAC */ | 0xfffffffc) /* Unused */
#endif
