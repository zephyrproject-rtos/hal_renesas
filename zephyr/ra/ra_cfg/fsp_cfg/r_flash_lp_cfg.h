...
#define FLASH_LP_CFG_CODE_FLASH_PROGRAMMING_ENABLE ((DT_PROP(DT_NODELABEL(code_flash_ctrl), programming_enable)))
#define FLASH_LP_CFG_DATA_FLASH_PROGRAMMING_ENABLE ((DT_PROP(DT_NODELABEL(data_flash_ctrl), programming_enable)))
