...
#define SDHI_CFG_SD_SUPPORT_ENABLE                                             \
  (DT_PROP_OR(DT_NODELABEL(sdmmc0), sd_support, 0)) ||                         \
      (DT_PROP_OR(DT_NODELABEL(sdmmc1), sd_support, 0))
#define SDHI_CFG_EMMC_SUPPORT_ENABLE                                           \
  (DT_PROP_OR(DT_NODELABEL(sdmmc0), mmc_support, 0)) ||                        \
      (DT_PROP_OR(DT_NODELABEL(sdmmc1), mmc_support, 0))
