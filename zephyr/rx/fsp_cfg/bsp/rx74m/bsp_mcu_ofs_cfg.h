...
#define OFS_IWDT                                                               \
  (0xA001A001U | 1U << 1U | 3U << 2U | 15U << 4U | 3U << 8U | 3 << 10U |       \
   1U << 12U | 1U << 14U)
#define OFS_WDT                                                                \
  (1U << 17U | 3U << 18U | 15U << 20U | 3U << 24U | 3U << 26U | 1U << 28U |    \
   1U << 30U)
...
#define BSP_CFG_OPTION_SETTING_OFS1_NS_NO_HOCOFRQ                              \
  (0x0FFFF0D0U | 1U << 3U | 7U | 1U << 5U | 1U << 8U | 7U << 28U | 1U << 31U)
#define BSP_CFG_OPTION_SETTING_OFS1_NS                                         \
  ((uint32_t)BSP_CFG_OPTION_SETTING_OFS1_NS_NO_HOCOFRQ |                       \
...
#define BSP_CFG_OPTION_SETTING_OFS1_SEL                                        \
  (0x0FFFF0D0U | ((7U << 0U)) | ((1U << 3U)) | ((1U << 5U)) | ((1U << 8U)) |   \
   ((7U << 9U)) | ((7U << 28U)) | ((1U << 31U)))
#endif
