...
#include "../../../rx/fsp/src/bsp/mcu/rx74n/bsp_mcu_info.h"
#include "../../../rx/fsp/src/bsp/mcu/rx74n/bsp_override.h"
#include "../../../rx/fsp/src/bsp/mcu/rx74n/r_adc_device_types.h"
#include "../../../rx/fsp/src/bsp/mcu/rx74n/r_lpm_device_types.h"
#include "bsp_clock_cfg.h"
#include "bsp_mcu_device_cfg.h"
#include "bsp_mcu_device_pn_cfg.h"

#define BSP_MCU_GROUP_RX74N (1)
...
#define BSP_PZ_CFG_PSARB                                                       \
  ((((FSP_NOT_DEFINED > 0) ? 0U : 1U) << 0) /* RSCI12, MSTPCRB.MSTPB0 bit */ | \
   ((((FSP_NOT_DEFINED > 0) || (FSP_NOT_DEFINED > 0)) ? 0U : 1U)               \
    << 4) /* RI3C0, MSTPCRB.MSTPB4 bit */                                      \
   |                                                                           \
   ...
   |                                                                           \
   (((FSP_NOT_DEFINED > 0) ? 0U : 1U) << 31) /* RSCI0, MSTPCRB.MSTPB31 bit */)
#endif
...
#define BSP_PZ_CFG_PSARC                                                       \
  ((((FSP_NOT_DEFINED > 0) ? 0U : 1U) << 0) /* CAC, MSTPCRC.MSTPC0 bit */ |    \
   ...
   |                                                                           \
   (((FSP_NOT_DEFINED > 0) ? 0U : 1U)                                          \
    << 25) /* CANFDG0, MSTPCRC.MSTPC25 bit */                                  \
   |                                                                           \
   ...
   (((FSP_NOT_DEFINED > 0) ? 0U : 1U)                                          \
    << 31) /* RSIP-E50D, MSTPCRC.MSTPC31 bit */)
#endif

#ifndef BSP_PZ_CFG_PSARD
#define BSP_PZ_CFG_PSARD                                                       \
  (((((FSP_NOT_DEFINED > 0) || (FSP_NOT_DEFINED > 0) ||                        \
      (FSP_NOT_DEFINED > 0) || (FSP_NOT_DEFINED > 0) ||                        \
      (FSP_NOT_DEFINED > 0) || (FSP_NOT_DEFINED > 0) ||                        \
      (FSP_NOT_DEFINED > 0) || (FSP_NOT_DEFINED > 0) ||                        \
      (FSP_NOT_DEFINED > 0) || (FSP_NOT_DEFINED > 0) ||                        \
      ...
      (FSP_NOT_DEFINED > 0) || (FSP_NOT_DEFINED > 0))                          \
         ? 0U                                                                  \
         : 1U)                                                                 \
    << 6) /* HRPWM, MSTPCRD.MSTPD6 bit */                                      \
   |                                                                           \
   (((FSP_NOT_DEFINED > 0) ? 0U : 1U)                                          \
    << 11) /* POEG GroupD, MSTPCRD.MSTPD11 bit */                              \
   |                                                                           \
   (((FSP_NOT_DEFINED > 0) ? 0U : 1U)                                          \
    << 12) /* POEG GroupC, MSTPCRD.MSTPD12 bit */                              \
   |                                                                           \
   (((FSP_NOT_DEFINED > 0) ? 0U : 1U)                                          \
    << 13) /* POEG GroupB, MSTPCRD.MSTPD13 bit */                              \
   |                                                                           \
   (((FSP_NOT_DEFINED > 0) ? 0U : 1U)                                          \
    << 14) /* POEG GroupA, MSTPCRD.MSTPD14 bit */                              \
   |                                                                           \
  ...
  ((((FSP_NOT_DEFINED > 0) ? 0U : 1U) << 1) /* WDT */ |                        \
   ...
   ((((FSP_NOT_DEFINED > 0) || (FSP_NOT_DEFINED > 0) ||                        \
      ...
      (FSP_NOT_DEFINED > 0) || (FSP_NOT_DEFINED > 0))                          \
         ? 0U                                                                  \
         : 1U)                                                                 \
    << 31) /* GPTW15-0, GPT_OPS, MSTPCRE.MSTPE31 bit */)
#endif

#ifndef BSP_PZ_CFG_PSARF
#define BSP_PZ_CFG_PSARF                                                       \
  (((((FSP_NOT_DEFINED > 0) || (FSP_NOT_DEFINED > 0)) ? 0U : 1U)               \
    << 6) /* TMR3, TMR2, MSTPCRF.MSTPF6 bit */                                 \
   |                                                                           \
   ((((FSP_NOT_DEFINED > 0) || (FSP_NOT_DEFINED > 0)) ? 0U : 1U)               \
    << 7) /* TMR1, TMR0, MSTPCRF.MSTPF7 bit */                                 \
   |                                                                           \
   ...
   |                                                                           \
   ((((FSP_NOT_DEFINED > 0) || (FSP_NOT_DEFINED > 0)) ? 0U : 1U)               \
    << 14) /* CMT3, CMT2, MSTPCRF.MSTPF14 bit */                               \
   |                                                                           \
   ((((FSP_NOT_DEFINED > 0) || (FSP_NOT_DEFINED > 0)) ? 0U : 1U)               \
    << 15) /* CMT1, CMT0, MSTPCRF.MSTPF15 bit */                               \
...
#define BSP_PZ_CFG_MSSAR                                                       \
  ((((FSP_NOT_DEFINED > 0) ? 0U : 1U)                                          \
    << 22) /* DMAC, DTC, MSTPCRA.MSTPA22 bit */                                \
   |                                                                           \
   ((((FSP_NOT_DEFINED > 0) || (FSP_NOT_DEFINED > 0)) ? 0U : 1U)               \
    << 29) /* EXDMAC, MSTPCRA.MSTPA29 bit */                                   \
...
#define BSP_PZ_CFG_CGFSAR (0x1B7F7FFDU)
#endif
#endif
...
#define BSP_PZ_CFG_ICUSARD                                                     \
  ((((1 > 0) ? 1U : 0U)                                                        \
    << 0U) /* Double-Precision Floating-Point Exceptions */                    \
...
#define BSP_PZ_CFG_ICU0SAR0                                                    \
  ((1U << 0U) /* IPR0 */ | (0U << 1U) /* IPR1 */ | (1U << 2U) /* IPR2 */ |     \
   (1U << 3U) /* IPR3 */ | (1U << 4U) /* IPR4 */ | (1U << 5U) /* IPR5 */ |     \
   (1U << 6U) /* IPR6 */ | (1U << 7U) /* IPR7 */ | (1U << 8U) /* IPR8 */ |     \
...
/* Security attribution register for ELCR、ELSEGR0 to ELSEGR3、ELOPA to ELOPD
...
#define BSP_PZ_CFG_ELCSARA                                                     \
  ((0x0000001FU) |                                                             \
   ...
   |                                                                           \
   ((((FSP_NOT_DEFINED > 0) || (FSP_NOT_DEFINED > 0)) ? 0U : 1U)               \
    << 18) /* ELOPC Security Attribution */                                    \
   |                                                                           \
   ((((FSP_NOT_DEFINED > 0) || (FSP_NOT_DEFINED > 0)) ? 0U : 1U)               \
    << 19) /* ELOPD Security Attribution */)
#endif
 ...
 * reason for Non Secure applications to access SRAMWTSC and therefore there is
 * no reason to access SRAMPRCR. */
