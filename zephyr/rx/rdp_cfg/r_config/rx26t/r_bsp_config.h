...
/* PLL clock source (PLLSRCSEL). Choose which clock source to input to the PLL circuit.
   ...
   1 = HOCO
*/
#define BSP_CFG_PLL_SRC                 RX_CGC_PLL_CLK_SRC(DT_NODELABEL(pll))
...
/* Peripheral Module Clock A Divider (PCKA).
   Available divisors = /1 (no division), /2, /4, /8, /16, /32, /64
*/
#define BSP_CFG_PCKA_DIV                (RX_CGC_PROP_HAS_STATUS_OKAY_OR(DT_NODELABEL(pclka), div, 2))
...
/* Peripheral Module Clock C Divider (PCKC).
   Available divisors = /1 (no division), /2, /4, /8, /16, /32, /64
*/
#define BSP_CFG_PCKC_DIV                (RX_CGC_PROP_HAS_STATUS_OKAY_OR(DT_NODELABEL(pclkc), div, 1))

/* Peripheral Module Clock D Divider (PCKD).
   Available divisors = /1 (no division), /2, /4, /8, /16, /32, /64
*/
#define BSP_CFG_PCKD_DIV                (RX_CGC_PROP_HAS_STATUS_OKAY_OR(DT_NODELABEL(pclkb), div, 1))
...
*/
#define BSP_CFG_CFDCK_DIV               (RX_CGC_PROP_HAS_STATUS_OKAY_OR(DT_NODELABEL(canfdclk), div, 1))
