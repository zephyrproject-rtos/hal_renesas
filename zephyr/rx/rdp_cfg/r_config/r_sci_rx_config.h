...
#define SCI_CFG_ASYNC_INCLUDED  (CONFIG_USE_RX_RDP_SCI_UART)
...
#define SCI_CFG_CH0_INCLUDED    (DT_NODE_HAS_STATUS(DT_NODELABEL(sci0), okay))
#define SCI_CFG_CH1_INCLUDED    (DT_NODE_HAS_STATUS(DT_NODELABEL(sci1), okay))
#define SCI_CFG_CH2_INCLUDED    (DT_NODE_HAS_STATUS(DT_NODELABEL(sci2), okay))
#define SCI_CFG_CH3_INCLUDED    (DT_NODE_HAS_STATUS(DT_NODELABEL(sci3), okay))
#define SCI_CFG_CH4_INCLUDED    (DT_NODE_HAS_STATUS(DT_NODELABEL(sci4), okay))
#define SCI_CFG_CH5_INCLUDED    (DT_NODE_HAS_STATUS(DT_NODELABEL(sci5), okay))
#define SCI_CFG_CH6_INCLUDED    (DT_NODE_HAS_STATUS(DT_NODELABEL(sci6), okay))
#define SCI_CFG_CH7_INCLUDED    (DT_NODE_HAS_STATUS(DT_NODELABEL(sci7), okay))
#define SCI_CFG_CH8_INCLUDED    (DT_NODE_HAS_STATUS(DT_NODELABEL(sci8), okay))
#define SCI_CFG_CH9_INCLUDED    (DT_NODE_HAS_STATUS(DT_NODELABEL(sci9), okay))
#define SCI_CFG_CH10_INCLUDED   (DT_NODE_HAS_STATUS(DT_NODELABEL(sci10), okay))
#define SCI_CFG_CH11_INCLUDED   (DT_NODE_HAS_STATUS(DT_NODELABEL(sci11), okay))
#define SCI_CFG_CH12_INCLUDED   (DT_NODE_HAS_STATUS(DT_NODELABEL(sci12), okay))
...
*/
#define SCI_CFG_TEI_INCLUDED    (CONFIG_USE_RX_RDP_SCI_UART)      /* 1=included, 0=not */
