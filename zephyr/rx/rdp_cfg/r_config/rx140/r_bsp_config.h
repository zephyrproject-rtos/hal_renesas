...
*/
#define BSP_CFG_PLL_DIV                 RX_CGC_PROP_HAS_STATUS_OKAY_OR(DT_NODELABEL(pll), div, 1)
...
*/
#define BSP_CFG_PLL_MUL                 (RX_CGC_PROP_HAS_STATUS_OKAY_OR(DT_NODELABEL(pll), mul, 15) + 1) / 2
...
#define SET_OFS1_HOCO_BITS(reg, freq)  \
	((reg) & ~(0b11 << 12)) | ((((freq) == 24000000 ? 0b10 : (freq) == 32000000 ? 0b11 : (freq) == 48000000 ? 0b01 : 0b00) << 12))
...
*/
#define BSP_CFG_OFS1_REG_VALUE  (SET_OFS1_HOCO_BITS(0xFFFFFFFF, (RX_CGC_PROP_HAS_STATUS_OKAY_OR(DT_NODELABEL(hoco), clock_frequency, 48000000))))
...
*/
#define BSP_CFG_CONFIGURATOR_VERSION                (2210)
