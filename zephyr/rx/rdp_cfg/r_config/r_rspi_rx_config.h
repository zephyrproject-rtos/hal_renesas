...
#define RSPI_CFG_USE_CHAN0  (DT_NODE_HAS_STATUS(DT_NODELABEL(rspi0), okay))
#define RSPI_CFG_USE_CHAN1  (DT_NODE_HAS_STATUS(DT_NODELABEL(rspi1), okay))
#define RSPI_CFG_USE_CHAN2  (DT_NODE_HAS_STATUS(DT_NODELABEL(rspi2), okay))
